...
namespace EIDSS.Localization.Helpers
{
    ...
    public class LocalizedRangeFromAttribute : RangeAttribute, IClientModelValidator
    {
        ...
        public LocalizedRangeFromAttribute(string minimumValue, string maximumValue) : base(typeof(int), minimumValue, maximumValue)
        {
        }
        ...
        protected override ValidationResult IsValid(object value, ValidationContext validationContext)
        {
            ...
            {
                ErrorMessage = string.Format(CacheProvider.GetResourceValueByLanguageCultureNameAndResourceKey(CurrentCulture.Name, MessageResourceKeyConstants.RangeFromXandXCharactersMessage), Minimum.ToString(), Maximum.ToString());
