...
{
    public class ControlMeasuresBase : VeterinaryDiseaseReportDeduplicationBaseComponent, IDisposable
	{
		#region Dependencies

		[Inject]
		private ILogger<ControlMeasuresBase> Logger { get; set; }
		...
		#endregion
		protected FlexForm.FlexForm ControlMeasuresDetails { get; set; }
		protected FlexForm.FlexForm ControlMeasuresDetails2 { get; set; }
