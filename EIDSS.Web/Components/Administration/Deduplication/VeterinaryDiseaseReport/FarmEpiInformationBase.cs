...
{
    public class FarmEpiInformationBase : VeterinaryDiseaseReportDeduplicationBaseComponent, IDisposable
	{
		#region Dependencies

		[Inject]
		private ILogger<FarmEpiInformationBase> Logger { get; set; }
