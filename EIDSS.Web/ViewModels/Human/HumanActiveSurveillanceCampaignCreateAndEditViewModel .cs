...
{
    public class HumanActiveSurveillanceCampaignCreateAndEditViewModel
    {
 
        public HumanActiveSurveillanceCampaignCreateAndEditViewModel()
        {
          

        }
        public GetHumanActiveSurveillanceCampaignDetailsResponseModel GetHumanActiveSurveillanceCampaignDetailsResponseModel { get; set; }

        public List<GetHumanActiveCampaignSampleToSampleTypeResponseModel> GetHumanActiveCampaignSampleToSampleTypeResponseModel { get; set; }
        ...
        public Select2DataItem DefaultCampaignType { get; set; }

        public Select2DataItem DefaultCampaignStatus { get; set; }

        public Select2DataItem DefaultDisease { get; set; }

        public Select2DataItem DefaultSampleType { get; set; }
