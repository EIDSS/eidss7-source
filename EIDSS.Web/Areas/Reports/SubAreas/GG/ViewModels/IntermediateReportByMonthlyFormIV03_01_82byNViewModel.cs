...
{
    public class IntermediateReportByMonthlyFormIV03_01_82byNViewModel  :ReportBaseModel
    {
    ...
    public class IntermediateReportByMonthlyFormIV03_01_82byNQueryModel:ReportQueryBaseModel
    {
