...
{
    public class IntermediateReportByMonthlyFormIV03ViewModel  :ReportBaseModel
    {
    ...
    public class IntermediateReportByMonthlyFormIV03QueryModel:ReportQueryBaseModel
    {
