...
{
    public class IntermediateReportByAnuualFormIV03ViewModel  :ReportBaseModel
    {
    ...
    public class IntermediateReportByAnuualFormIV03QueryModel:ReportQueryBaseModel
    {
