...
{
    public class ReportOnCertainDiseasesConditionsMonthlyFormIV03_01_82byNViewModel  :ReportBaseModel
    {
    ...
    public class ReportOnCertainDiseasesConditionsMonthlyFormIV03_01_82byNQueryModel:ReportQueryBaseModel
    {
