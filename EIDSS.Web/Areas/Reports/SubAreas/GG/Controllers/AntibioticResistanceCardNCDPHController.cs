...
namespace EIDSS.Web.Areas.Reports.SubAreas.GG.Controllers
{
    ...
    [SubArea("GG")]
    [Controller]
    public class AntibioticResistanceCardNCDPHController : Reports.Controllers.ReportController
    {
        ...
        public AntibioticResistanceCardNCDPHController(IConfiguration configuration, ICrossCuttingClient crossCuttingClient, ITokenService tokenService,  ILogger<AntibioticResistanceCardNCDPHController> logger) : 
                base(configuration, tokenService, crossCuttingClient, logger)
        {
            _logger = logger;
            _configuration = configuration;
            _crossCuttingClient = crossCuttingClient;
            ReportFileName = "AntibioticResistanceCardNCDPH";
        ...
        public async Task<IActionResult> Index()
        {
            ...
            { 
                ...
                var antibioticResistanceCardNCDPHViewModel = new AntibioticResistanceCardNCDPHViewModel()
                {
                ...
                return View(antibioticResistanceCardNCDPHViewModel);
            }
            catch (Exception ex)
            {
        ...
        [HttpPost]
        public async Task<IActionResult> Index(AntibioticResistanceCardNCDPHViewModel antibioticResistanceCardNCDPHViewModel)
        {
            try
            {
                var reportLanguageList = await _crossCuttingClient.GetReportLanguageList(GetCurrentLanguage());
                var reportYearList = await _crossCuttingClient.GetReportYearList();             
                antibioticResistanceCardNCDPHViewModel.ReportLanguageModels = reportLanguageList;
                antibioticResistanceCardNCDPHViewModel.ShowIncludeSignature = includeSignaturePermission;
                antibioticResistanceCardNCDPHViewModel.ShowUseArchiveData = archivePermission;
                ...
                {
                    antibioticResistanceCardNCDPHViewModel.JavascriptToRun = "submitReport();";
                    return View(antibioticResistanceCardNCDPHViewModel);
                }
        ...
        [HttpPost]
        public IActionResult GenerateReport([FromBody] AntibioticResistanceCardNCDPHQueryModel  reportQueryModel)
        {
            try
            { 
