...
namespace EIDSS.Web.Areas.Reports.SubAreas.GG.Controllers
{
    ...
    [SubArea("GG")]
    [Controller]
    public class AntibioticResistanceCardLMAController : Reports.Controllers.ReportController
    {
        ...
        public AntibioticResistanceCardLMAController(IConfiguration configuration, ICrossCuttingClient crossCuttingClient, ITokenService tokenService,  ILogger<AntibioticResistanceCardLMAController> logger) : 
                base(configuration, tokenService, crossCuttingClient, logger)
        {
            _logger = logger;
            _configuration = configuration;
            _crossCuttingClient = crossCuttingClient;
            ReportFileName = "AntibioticResistanceCardLMA";
        ...
        public async Task<IActionResult> Index()
        {
            ...
            { 
                ...
                var antibioticResistanceCardLMAViewModel = new AntibioticResistanceCardLMAViewModel()
                {
                ...
                return View(antibioticResistanceCardLMAViewModel);
            }
            catch (Exception ex)
            {
        ...
        [HttpPost]
        public async Task<IActionResult> Index(AntibioticResistanceCardLMAViewModel antibioticResistanceCardLMAViewModel)
        {
            try
            {
                var reportLanguageList = await _crossCuttingClient.GetReportLanguageList(GetCurrentLanguage());
                var reportYearList = await _crossCuttingClient.GetReportYearList();             
                antibioticResistanceCardLMAViewModel.ReportLanguageModels = reportLanguageList;
                antibioticResistanceCardLMAViewModel.ShowIncludeSignature = includeSignaturePermission;
                antibioticResistanceCardLMAViewModel.ShowUseArchiveData = archivePermission;
                ...
                {
                    antibioticResistanceCardLMAViewModel.JavascriptToRun = "submitReport();";
                    return View(antibioticResistanceCardLMAViewModel);
                }
        ...
        [HttpPost]
        public IActionResult GenerateReport([FromBody] AntibioticResistanceCardLMAQueryModel  reportQueryModel)
        {
            try
            { 
