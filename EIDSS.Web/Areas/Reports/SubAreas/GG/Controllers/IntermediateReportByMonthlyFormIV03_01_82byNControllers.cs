...
namespace EIDSS.Web.Areas.Reports.SubAreas.GG.Controllers
{
    ...
    [SubArea("GG")]
    [Controller]
    public class IntermediateReportByMonthlyFormIV03_01_82byNController : Reports.Controllers.ReportController
    {
        ...
        public IntermediateReportByMonthlyFormIV03_01_82byNController(IConfiguration configuration, ICrossCuttingClient crossCuttingClient, ITokenService tokenService, ILogger<IntermediateReportByMonthlyFormIV03_01_82byNController> logger) :
                base(configuration, tokenService, crossCuttingClient, logger)
        {
            _logger = logger;
            _configuration = configuration;
            _crossCuttingClient = crossCuttingClient;
            ReportFileName = "IntermediateReportByMonthlyFormIV03_01_82byN";
        ...
        public async Task<IActionResult> Index()
        {
            ...
            { 
                ...
                string minimumDateString = "2014-12-01";
                string maximumDateString = "2016-01-31";
                DateTime minimumIssueDate = DateTime.Parse(minimumDateString);
                DateTime maximumIssueDate = DateTime.Parse(maximumDateString);

                var intermediateReportByMonthlyFormIV03_01_82byNViewModel = new IntermediateReportByMonthlyFormIV03_01_82byNViewModel()
                {
                ...
                return View(intermediateReportByMonthlyFormIV03_01_82byNViewModel);
            }
            catch (Exception ex)
            {
        ...
        [HttpPost]
        public async Task<IActionResult> Index(IntermediateReportByMonthlyFormIV03_01_82byNViewModel intermediateReportByMonthlyFormIV03_01_82byNViewModel)
        {
            try
            {
                ...
                if (gisRegionList.Count > 0)
                {
                    if (string.IsNullOrEmpty(Convert.ToString(intermediateReportByMonthlyFormIV03_01_82byNViewModel.RegionId)))
                        ...
                        gisRayonList = await _crossCuttingClient.GetGisLocationChildLevel(GetCurrentLanguage(), Convert.ToString(intermediateReportByMonthlyFormIV03_01_82byNViewModel.RegionId));
                }

                intermediateReportByMonthlyFormIV03_01_82byNViewModel.ReportLanguageModels = reportLanguageList;
                intermediateReportByMonthlyFormIV03_01_82byNViewModel.GisRegionList = gisRegionList;
                intermediateReportByMonthlyFormIV03_01_82byNViewModel.GisRayonList = gisRayonList;
                intermediateReportByMonthlyFormIV03_01_82byNViewModel.ShowIncludeSignature = includeSignaturePermission;
                intermediateReportByMonthlyFormIV03_01_82byNViewModel.ShowUseArchiveData = archivePermission;
                ...
                {
                    intermediateReportByMonthlyFormIV03_01_82byNViewModel.JavascriptToRun = "submitReport();";
                    return View(intermediateReportByMonthlyFormIV03_01_82byNViewModel);
                }
        ...
        [HttpPost]
        public IActionResult GenerateReport([FromBody] IntermediateReportByMonthlyFormIV03_01_82byNQueryModel reportQueryModel)
        {
            try
            { 
