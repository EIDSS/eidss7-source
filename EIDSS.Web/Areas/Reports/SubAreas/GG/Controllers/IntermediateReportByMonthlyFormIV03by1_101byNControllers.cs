...
namespace EIDSS.Web.Areas.Reports.SubAreas.GG.Controllers
{
    ...
    [SubArea("GG")]
    [Controller]
    public class IntermediateReportByMonthlyFormIV03by1_101byNController : Reports.Controllers.ReportController
    {
        ...
        public IntermediateReportByMonthlyFormIV03by1_101byNController(IConfiguration configuration, ICrossCuttingClient crossCuttingClient, ITokenService tokenService, ILogger<IntermediateReportByMonthlyFormIV03by1_101byNController> logger) :
                base(configuration, tokenService, crossCuttingClient, logger)
        {
            _logger = logger;
            _configuration = configuration;
            _crossCuttingClient = crossCuttingClient;
            ReportFileName = "IntermediateReportByMonthlyFormIV03by1_101byN";
        ...
        public async Task<IActionResult> Index()
        {
            ...
            { 
                ...
                string minimumDateString = "2005-04-01"; 
                string maximumDateString = "2012-05-31"; 
                DateTime minimumIssueDate = DateTime.Parse(minimumDateString);
                DateTime maximumIssueDate = DateTime.Parse(maximumDateString);

                var intermediateReportByMonthlyFormIV03by1_101byNViewModel = new IntermediateReportByMonthlyFormIV03by1_101byNViewModel()
                {
                ...
                return View(intermediateReportByMonthlyFormIV03by1_101byNViewModel);
            }
            catch (Exception ex)
            {
        ...
        [HttpPost]
        public async Task<IActionResult> Index(IntermediateReportByMonthlyFormIV03by1_101byNViewModel intermediateReportByMonthlyFormIV03by1_101byNViewModel)
        {
            try
            {
                ...
                if (gisRegionList.Count > 0)
                {
                    if (string.IsNullOrEmpty(Convert.ToString(intermediateReportByMonthlyFormIV03by1_101byNViewModel.RegionId)))
                        ...
                        gisRayonList = await _crossCuttingClient.GetGisLocationChildLevel(GetCurrentLanguage(), Convert.ToString(intermediateReportByMonthlyFormIV03by1_101byNViewModel.RegionId));
                }

                intermediateReportByMonthlyFormIV03by1_101byNViewModel.ReportLanguageModels = reportLanguageList;
                intermediateReportByMonthlyFormIV03by1_101byNViewModel.GisRegionList = gisRegionList;
                intermediateReportByMonthlyFormIV03by1_101byNViewModel.GisRayonList = gisRayonList;
                intermediateReportByMonthlyFormIV03by1_101byNViewModel.ShowIncludeSignature = includeSignaturePermission;
                intermediateReportByMonthlyFormIV03by1_101byNViewModel.ShowUseArchiveData = archivePermission;
                ...
                {
                    intermediateReportByMonthlyFormIV03by1_101byNViewModel.JavascriptToRun = "submitReport();";
                    return View(intermediateReportByMonthlyFormIV03by1_101byNViewModel);
                }
        ...
        [HttpPost]
        public IActionResult GenerateReport([FromBody] IntermediateReportByMonthlyFormIV03by1_101byNQueryModel reportQueryModel)
        {
            try
            { 
                ...
                model.AddParameter("EndIssueDate", reportQueryModel.StartIssueDate.ToString(new CultureInfo(reportQueryModel.LanguageId)));
