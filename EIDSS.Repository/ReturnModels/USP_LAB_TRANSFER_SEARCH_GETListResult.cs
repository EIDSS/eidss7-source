...
{
    public partial class USP_LAB_TRANSFER_SEARCH_GETListResult
    {
        ...
        public int ReadPermissionIndicator { get; set; }
        public int AccessToPersonalDataPermissionIndicator { get; set; }
        public int AccessToGenderAndAgeDataPermissionIndicator { get; set; }
        public int WritePermissionIndicator { get; set; }
        public int DeletePermissionIndicator { get; set; }
