...
namespace EIDSS.Repository.Contexts
{
    ...
    /// <summary>
    /// An instance of xSiteContext targeting the Azerbaijani language.  
    /// One or more language instances of xsite may be implemented for an EIDSS instance
    /// </summary>
    public partial class xSiteContext_azl : DbContext, IXSiteContext
    {
        public string LanguageCode { get; set; } = "az-Latn-AZ";

        public xSiteContext_azl()
        {
        }

        public xSiteContext_azl(DbContextOptions<xSiteContext_azl> options)
            : base(options)
        {
        }
