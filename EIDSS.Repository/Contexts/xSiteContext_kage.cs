...
{
    public partial class xSiteContext_kage : DbContext, IXSiteContext
    {
        public string LanguageCode { get; set; } = "ka-GE";

        public xSiteContext_kage()
        {
        }

        public xSiteContext_kage(DbContextOptions<xSiteContext_kage> options)
            : base(options)
        {
        }
