...
namespace EIDSS.Api.Controllers.Veterinary
{
    ...
    [Route("api/Veterinary/Farm")]
    [ApiController]
    public partial class FarmController : EIDSSControllerBase
    {
        public FarmController(IDataRepository repository, IMemoryCache memoryCache) : base(repository, memoryCache)
        {
        }
    }
}
