...
{
    [Route("api/Configuration/ParameterTypeEditor")]
    [ApiController]
    public partial class ParameterTypeEditorController : EIDSSControllerBase
    {
        public ParameterTypeEditorController(IDataRepository repository, IMemoryCache memoryCache) : base(repository, memoryCache)
        {
        }
    }
}
