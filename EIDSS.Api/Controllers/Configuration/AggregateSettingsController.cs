...
{
    [Route("api/Configuration/AggregateSettings")]
    [ApiController]
    public partial class AggregateSettingsController : EIDSSControllerBase
    {
        public AggregateSettingsController(IDataRepository repository, IMemoryCache memoryCache) : base(repository, memoryCache)
        {
        }
