...
// these classes are used to exactly match the expected parameters
//  of USP_VCTS_SURVEILLANCE_SESSION_SET when sending json collections
namespace EIDSS.Domain.RequestModels.Vector
{
    public class VectorAggregateCollectionRequestModel
    {
        public long VectorSessionSummaryKey { get; set; }
        public long VectorSessionKey { get; set; }
        public string SummarySessionID { get; set; }
        ...
        public int? PoolsVectors { get; set; }
        public int RowStatus { get; set; }
        public int? RowAction { get; set; }
    }

    public class VectorAggregateDiagnosisInfoRequestModel
    {
    ...
    public class VectorDetailCollectionRequestModel
    {
        public long VectorSessionKey { get; set; }
        public long VectorSessionDetailedKey { get; set; }
        ...
        public long? DetailedVectorTypeID { get; set; }
        ...
        public long? EctoparASSitesCollectionID { get; set; }
