...
{
    public class LaboratoryTestGetListViewModel : BaseModel
    {
        public LaboratoryTestGetListViewModel ShallowCopy()
        {
            return (LaboratoryTestGetListViewModel)MemberwiseClone();
        }
        
        public long TestID { get; set; }
        public long? TestIDOriginal { get; set; }
