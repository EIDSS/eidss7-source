...
--*************************************************************************
-- Name 				: report.USP_REP_HUM_ExternalComparative_Calculations
-- Description			: This procedure returns data for AJ - External Comparative Report (used in report.USP_REP_HUM_ExternalComparative for Calculations) 
--          
-- Author               : Srini Goli
-- Revision History
...
CREATE PROCEDURE [Report].[USP_REP_HUM_ExternalComparative_Calculations]
    @CountryID BIGINT,
    @StartDate DATETIME,
    @FinishDate DATETIME,
    @RegionID BIGINT,
...
FROM tlbHumanCase hc
    ...
    LEFT JOIN tstSite ts
    ON ts.idfsSite = hc.idfsSite AND ts.intFlags = 1
...
--aggregate cases
UPDATE		fdt
SET			fdt.intAge_0_17 = fadvt.intAge_0_17,
