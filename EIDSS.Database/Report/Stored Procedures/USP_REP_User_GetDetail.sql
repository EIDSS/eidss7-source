...
EXEC	@return_value = [report].[USP_REP_User_GetDetail]
		@LangID ='ka',
		@UserID = 10
----SELECT	'Return Value' = @return_value
*/
--=====================================================================================================   
CREATE PROCEDURE [Report].[USP_REP_User_GetDetail]    
(
...
BEGIN
	...
	SET NOCOUNT ON;
		...
		IF @UserID is null
			RAISERROR (15600,-1,-1, 'USP_REP_User_GetDetail'); 
		ELSE
			BEGIN
  ...
  ----  -- Insert statements for procedure here
			...
			INNER JOIN report.FN_GBL_Reference_GET(@LangID,19000045) as OfficeAbbreviation       
