--*************************************************************************
-- Name 				: report.USP_REP_HUM_MonthlyInfectiousDiseaseNewHeader
-- DescriptiON			: Select data for Reportable Infectious Diseases (Monthly Form IV03) version 6..
-- 
-- AuthOR               : Srini Goli
-- Revision History
...
EXEC report.USP_REP_HUM_MonthlyInfectiousDiseaseNewHeader 'en',  37020000000, 3260000000

*/

CREATE PROCEDURE [Report].[USP_REP_HUM_MonthlyInfectiousDiseaseNewHeader]
	(
