...
exec report.USP_REP_HUM_ComparativeTwoYears_Graph 'en', 2011, 2016, '1',  null, null, null  
exec report.USP_REP_HUM_ComparativeTwoYears_Graph 'en', 2014, 2015, '2',  null, null, null  
exec report.USP_REP_HUM_ComparativeTwoYears_Graph 'en', 2012, 2015, '1',  null, null, null  
exec report.USP_REP_HUM_ComparativeTwoYears_Graph 'en', 2012, 2013, '1,2',  null, null, null  
exec report.USP_REP_HUM_ComparativeTwoYears_Graph 'en', 2014, 2016, '1,2',  null, 1344330000000 /*Baku*/, 1344390000000 /*Nizami (Baku)*/  
exec report.USP_REP_HUM_ComparativeTwoYears_Graph 'en', 2015, 2016, '1,2',  null, 10300053, 867  
exec report.USP_REP_HUM_ComparativeTwoYears_Graph 'en', 2015, 2016, '2',  null, 10300053, null  
...
exec report.USP_REP_HUM_ComparativeTwoYears_Graph 'en', 2014, 2016, '1',  7718730000000, null, null  
...
test 2  
 ...
 Generate report on site Republican APS  
exec report.USP_REP_HUM_ComparativeTwoYears_Graph 'en', 2014, 2018, '1',  7718730000000, 10300053, 869  
...
test 3  
 ...
 Entered by Organization (blank)  
 Generate report on site Republican APS  
exec report.USP_REP_HUM_ComparativeTwoYears_Graph 'en', 2010, 2021, '1',  7718080000000, 1344340000000, null  
...
-- Entered by Organization (blank)  
-- Generate report on site Republican APS  
exec report.USP_REP_HUM_ComparativeTwoYears_Graph 'en', 2015, 2016, '1,2',  null, 1344340000000, 1344790000000  
*/   
   
CREATE PROCEDURE [Report].[USP_REP_HUM_ComparativeTwoYears_Graph]  
...
from report.FN_GBL_SYS_SplitList(@StrCounter,1,',') cn
 ...
 set @idfsSite = ISNULL(@SiteID, dbo.FN_GBL_SITEID_GET())   
...
--select * from @ReportTable 
 ...
 -- Unpivot the table.  
SELECT intYear, intCounter,Replace(Month,'int','') as [Month], Totals 
into #unpivotTemp 
FROM   
   (SELECT intYear, intCounter, intJanuary, intFebruary, intMarch, intApril, intMay, intJune, intJuly, intAugust, intSeptember, intOctober, intNovember, intDecember  
   FROM @ReportTable) p  
UNPIVOT  
   (Totals FOR [Month] IN   
	  (intJanuary, intFebruary, intMarch, intApril, intMay, intJune, intJuly, intAugust, intSeptember, intOctober, intNovember, intDecember)  
)AS unpvt;   
  
SELECT r.intYear,
	   r.intCounter,
	   r.Totals,
	   a.strTextString as [Month],
	   intOrder as MonthOrder
FROM dbo.FN_GBL_Reference_GETList(@LangID, 19000132) a
inner join #unpivotTemp r on r.[Month]=a.strDefault
