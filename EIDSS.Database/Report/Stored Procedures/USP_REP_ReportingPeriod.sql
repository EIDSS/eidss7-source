...
--*************************************************************************
-- Name 				: report.USP_REP_ReportingPeriod
...
EXEC report.USP_REP_ReportingPeriod 'en','2020','Year'
EXEC report.USP_REP_ReportingPeriod 'ru','2020','Half-year'
EXEC report.USP_REP_ReportingPeriod 'en','2020','Quarter'
EXEC report.USP_REP_ReportingPeriod 'az-L','2020','Month'
*/

CREATE PROCEDURE [Report].[USP_REP_ReportingPeriod]
    (
