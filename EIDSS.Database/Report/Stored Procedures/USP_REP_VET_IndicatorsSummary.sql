...
--*************************************************************************
-- Name 				: report.USP_REP_VET_IndicatorsSummary
-- DescriptiON			: Select data for Veterinary Data Indicators report - summary mode.
--          
-- Author               : Srini Goli
-- Revision History
...
EXEC report.USP_REP_VET_IndicatorsSummary @LangID=N'en', @FromYear = 2017, @ToYear = 2017, @FromMonth = 12, @ToMonth = 12
*/

CREATE PROCEDURE  [Report].[USP_REP_VET_IndicatorsSummary]
    (
