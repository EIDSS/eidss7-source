...
--*************************************************************************
-- Name 				: report.USP_REP_LAB_AntibioticResistanceCardNCDPH
-- Description			: Select data for Antibiotic Resistance.
-- 
-- Author               : Srini Goli
-- Revision History
...
EXEC report.USP_REP_LAB_AntibioticResistanceCardNCDPH 'ru', 'S070120001'
*/

create  Procedure [Report].[USP_REP_LAB_AntibioticResistanceCardNCDPH]
	(
...
--https://95.167.107.114/BTRP/Project_Documents/08x-Implementation/Customizations/GG/Customization%20EIDSS%20v6/Reports/Specification%20for%20report%20development%20-%20Antibiotic%20Resistance%20Card%20for%20NCDC%20GG%20v1.0.doc
-- by number marked red at screen form prototype 

declare	@ReportTable 	table
(	
	strOrganizationName		nvarchar(200), --1
	strOrganizationAddress	nvarchar(200), --2
	strCulture				nvarchar(200), --4
	datDateTestConducted	datetime,	--6
	strAmikacin 			nvarchar(200), --11
	strAmpicillin 			nvarchar(200), --12
	strAmoxicillinClavAcid 	nvarchar(200), --13
	strAmoxicillin 			nvarchar(200), --14
	strAztreonam 			nvarchar(200), --15
	strAzithromicin 		nvarchar(200), --16
	strCarbenicillin 		nvarchar(200), --17
	strCefazolin 			nvarchar(200), --18
	strCefotaxime 			nvarchar(200), --19
	strCeftazidime 			nvarchar(200), --20
	strCefotaxine  			nvarchar(200), --21
	strCefoperazone 		nvarchar(200), --22
	strChoramphenicol 		nvarchar(200), --23
	strCeftriaxone 			nvarchar(200), --24
	strCefepime 			nvarchar(200), --25
	strCefoxitine 			nvarchar(200), --26
	strCiprofloxacin 		nvarchar(200), --27
	strColistineColomycin 	nvarchar(200), --28
	strCefuroxime 			nvarchar(200), --29
	strCephalotin 			nvarchar(200), --30
	strClindamycin 			nvarchar(200), --31
	strDoxycycline 			nvarchar(200), --32
	strErythromycin 		nvarchar(200), --33
	strFosfumycin 			nvarchar(200), --34
	strGentamicin 			nvarchar(200), --35
	strImipenem 			nvarchar(200), --36
	strNorfloxacin 			nvarchar(200), --37
	strNalidixicAcid 		nvarchar(200), --38
	strNitrofurantoin 		nvarchar(200), --39
	strNetilmicin 			nvarchar(200), --40
	strOfloxacin 			nvarchar(200), --41
	strOxacillin 			nvarchar(200), --42
	strPenicillin 			nvarchar(200), --43
	strPiperacillin 		nvarchar(200), --44
	strRifampin 			nvarchar(200), --45
	strStreptomicin 		nvarchar(200), --46
	strSulfonamides 		nvarchar(200), --47
	strTetracycline 		nvarchar(200), --48
	strTicarcillin 			nvarchar(200), --49
	strTobramycin 			nvarchar(200), --50
	strTrimethoprimSulfo 	nvarchar(200), --51
	strVancomycin			nvarchar(200), -- 50
	strResearchConductedBy	nvarchar(200) --53
)	
...
DECLARE 
	...
	@strOrganizationName		nvarchar(200), --1
	@strOrganizationAddress	nvarchar(200),
...
set @idfsCustomReportType = 10290012 -- GG Antibiotic Resistance Card
...
if @SiteID is null set @SiteID = dbo.FN_GBL_SITEID_GET() 

SELECT 
    @strOrganizationAddress = report.FN_REP_AddressSharedString(@LangID, tlbOffice.idfLocation),
    @strOrganizationName = ISNULL(trtStringNameTranslation.strTextString, trtBaseReference.strDefault)
FROM tlbOffice
    INNER JOIN tstSite
    ...
    AND trtStringNameTranslation.idfsLanguage = report.FN_GBL_LanguageCode_GET(@LangID)
    AND trtStringNameTranslation.intRowStatus = 0

WHERE tstSite.idfsSite = @SiteID AND tlbOffice.intRowStatus = 0
...
from		tlbTesting t
	...
	inner join	dbo.FN_GBL_ReferenceRepair(@LangID, 19000097) r_tt	-- Test Type
...
FROM tlbObservation o
    ...
    (
     tlbActivityParameters ap_Amikacin
        ...
        INNER JOIN dbo.FN_GBL_ReferenceRepair(@LangID, @Ant_Resistance_ReferenceType) ref_Amikacin
    ...
    (
     tlbActivityParameters ap_Ampicillin
        ...
        INNER JOIN dbo.FN_GBL_ReferenceRepair(@LangID, @Ant_Resistance_ReferenceType) ref_Ampicillin
    ...
    (
     tlbActivityParameters ap_AmoxicillinClavAcid
        ...
        INNER JOIN dbo.FN_GBL_ReferenceRepair(@LangID, @Ant_Resistance_ReferenceType) ref_AmoxicillinClavAcid
    ...
    (
     tlbActivityParameters ap_Amoxicillin
        ...
        INNER JOIN dbo.FN_GBL_ReferenceRepair(@LangID, @Ant_Resistance_ReferenceType) ref_Amoxicillin
    ...
    (
     tlbActivityParameters ap_Aztreonam
        ...
        INNER JOIN dbo.FN_GBL_ReferenceRepair(@LangID, @Ant_Resistance_ReferenceType) ref_Aztreonam
    ...
    (
     tlbActivityParameters ap_Azithromicin
        ...
        INNER JOIN dbo.FN_GBL_ReferenceRepair(@LangID, @Ant_Resistance_ReferenceType) ref_Azithromicin
    ...
    (
     tlbActivityParameters ap_Carbenicillin
        ...
        INNER JOIN dbo.FN_GBL_ReferenceRepair(@LangID, @Ant_Resistance_ReferenceType) ref_Carbenicillin
    ...
    (
     tlbActivityParameters ap_Cefazolin
        ...
        INNER JOIN dbo.FN_GBL_ReferenceRepair(@LangID, @Ant_Resistance_ReferenceType) ref_Cefazolin
    ...
    (
     tlbActivityParameters ap_Cefotaxime
        ...
        INNER JOIN dbo.FN_GBL_ReferenceRepair(@LangID, @Ant_Resistance_ReferenceType) ref_Cefotaxime
    ...
    (
     tlbActivityParameters ap_Ceftazidime
        ...
        INNER JOIN dbo.FN_GBL_ReferenceRepair(@LangID, @Ant_Resistance_ReferenceType) ref_Ceftazidime
    ...
    (
     tlbActivityParameters ap_Cefotaxine
        ...
        INNER JOIN dbo.FN_GBL_ReferenceRepair(@LangID, @Ant_Resistance_ReferenceType) ref_Cefotaxine
    ...
    (
     tlbActivityParameters ap_Cefoperazone
        ...
        INNER JOIN dbo.FN_GBL_ReferenceRepair(@LangID, @Ant_Resistance_ReferenceType) ref_Cefoperazone
    ...
    (
     tlbActivityParameters ap_Choramphenicol
        ...
        INNER JOIN dbo.FN_GBL_ReferenceRepair(@LangID, @Ant_Resistance_ReferenceType) ref_Choramphenicol
    ...
    (
     tlbActivityParameters ap_Ceftriaxone
        ...
        INNER JOIN dbo.FN_GBL_ReferenceRepair(@LangID, @Ant_Resistance_ReferenceType) ref_Ceftriaxone
    ...
    (
     tlbActivityParameters ap_Cefepime
        ...
        INNER JOIN dbo.FN_GBL_ReferenceRepair(@LangID, @Ant_Resistance_ReferenceType) ref_Cefepime
    ...
    (
     tlbActivityParameters ap_Cefoxitine
        ...
        INNER JOIN dbo.FN_GBL_ReferenceRepair(@LangID, @Ant_Resistance_ReferenceType) ref_Cefoxitine
    ...
    (
     tlbActivityParameters ap_Ciprofloxacin
        ...
        INNER JOIN dbo.FN_GBL_ReferenceRepair(@LangID, @Ant_Resistance_ReferenceType) ref_Ciprofloxacin
    ...
    (
     tlbActivityParameters ap_ColistineColomycin
        ...
        INNER JOIN dbo.FN_GBL_ReferenceRepair(@LangID, @Ant_Resistance_ReferenceType) ref_ColistineColomycin
    ...
    (
     tlbActivityParameters ap_Cefuroxime
        ...
        INNER JOIN dbo.FN_GBL_ReferenceRepair(@LangID, @Ant_Resistance_ReferenceType) ref_Cefuroxime
    ...
    (
     tlbActivityParameters ap_Cephalotin
        ...
        INNER JOIN dbo.FN_GBL_ReferenceRepair(@LangID, @Ant_Resistance_ReferenceType) ref_Cephalotin
    ...
    (
     tlbActivityParameters ap_Clindamycin
        ...
        INNER JOIN dbo.FN_GBL_ReferenceRepair(@LangID, @Ant_Resistance_ReferenceType) ref_Clindamycin
    ...
    (
     tlbActivityParameters ap_Doxycycline
        ...
        INNER JOIN dbo.FN_GBL_ReferenceRepair(@LangID, @Ant_Resistance_ReferenceType) ref_Doxycycline
    ...
    (
     tlbActivityParameters ap_Erythromycin
        ...
        INNER JOIN dbo.FN_GBL_ReferenceRepair(@LangID, @Ant_Resistance_ReferenceType) ref_Erythromycin
    ...
    (
     tlbActivityParameters ap_Fosfumycin
        ...
        INNER JOIN dbo.FN_GBL_ReferenceRepair(@LangID, @Ant_Resistance_ReferenceType) ref_Fosfumycin
    ...
    (
     tlbActivityParameters ap_Gentamicin
        ...
        INNER JOIN dbo.FN_GBL_ReferenceRepair(@LangID, @Ant_Resistance_ReferenceType) ref_Gentamicin
    ...
    (
     tlbActivityParameters ap_Imipenem
        ...
        INNER JOIN dbo.FN_GBL_ReferenceRepair(@LangID, @Ant_Resistance_ReferenceType) ref_Imipenem
    ...
    (
     tlbActivityParameters ap_Norfloxacin
        ...
        INNER JOIN dbo.FN_GBL_ReferenceRepair(@LangID, @Ant_Resistance_ReferenceType) ref_Norfloxacin
    ...
    (
     tlbActivityParameters ap_NalidixicAcid
        ...
        INNER JOIN dbo.FN_GBL_ReferenceRepair(@LangID, @Ant_Resistance_ReferenceType) ref_NalidixicAcid
    ...
    (
     tlbActivityParameters ap_Nitrofurantoin
        ...
        INNER JOIN dbo.FN_GBL_ReferenceRepair(@LangID, @Ant_Resistance_ReferenceType) ref_Nitrofurantoin
    ...
    (
     tlbActivityParameters ap_Netilmicin
        ...
        INNER JOIN dbo.FN_GBL_ReferenceRepair(@LangID, @Ant_Resistance_ReferenceType) ref_Netilmicin
    ...
    (
     tlbActivityParameters ap_Ofloxacin
        ...
        INNER JOIN dbo.FN_GBL_ReferenceRepair(@LangID, @Ant_Resistance_ReferenceType) ref_Ofloxacin
    ...
    (
     tlbActivityParameters ap_Oxacillin
        ...
        INNER JOIN dbo.FN_GBL_ReferenceRepair(@LangID, @Ant_Resistance_ReferenceType) ref_Oxacillin
    ...
    (
     tlbActivityParameters ap_Penicillin
        ...
        INNER JOIN dbo.FN_GBL_ReferenceRepair(@LangID, @Ant_Resistance_ReferenceType) ref_Penicillin
    ...
    (
     tlbActivityParameters ap_Piperacillin
        ...
        INNER JOIN dbo.FN_GBL_ReferenceRepair(@LangID, @Ant_Resistance_ReferenceType) ref_Piperacillin
    ...
    (
     tlbActivityParameters ap_Rifampin
        ...
        INNER JOIN dbo.FN_GBL_ReferenceRepair(@LangID, @Ant_Resistance_ReferenceType) ref_Rifampin
    ...
    (
     tlbActivityParameters ap_Streptomicin 
        ...
        INNER JOIN dbo.FN_GBL_ReferenceRepair(@LangID, @Ant_Resistance_ReferenceType) ref_Streptomicin 
    ...
    (
     tlbActivityParameters ap_Sulfonamides
        ...
        INNER JOIN dbo.FN_GBL_ReferenceRepair(@LangID, @Ant_Resistance_ReferenceType) ref_Sulfonamides
    ...
    (
     tlbActivityParameters ap_Tetracycline
        ...
        INNER JOIN dbo.FN_GBL_ReferenceRepair(@LangID, @Ant_Resistance_ReferenceType) ref_Tetracycline
    ...
    (
     tlbActivityParameters ap_Ticarcillin
        ...
        INNER JOIN dbo.FN_GBL_ReferenceRepair(@LangID, @Ant_Resistance_ReferenceType) ref_Ticarcillin
    ...
    (
     tlbActivityParameters ap_Tobramycin
        ...
        INNER JOIN dbo.FN_GBL_ReferenceRepair(@LangID, @Ant_Resistance_ReferenceType) ref_Tobramycin
    ...
    (
     tlbActivityParameters ap_TrimethoprimSulfo
        ...
        INNER JOIN dbo.FN_GBL_ReferenceRepair(@LangID, @Ant_Resistance_ReferenceType) ref_TrimethoprimSulfo
    ...
    (
     tlbActivityParameters ap_Vancomycin
        ...
        INNER JOIN dbo.FN_GBL_ReferenceRepair(@LangID, @Ant_Resistance_ReferenceType) ref_Vancomycin
...
(	strOrganizationName	,	 --1
	strOrganizationAddress	, --2
	strCulture, --4
	datDateTestConducted,		--6
	strAmikacin, --8
	strAmpicillin, --9
