...
--*************************************************************************
-- Name 				: report.USP_REP_VET_IndicatorsDetail
-- DescriptiON			: Select data for Veterinary Data Indicators report - detailed mode..
--          
-- Author               : Srini Goli
-- Revision History
...
EXEC report.USP_REP_VET_IndicatorsDetail @LangID=N'en', @FromYear = 2017, @ToYear = 2017, @FromMonth = 1, @ToMonth = 12, @OrganizationEntered = 48130000000
EXEC REPORT.USP_GBL_LKUP_BaseRef_GetList 'en','Organization Abbreviation',96
*/

CREATE PROCEDURE [Report].[USP_REP_VET_IndicatorsDetail]
    (
		...
		, @OrganizationID AS VARCHAR(50) = NULL -- note: this is not selected value from the filter. This is current organization 
		, @idfUserID AS VARCHAR(50) = NULL
    )
AS BEGIN
...
/*	DECLARE @LangID AS NVARCHAR (10) = N'en'
	...
	JOIN report.FN_GBL_ReferenceRepair_GET(@LangID, 19000132 /*Report Additional Text*/) rat ON
	...
	JOIN report.FN_GBL_ReferenceRepair_GET(@LangID, 19000045 /*Organization Abbreviation*/) oa ON
