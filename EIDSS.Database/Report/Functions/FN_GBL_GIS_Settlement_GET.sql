...
-- Testing code:
/*
 SELECT * FROM report.FN_GBL_GIS_Settlement_GET('en',19000004) --Settlement
*/
-- ************************************************************************************************


CREATE FUNCTION [Report].[FN_GBL_GIS_Settlement_GET](@LangID  NVARCHAR(50), @type BIGINT)
...
BEGIN
	...
	FROM report.FN_GBL_GIS_ReferenceRepair_GET(@LangID, 19000004 /*Settlement*/) s
	LEFT JOIN report.FN_GBL_GIS_ReferenceRepair_GET(@LangID, 19000002 /*Rayon*/) rr
