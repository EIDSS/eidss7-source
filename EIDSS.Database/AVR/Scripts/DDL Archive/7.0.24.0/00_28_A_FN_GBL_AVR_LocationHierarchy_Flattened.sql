...
/****** Object:  UserDefinedFunction [dbo].[FN_GBL_AVR_LocationHierarchy_Flattened]    Script Date: 4/17/2023 10:54:47 AM ******/
SET ANSI_NULLS ON
GO
...
-- =============================================
CREATE OR ALTER FUNCTION [dbo].[FN_GBL_AVR_LocationHierarchy_Flattened] 
(
