CREATE TABLE [dbo].[tasView] (
    ...
    [rowguid]                   UNIQUEIDENTIFIER CONSTRAINT [DF_tasView_rowguid] DEFAULT (newsequentialid()) ROWGUIDCOL NOT NULL,
    [SourceSystemNameID]        BIGINT           NULL,
    [SourceSystemKeyValue]      NVARCHAR (MAX)   NULL,
    [AuditCreateUser]           NVARCHAR (200)   NULL,
    [AuditCreateDTM]            DATETIME         CONSTRAINT [DF_tasView_CreateDTM] DEFAULT (getdate()) NULL,
