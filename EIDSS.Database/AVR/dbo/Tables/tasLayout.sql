CREATE TABLE [dbo].[tasLayout] (
    ...
    [rowguid]                        UNIQUEIDENTIFIER CONSTRAINT [DF_tasLayout_rowguid] DEFAULT (newsequentialid()) ROWGUIDCOL NOT NULL,
    [SourceSystemNameID]             BIGINT           NULL,
    [SourceSystemKeyValue]           NVARCHAR (MAX)   NULL,
    [AuditCreateUser]                NVARCHAR (200)   NULL,
    [AuditCreateDTM]                 DATETIME         CONSTRAINT [DF_tasLayout_CreateDTM] DEFAULT (getdate()) NULL,
