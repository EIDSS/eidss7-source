CREATE TABLE [dbo].[tasMapImage] (
    ...
    [rowguid]              UNIQUEIDENTIFIER CONSTRAINT [DF_tasMapImage_rowguid] DEFAULT (newsequentialid()) ROWGUIDCOL NOT NULL,
    [SourceSystemNameID]   BIGINT           NULL,
    [SourceSystemKeyValue] NVARCHAR (MAX)   NULL,
    [AuditCreateUser]      NVARCHAR (200)   NULL,
    [AuditCreateDTM]       DATETIME         CONSTRAINT [DF_tasMapImage_CreateDTM] DEFAULT (getdate()) NULL,
