CREATE TABLE [dbo].[tasQuerySearchField] (
    ...
    [rowguid]              UNIQUEIDENTIFIER CONSTRAINT [DF_tasQuerySearchField_rowguid] DEFAULT (newsequentialid()) ROWGUIDCOL NOT NULL,
    [SourceSystemNameID]   BIGINT           NULL,
    [SourceSystemKeyValue] NVARCHAR (MAX)   NULL,
    [AuditCreateUser]      NVARCHAR (200)   NULL,
    [AuditCreateDTM]       DATETIME         CONSTRAINT [DF_tasQuerySearchField_CreateDTM] DEFAULT (getdate()) NULL,
