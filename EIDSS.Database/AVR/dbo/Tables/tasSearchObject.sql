CREATE TABLE [dbo].[tasSearchObject] (
    ...
    [intRowStatus]         INT              CONSTRAINT [DF__tasSearch__intRo__52102116] DEFAULT ((0)) NOT NULL,
    [blnShowReportType]    BIT              CONSTRAINT [Def_0_tasSearchObject__blnShowReportType] DEFAULT ((0)) NOT NULL,
    [strReservedAttribute] NVARCHAR (MAX)   NULL,
    [SourceSystemNameID]   BIGINT           NULL,
    [SourceSystemKeyValue] NVARCHAR (MAX)   NULL,
    [AuditCreateUser]      NVARCHAR (200)   NULL,
    [AuditCreateDTM]       DATETIME         CONSTRAINT [DF_tasSearchObject_CreateDTM] DEFAULT (getdate()) NULL,
