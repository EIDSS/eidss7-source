CREATE TABLE [dbo].[tasLayoutToMapImage] (
    ...
    [rowguid]              UNIQUEIDENTIFIER CONSTRAINT [DF_tasLayoutToMapImage_rowguid] DEFAULT (newsequentialid()) ROWGUIDCOL NOT NULL,
    [SourceSystemNameID]   BIGINT           NULL,
    [SourceSystemKeyValue] NVARCHAR (MAX)   NULL,
    [AuditCreateUser]      NVARCHAR (200)   NULL,
    [AuditCreateDTM]       DATETIME         CONSTRAINT [DF_tasLayoutToMapImage_CreateDTM] DEFAULT (getdate()) NULL,
