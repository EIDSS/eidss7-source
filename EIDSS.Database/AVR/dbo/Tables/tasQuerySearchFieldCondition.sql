CREATE TABLE [dbo].[tasQuerySearchFieldCondition] (
    ...
    [rowguid]                      UNIQUEIDENTIFIER CONSTRAINT [DF_tasQuerySearchFieldCondition_rowguid] DEFAULT (newsequentialid()) ROWGUIDCOL NOT NULL,
    [SourceSystemNameID]           BIGINT           NULL,
    [SourceSystemKeyValue]         NVARCHAR (MAX)   NULL,
    [AuditCreateUser]              NVARCHAR (200)   NULL,
    [AuditCreateDTM]               DATETIME         CONSTRAINT [DF_tasQuerySearchFieldCondition_CreateDTM] DEFAULT (getdate()) NULL,
