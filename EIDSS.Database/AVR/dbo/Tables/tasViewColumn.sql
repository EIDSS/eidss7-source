CREATE TABLE [dbo].[tasViewColumn] (
    ...
    [rowguid]                  UNIQUEIDENTIFIER CONSTRAINT [DF_tasViewColumn_rowguid] DEFAULT (newsequentialid()) ROWGUIDCOL NOT NULL,
    [SourceSystemNameID]       BIGINT           NULL,
    [SourceSystemKeyValue]     NVARCHAR (MAX)   NULL,
    [AuditCreateUser]          NVARCHAR (200)   NULL,
    [AuditCreateDTM]           DATETIME         CONSTRAINT [DF_tasViewColumn_CreateDTM] DEFAULT (getdate()) NULL,
