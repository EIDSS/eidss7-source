CREATE TABLE [dbo].[tasQueryConditionGroup] (
    ...
    [rowguid]                      UNIQUEIDENTIFIER CONSTRAINT [DF_tasQueryConditionGroup_rowguid] DEFAULT (newsequentialid()) ROWGUIDCOL NOT NULL,
    [SourceSystemNameID]           BIGINT           NULL,
    [SourceSystemKeyValue]         NVARCHAR (MAX)   NULL,
    [AuditCreateUser]              NVARCHAR (200)   NULL,
    [AuditCreateDTM]               DATETIME         CONSTRAINT [DF_tasQueryConditionGroup_CreateDTM] DEFAULT (getdate()) NULL,
