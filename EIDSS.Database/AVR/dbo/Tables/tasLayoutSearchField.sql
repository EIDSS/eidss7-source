CREATE TABLE [dbo].[tasLayoutSearchField] (
    ...
    [rowguid]                    UNIQUEIDENTIFIER CONSTRAINT [DF_tasLayoutSearchField_rowguid] DEFAULT (newsequentialid()) ROWGUIDCOL NOT NULL,
    [SourceSystemNameID]         BIGINT           NULL,
    [SourceSystemKeyValue]       NVARCHAR (MAX)   NULL,
    [AuditCreateUser]            NVARCHAR (200)   NULL,
    [AuditCreateDTM]             DATETIME         CONSTRAINT [DF_tasLayoutSearchField_CreateDTM] DEFAULT (getdate()) NULL,
