...
CREATE FUNCTION [dbo].[fnGisExtendedReferenceRepair](
	@LangID  NVARCHAR(50), 
	@type BIGINT
)  
RETURNS TABLE  
...
LEFT JOIN gisStringNameTranslation AS snt ON snt.idfsGISBaseReference = br.idfsGISBaseReference AND snt.idfsLanguage = dbo.fnGetLanguageCode(@LangID)  
