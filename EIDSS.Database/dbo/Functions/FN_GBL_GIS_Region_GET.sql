...
-- Testing code:
/*
 SELECT * FROM dbo.FN_GBL_GIS_Region_GET('en',19000003)	--Region
*/
-- ************************************************************************************************


CREATE FUNCTION [dbo].[FN_GBL_GIS_Region_GET](@LangID  NVARCHAR(50), @type BIGINT)
...
BEGIN
	...
	FROM dbo.FN_GBL_GIS_ReferenceRepair_GET(@LangID, 19000003 /*Region*/) r
