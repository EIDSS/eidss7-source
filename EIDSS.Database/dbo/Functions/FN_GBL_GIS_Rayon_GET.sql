...
-- Testing code:
/*
 SELECT * FROM dbo.FN_GBL_GIS_Rayon_GET('en',19000002) --Rayon
*/
-- ************************************************************************************************


CREATE FUNCTION [dbo].[FN_GBL_GIS_Rayon_GET](@LangID  NVARCHAR(50), @type BIGINT)
...
BEGIN
	...
	FROM dbo.FN_GBL_GIS_ReferenceRepair_GET(@LangID, 19000002 /*Rayon*/) rr
