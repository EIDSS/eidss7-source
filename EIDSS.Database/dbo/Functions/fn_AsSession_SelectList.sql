...
--
-- Sample:  SELECT * FROM fn_AsSession_SelectList ('ru')
-- Update History:
-- Last Modified Date   Updated By      Description
-- 10/14/2021           Steven Verner   Modified to point to EIDSS7 functions
-- ==================================================================================
CREATE     Function [dbo].[fn_AsSession_SelectList](
...
Left JOIN tlbCampaign ON tlbMonitoringSession.idfCampaign = tlbCampaign.idfCampaign AND tlbCampaign.intRowStatus = 0
LEFT JOIN FN_GBL_GIS_ReferenceRepair(@LangID,19000003) Region ON Region.idfsReference = tlbMonitoringSession.idfsRegion
LEFT JOIN FN_GBL_GIS_ReferenceRepair(@LangID,19000002) Rayon ON	Rayon.idfsReference = tlbMonitoringSession.idfsRayon
LEFT JOIN FN_GBL_GIS_ReferenceRepair(@LangID,19000004) Settlement ON Settlement.idfsReference = tlbMonitoringSession.idfsSettlement
LEFT JOIN FN_GBL_GIS_ReferenceRepair(@LangID,19000117) [Status] ON [Status].idfsReference = tlbMonitoringSession.idfsMonitoringSessionStatus
