...
--	Steven Verner   10/14/2021  Updated to use location hierarchy
/*
...
AS
    ...
    left join FN_GBL_Reference_GETList(@LangID,19000089) AreaType on AreaType.idfsReference = tlbStatistic.idfsStatisticAreaType
    -- )
