...
select dbo.FN_GBL_AddressString ('ru', 1)
*/

create function [dbo].[FN_GBL_AddressString]
	(
		@LangID nvarchar(50), 
		@GeoLocation bigint
	)
...
as
	...
	(
					gisSettlement 
		inner join  dbo.FN_GBL_GIS_ReferenceRepair_GET(@LangID, 19000005 /*'rftSettlementType'*/) rfSettlementType 
