...
CREATE VIEW [dbo].[Human_Case_and_Event_Tracking_AM]
as
...
LEFT JOIN fnReferenceRepair('hy', 19000046) [ref_sflHC_ReceivedByOffice] ON 
	[ref_sflHC_ReceivedByOffice].idfsReference = v.[sflHC_ReceivedByOffice_ID] 
LEFT JOIN fnReferenceRepair('hy', 19000046) [ref_sflHC_SentByOffice] ON 
	[ref_sflHC_SentByOffice].idfsReference = v.[sflHC_SentByOffice_ID] 
LEFT JOIN fnReferenceRepair('hy', 19000035) [ref_sflHC_PatientNotificationStatus] ON 
	[ref_sflHC_PatientNotificationStatus].idfsReference = v.[sflHC_PatientNotificationStatus_ID] 
LEFT JOIN fnReferenceRepair('hy', 19000041) [ref_sflHC_HospitalizationStatus] ON 
	[ref_sflHC_HospitalizationStatus].idfsReference = v.[sflHC_HospitalizationStatus_ID] 
LEFT JOIN fnReferenceRepair('hy', 19000019) [ref_sflHC_FinalDiagnosis] ON 
	[ref_sflHC_FinalDiagnosis].idfsReference = v.[sflHC_FinalDiagnosis_ID] 
LEFT JOIN fnReferenceRepair('hy', 19000011) [ref_sflHC_FinalCaseClassification] ON 
	[ref_sflHC_FinalCaseClassification].idfsReference = v.[sflHC_FinalCaseClassification_ID] 
LEFT JOIN fnReferenceRepair('hy', 19000100) [ref_sflHC_Hospitalization] ON 
	[ref_sflHC_Hospitalization].idfsReference = v.[sflHC_Hospitalization_ID] 
LEFT JOIN fnReferenceRepair('hy', 19000149) [ref_sflHC_NonNotifiableDiagnosis] ON 
	[ref_sflHC_NonNotifiableDiagnosis].idfsReference = v.[sflHC_NonNotifiableDiagnosis_ID] 
LEFT JOIN fnReferenceRepair('hy', 19000046) [ref_sflHC_FacilityWherePatientFSC] ON 
	[ref_sflHC_FacilityWherePatientFSC].idfsReference = v.[sflHC_FacilityWherePatientFSC_ID] 
LEFT JOIN fnReferenceRepair('hy', 19000111) [ref_sflHC_CaseProgressStatus] ON 
	[ref_sflHC_CaseProgressStatus].idfsReference = v.[sflHC_CaseProgressStatus_ID] 
LEFT JOIN fnReferenceRepair('hy', 19000150) [ref_sflHC_ReasonForNotCollectingSample] ON 
	[ref_sflHC_ReasonForNotCollectingSample].idfsReference = v.[sflHC_ReasonForNotCollectingSample_ID] 
LEFT JOIN fnReferenceRepair('hy', 19000019) [ref_sflHC_Diagnosis] ON 
	[ref_sflHC_Diagnosis].idfsReference = v.[sflHC_Diagnosis_ID] 
LEFT JOIN fnReferenceRepair('hy', 19000019) [ref_sflHC_ChangedDiagnosis] ON 
	[ref_sflHC_ChangedDiagnosis].idfsReference = v.[sflHC_ChangedDiagnosis_ID] 
LEFT JOIN fnReferenceRepair('hy', 19000045) [ref_sflHCDiagnosisHistory_Organization] ON 
	[ref_sflHCDiagnosisHistory_Organization].idfsReference = v.[sflHCDiagnosisHistory_Organization_ID] 
LEFT JOIN fnReferenceRepair('hy', 19000046) [ref_sflHCSample_CollectedByOffice] ON 
	[ref_sflHCSample_CollectedByOffice].idfsReference = v.[sflHCSample_CollectedByOffice_ID] 
	
LEFT JOIN fnGisExtendedReferenceRepair('hy', 19000003) [ref_GIS_sflHC_ResidenceRegion] ON 
	[ref_GIS_sflHC_ResidenceRegion].idfsReference = v.[sflHC_ResidenceRegion_ID] 
LEFT JOIN fnGisExtendedReferenceRepair('hy', 19000002) [ref_GIS_sflHC_ResidenceRayon] ON 
	[ref_GIS_sflHC_ResidenceRayon].idfsReference = v.[sflHC_ResidenceRayon_ID] 
LEFT JOIN fnGisExtendedReferenceRepair('hy', 19000004) [ref_GIS_sflHC_ResidenceSettlement] ON 
