...
CREATE VIEW [dbo].[Human_Case_Diagnosis_UA]
as
...
left join	fnReferenceRepair('uk', 19000019) [ref_sflHCDiagnosisHistory_ChangedDiagnosis] 
on			[ref_sflHCDiagnosisHistory_ChangedDiagnosis].idfsReference = v.[sflHCDiagnosisHistory_ChangedDiagnosis_ID] 
left join	fnReferenceRepair('uk', 19000019) [ref_sflHCDiagnosisHistory_PreviousDiagnosis] 
on			[ref_sflHCDiagnosisHistory_PreviousDiagnosis].idfsReference = v.[sflHCDiagnosisHistory_PreviousDiagnosis_ID] 
left join	fnReferenceRepair('uk', 19000087) [ref_sflHCTest_SampleType] 
