...
CREATE VIEW [dbo].[Human_Case_Persons_Place_Time_UA]
AS
...
LEFT JOIN fnReferenceRepair('uk', 19000064) [ref_sflHC_Outcome] ON 
	[ref_sflHC_Outcome].idfsReference = v.[sflHC_Outcome_ID] 
LEFT JOIN fnReferenceRepair('uk', 19000011) [ref_sflHC_InitialCaseClassification] ON 
	[ref_sflHC_InitialCaseClassification].idfsReference = v.[sflHC_InitialCaseClassification_ID] 
LEFT JOIN fnGisExtendedReferenceRepair('uk', 19000002) [ref_GIS_sflHC_PatientCRRayon] ON 
	[ref_GIS_sflHC_PatientCRRayon].idfsReference = v.[sflHC_PatientCRRayon_ID] 
LEFT JOIN fnGisExtendedReferenceRepair('uk', 19000003) [ref_GIS_sflHC_PatientCRRegion] ON 
...
LEFT JOIN fnReferenceRepair('uk', 19000054) [ref_sflHC_PatientNationality] ON 
...
LEFT JOIN 	fnReferenceRepair('uk', 19000043) [ref_sflHC_PatientSex] ON 
	[ref_sflHC_PatientSex].idfsReference = v.[sflHC_PatientSex_ID] 
LEFT JOIN fnReferenceRepair('uk', 19000061) [ref_sflHC_PatientOccupation] ON 
	[ref_sflHC_PatientOccupation].idfsReference = v.[sflHC_PatientOccupation_ID] 
LEFT JOIN fnReferenceRepair('uk', 19000042) [ref_sflHC_PatientAgeType] ON 
	[ref_sflHC_PatientAgeType].idfsReference = v.[sflHC_PatientAgeType_ID] 
LEFT JOIN fnGisExtendedReferenceRepair('uk', 19000002) [ref_GIS_sflHC_PatientEmpRayon] ON 
	[ref_GIS_sflHC_PatientEmpRayon].idfsReference = v.[sflHC_PatientEmpRayon_ID] 
LEFT JOIN fnGisExtendedReferenceRepair('uk', 19000003) [ref_GIS_sflHC_PatientEmpRegion] ON 
	[ref_GIS_sflHC_PatientEmpRegion].idfsReference = v.[sflHC_PatientEmpRegion_ID] 
LEFT JOIN fnGisExtendedReferenceRepair('uk', 19000004) [ref_GIS_sflHC_PatientEmpSettlement] ON 
	[ref_GIS_sflHC_PatientEmpSettlement].idfsReference = v.[sflHC_PatientEmpSettlement_ID] 
LEFT JOIN fnGisExtendedReferenceRepair('uk', 19000004) [ref_GIS_sflHC_PatientCRSettlement] ON 
