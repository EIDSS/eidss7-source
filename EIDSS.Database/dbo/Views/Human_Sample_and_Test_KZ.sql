...
CREATE VIEW [dbo].[Human_Sample_and_Test_KZ]
as
select		
...
left join	fnReferenceRepair('kk', 19000150) [ref_sflHC_ReasonForNotCollectingSample] 
...
left join	fnReferenceRepair('kk', 19000042) [ref_sflHC_PatientAgeType] 
on			[ref_sflHC_PatientAgeType].idfsReference = v.[sflHC_PatientAgeType_ID] 
left join	fnReferenceRepair('kk', 19000046) [ref_sflHCSample_CollectedByOffice] 
...
left join	fnReferenceRepair('kk', 19000087) [ref_sflHCSample_SampleType] 
...
left join	fnReferenceRepair('kk', 19000019) [ref_sflHCTest_Diagnosis] 
on			[ref_sflHCTest_Diagnosis].idfsReference = v.[sflHCTest_Diagnosis_ID] 
left join	fnReferenceRepair('kk', 19000001) [ref_sflHCTest_TestStatus] 
...
--Not needed--left join	fnReference('kk', 19000044) ref_None	-- Information String
