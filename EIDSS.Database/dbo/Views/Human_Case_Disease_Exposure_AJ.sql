...
CREATE VIEW [dbo].[Human_Case_Disease_Exposure_AJ]
AS
...
LEFT JOIN fnGisExtendedReferenceRepair('az-L', 19000003) [ref_GIS_sflHC_LocationRegion] ON 
	[ref_GIS_sflHC_LocationRegion].idfsReference = v.[sflHC_LocationRegion_ID] 
LEFT JOIN fnGisExtendedReferenceRepair('az-L', 19000002) [ref_GIS_sflHC_LocationRayon] ON 
	[ref_GIS_sflHC_LocationRayon].idfsReference = v.[sflHC_LocationRayon_ID] 
LEFT JOIN fnGisExtendedReferenceRepair('az-L', 19000004) [ref_GIS_sflHC_LocationSettlement] ON 
