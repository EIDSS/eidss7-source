...
-- ================================================================================================
-- Name: USSP_GBL_CONTACT_DEDUP_SET
--
-- Description: Inserts/updates and deletes contacts for human and outbreak modules during dedup.
--          
-- Author: Stephen Long
--
-- Revision History:
...
-- ---------------- ---------- -------------------------------------------------------------------
-- Mark Wilson     06/10/2022 Initial release 
-- ================================================================================================
CREATE PROCEDURE [dbo].[USSP_GBL_CONTACT_DEDUP_SET]
(
        ...
        BEGIN
            ...
            IF (@LocationId IS NOT NULL)
                EXECUTE dbo.USSP_GBL_ADDRESS_SET 
					@GeolocationID = @AddressId OUTPUT,
                    @ResidentTypeID = NULL,
                    @GroundTypeID = NULL,
         ...
         ELSE
            ...
            BEGIN
                ...
                EXEC dbo.USP_GBL_NEXTKEYID_GET 
					@tableName = 'tlbContactedCasePerson',
					@idfsKey = @ContactedCasePersonId OUTPUT;
