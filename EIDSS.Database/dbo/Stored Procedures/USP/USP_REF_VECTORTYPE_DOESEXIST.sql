-- ============================================================================
-- Name: USP_REF_VECTORTYPE_DOESEXIST
...
-- exec USP_REF_VECTORTYPE_DOESEXIST 'Fleas'
-- exec USP_REF_VECTORTYPE_DOESEXIST 'Test'
-- ============================================================================
CREATE PROCEDURE [dbo].[USP_REF_VECTORTYPE_DOESEXIST]
(
	@strName nvarchar(50)
)as
...
BEGIN
	BEGIN TRY
	Declare @exists bit
	Declare @idfsReferenceType bigint = (Select idfsReferenceType from trtReferenceType where strReferenceTypeName = 'Vector Type')
