...
-- Susan Nelsen       03/26/2020 Add CampaignToSampleTypeUID returned
-- Stephen Long       04/27/2020 Added legacy ID to the model.
--
-- Testing code:
-- ================================================================================================
...
BEGIN
	...
	BEGIN TRY
		SELECT tc.idfCampaign AS CampaignID,
			...
			cts.CampaignToSampleTypeUID AS CampaignToSampleTypeID,
			...
			tc.LegacyCampaignID AS LegacyID, 
