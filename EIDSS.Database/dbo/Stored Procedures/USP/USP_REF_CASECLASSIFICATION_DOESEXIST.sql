...
-- exec USP_REF_CASECLASSIFICATION_DOESEXIST 'Confirmed'
-- exec USP_REF_CASECLASSIFICATION_DOESEXIST 'Not tested'
-- ============================================================================
CREATE PROCEDURE [dbo].[USP_REF_CASECLASSIFICATION_DOESEXIST]
(
	@strName nvarchar(50)
)as
...
BEGIN
	BEGIN TRY
	Declare @exists bit
	Declare @idfsReferenceType bigint = (Select idfsReferenceType from trtReferenceType where strReferenceTypeName = 'Case Classification')
