...
-- Steven Verner	  03/26/2021 Added WITH RESULT SETS NONE on call to USP_GBL_NEXTKEYID_PRE_GET to accomodate EF POCO 
--
--								 Removed @returnCode and @returnMessage variables and instead
...
*/
-- ================================================================================================
CREATE PROCEDURE [dbo].[USP_GBL_NEXTKEYID_PRE_GET] 
(
