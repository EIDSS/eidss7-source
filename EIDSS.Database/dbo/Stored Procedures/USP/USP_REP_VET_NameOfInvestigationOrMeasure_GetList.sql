...
--*************************************************************************
-- Name 				: dbo.USP_REP_VET_NameOfInvestigationOrMeasure_GetList
...
EXEC dbo.USP_REP_VET_NameOfInvestigationOrMeasure_GetList 'en'
*/ 
 
CREATE PROCEDURE [dbo].[USP_REP_VET_NameOfInvestigationOrMeasure_GetList]
