...
-- Stephen Long     06/28/2023 Added defaults on site, organization and employee so the report
--                             will load correctly.
-- Stephen Long     07/05/2023 Fix on site permission deletion query.
-- ================================================================================================
CREATE PROCEDURE [dbo].[USP_VAS_MONITORING_SESSION_GETDetail]
(
    @LanguageID NVARCHAR(50),
    @MonitoringSessionID BIGINT,
    @UserSiteID BIGINT = 0,
    @UserOrganizationID BIGINT = 0,
