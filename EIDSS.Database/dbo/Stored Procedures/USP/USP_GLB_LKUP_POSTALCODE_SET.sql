...
--*************************************************************
-- Name 				: USP_GLB_LKUP_POSTALCODE_SET
-- Description			: Sets/Gets Postal Code for quick referencing in the system.
--          
...
--
-- Testing code:
-- EXEC USP_GLB_LKUP_POSTALCODE_SET @strStreetName, @idfsSettlement, @User, @idfsStreetID OUTPUT
--*************************************************************

CREATE PROCEDURE [dbo].[USP_GLB_LKUP_POSTALCODE_SET]
	(
			...
			BEGIN
				...
				ELSE
					BEGIN
						...
						EXEC dbo.USP_GBL_NEXTKEYID_GET 'tlbPostalCode', @idfPostalCode OUTPUT
