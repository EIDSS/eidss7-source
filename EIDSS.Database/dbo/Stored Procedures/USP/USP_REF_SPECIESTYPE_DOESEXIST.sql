...
-- Description:	Check to see if a species type currently exists by name
--                      
-- Author: Ricky Moss
-- Revision History:
...
-- f
-- exec USP_REF_SPECIESTYPE_DOESEXIST 'Lizard'
-- ============================================================================
CREATE PROCEDURE [dbo].[USP_REF_SPECIESTYPE_DOESEXIST]
(
	@strName nvarchar(50)
)as
...
BEGIN
	BEGIN TRY
	Declare @exists bit
	Declare @idfsReferenceType bigint = (Select idfsReferenceType from trtReferenceType where strReferenceTypeName = 'Species List')
