...
--	    Mark Wilson     8/24/22 changed join for humanmaster to human copy
--
 --BEGIN tran
 --EXEC USP_HUM_COPYHUMANACTUALTOHUMAN @idfHumanActual, @idfHuman OUT
--*************************************************************
CREATE PROCEDURE [dbo].[USP_OMM_COPYHUMANACTUALTOHUMAN]
(
	...
	BEGIN TRY
			...
			IF EXISTS	(
				...
				BEGIN
					...
					FROM	tlbHuman h
					INNER JOIN tlbHumanActual ha ON ha.idfHumanActual = h.idfHumanActual  -- MCW changed ha.idfHumanActual to h.idfHumanActual
