...
-- Description:				06/19/2017: Created based on V6 spAccessoryCode_SelectLookup :  V7 USP65
--                          select list of records from the following tables trtHACodeList and FN_GBL_ReferenceRepair
...
EXEC	@return_value = [dbo].[USP_GBL_LKUP_HACODE_GETList]
		@LangID = N'en'
...
--=====================================================================================================
CREATE  PROCEDURE [dbo].[USP_GBL_LKUP_HACODE_GETList] 
(
