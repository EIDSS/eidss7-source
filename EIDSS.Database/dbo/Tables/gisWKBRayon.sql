CREATE TABLE [dbo].[gisWKBRayon] (
    ...
    [rowguid]                UNIQUEIDENTIFIER CONSTRAINT [DF_gisWKBRayon_rowguid] DEFAULT (newsequentialid()) ROWGUIDCOL NOT NULL,
    [SourceSystemNameID]     BIGINT           NULL,
    [SourceSystemKeyValue]   NVARCHAR (MAX)   NULL,
    [AuditCreateUser]        NVARCHAR (200)   NULL,
    [AuditCreateDTM]         DATETIME         CONSTRAINT [DF_gisWKBRayon_CreateDTM] DEFAULT (getdate()) NULL,
