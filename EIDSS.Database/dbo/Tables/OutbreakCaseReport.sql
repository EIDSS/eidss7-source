CREATE TABLE [dbo].[OutbreakCaseReport] (
    ...
    [rowguid]                      UNIQUEIDENTIFIER CONSTRAINT [DF_OutbreakCaseReport_rowguid] DEFAULT (newsequentialid()) ROWGUIDCOL NOT NULL,
    [SourceSystemNameID]           BIGINT           CONSTRAINT [DEF_OutbreakCaseReport_SourceSystemNameID] DEFAULT ((10519001)) NULL,
    [SourceSystemKeyValue]         NVARCHAR (MAX)   NULL,
    [CaseEPIObservationID]         BIGINT           NULL,
    ...
    CONSTRAINT [FK_OutbreakCase_tlbObservation_CaseEPIObservationID] FOREIGN KEY ([CaseEPIObservationID]) REFERENCES [dbo].[tlbObservation] ([idfObservation]),
...
CREATE INDEX [IX_OutbreakCaseReport_idfVetCase] ON [dbo].[OutbreakCaseReport] ([idfVetCase])

GO

CREATE INDEX [IX_OutbreakCaseReport_idfHumanCase] ON [dbo].[OutbreakCaseReport] ([idfHumanCase])

GO

CREATE INDEX [IX_OutbreakCaseReport_idfOutbreak] ON [dbo].[OutbreakCaseReport] ([idfOutbreak])
