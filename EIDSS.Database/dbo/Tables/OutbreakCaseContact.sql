CREATE TABLE [dbo].[OutbreakCaseContact] (
    ...
    [SourceSystemNameID]          BIGINT           CONSTRAINT [DEF_OutbreakCaseContact_SourceSystemNameID] DEFAULT ((10519001)) NULL,
...
CREATE INDEX [IX_OutbreakCaseContact_OutBreakCaseReportUID] ON [dbo].[OutbreakCaseContact] ([OutBreakCaseReportUID])
