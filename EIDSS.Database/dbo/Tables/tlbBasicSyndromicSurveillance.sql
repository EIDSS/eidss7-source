CREATE TABLE [dbo].[tlbBasicSyndromicSurveillance] (
    ...
    [SourceSystemNameID]                     BIGINT           CONSTRAINT [DEF_tlbBasicSyndromicSurveillance_SourceSystemNameID] DEFAULT ((10519001)) NULL,
    [SourceSystemKeyValue]                   NVARCHAR (MAX)   NULL,
    [AuditCreateUser]                        NVARCHAR (200)   NULL,
    [AuditCreateDTM]                         DATETIME         CONSTRAINT [DF_tlbBasicSyndromicSurveillance_CreateDTM] DEFAULT (getdate()) NULL,
