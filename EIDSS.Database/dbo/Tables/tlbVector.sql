CREATE TABLE [dbo].[tlbVector] (
    ...
    [SourceSystemNameID]           BIGINT           CONSTRAINT [DEF_tlbVector_SourceSystemNameID] DEFAULT ((10519001)) NULL,
    [SourceSystemKeyValue]         NVARCHAR (MAX)   NULL,
    [AuditCreateUser]              NVARCHAR (200)   NULL,
    [AuditCreateDTM]               DATETIME         CONSTRAINT [DF_tlbVector_CreateDTM] DEFAULT (getdate()) NULL,
