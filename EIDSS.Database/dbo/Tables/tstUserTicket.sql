CREATE TABLE [dbo].[tstUserTicket] (
    ...
    [rowguid]              UNIQUEIDENTIFIER CONSTRAINT [DF_tstUserTicket_rowguid] DEFAULT (newsequentialid()) ROWGUIDCOL NOT NULL,
    [SourceSystemNameID]   BIGINT           NULL,
    [SourceSystemKeyValue] NVARCHAR (MAX)   NULL,
    [AuditCreateUser]      NVARCHAR (200)   NULL,
    [AuditCreateDTM]       DATETIME         CONSTRAINT [DF_tstUserTicket_CreateDTM] DEFAULT (getdate()) NULL,
