CREATE TABLE [dbo].[tlbVectorSurveillanceSessionSummary] (
    ...
    [SourceSystemNameID]           BIGINT           CONSTRAINT [DEF_tlbVectorSurveillanceSessionSummary_SourceSystemNameID] DEFAULT ((10519001)) NULL,
    [SourceSystemKeyValue]         NVARCHAR (MAX)   NULL,
    [AuditCreateUser]              NVARCHAR (200)   NULL,
    [AuditCreateDTM]               DATETIME         CONSTRAINT [DF_tlbVectorSurveillanceSessionSummary_CreateDTM] DEFAULT (getdate()) NULL,
...
GO
CREATE NONCLUSTERED INDEX [tlbVectorSurveillanceSessionSummary_idfVectorSurveillanceSession]
    ON [dbo].[tlbVectorSurveillanceSessionSummary]([idfVectorSurveillanceSession] ASC);
