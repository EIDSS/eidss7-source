CREATE TABLE [dbo].[tstUserTableLocal] (
    ...
    [rowguid]              UNIQUEIDENTIFIER CONSTRAINT [DF_tstUserTableLocal_rowguid] DEFAULT (newsequentialid()) ROWGUIDCOL NOT NULL,
    [SourceSystemNameID]   BIGINT           NULL,
    [SourceSystemKeyValue] NVARCHAR (MAX)   NULL,
    [AuditCreateUser]      NVARCHAR (200)   NULL,
    [AuditCreateDTM]       DATETIME         CONSTRAINT [DF_tstUserTableLocal_CreateDTM] DEFAULT (getdate()) NULL,
