CREATE TABLE [dbo].[gisUserLayer] (
    ...
    [intDeleted]           INT              CONSTRAINT [DF__gisUserLa__intDe__471F2805] DEFAULT ((0)) NOT NULL,
    [SourceSystemNameID]   BIGINT           NULL,
    [SourceSystemKeyValue] NVARCHAR (MAX)   NULL,
    [AuditCreateUser]      NVARCHAR (200)   NULL,
    [AuditCreateDTM]       DATETIME         CONSTRAINT [DF_gisUserLayer_CreateDTM] DEFAULT (getdate()) NULL,
