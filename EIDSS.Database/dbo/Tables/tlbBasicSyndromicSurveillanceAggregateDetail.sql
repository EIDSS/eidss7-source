CREATE TABLE [dbo].[tlbBasicSyndromicSurveillanceAggregateDetail] (
    ...
    [SourceSystemNameID]   BIGINT           CONSTRAINT [DEF_tlbBasicSyndromicSurveillanceAggregateDetail_SourceSystemNameID] DEFAULT ((10519001)) NULL,
    [SourceSystemKeyValue] NVARCHAR (MAX)   NULL,
    [AuditCreateUser]      NVARCHAR (200)   NULL,
    [AuditCreateDTM]       DATETIME         CONSTRAINT [DF_tlbBasicSyndromicSurveillanceAggregateDetail_CreateDTM] DEFAULT (getdate()) NULL,
