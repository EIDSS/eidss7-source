CREATE TABLE [dbo].[tlbAggrVetCaseMTX] (
    ...
    [SourceSystemNameID]   BIGINT           CONSTRAINT [DEF_tlbAggrVetCaseMTX_SourceSystemNameID] DEFAULT ((10519001)) NULL,
    [SourceSystemKeyValue] NVARCHAR (MAX)   NULL,
    [AuditCreateUser]      NVARCHAR (200)   NULL,
    [AuditCreateDTM]       DATETIME         CONSTRAINT [DF_tlbAggrVetCaseMTX_CreateDTM] DEFAULT (getdate()) NULL,
