CREATE TABLE [dbo].[tstBarcodeLayout] (
    ...
    [rowguid]              UNIQUEIDENTIFIER CONSTRAINT [DF_tstBarcodeLayout_rowguid] DEFAULT (newsequentialid()) ROWGUIDCOL NOT NULL,
    [SourceSystemNameID]   BIGINT           NULL,
    [SourceSystemKeyValue] NVARCHAR (MAX)   NULL,
    [AuditCreateUser]      NVARCHAR (200)   NULL,
    [AuditCreateDTM]       DATETIME         CONSTRAINT [DF_tstBarcodeLayout_CreateDTM] DEFAULT (getdate()) NULL,
