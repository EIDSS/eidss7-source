CREATE TABLE [dbo].[tlbVectorSurveillanceSessionSummaryDiagnosis] (
    ...
    [SourceSystemNameID]            BIGINT           CONSTRAINT [DEF_tlbVectorSurveillanceSessionSummaryDiagnosis_SourceSystemNameID] DEFAULT ((10519001)) NULL,
    [SourceSystemKeyValue]          NVARCHAR (MAX)   NULL,
    [AuditCreateUser]               NVARCHAR (200)   NULL,
    [AuditCreateDTM]                DATETIME         CONSTRAINT [DF_tlbVectorSurveillanceSessionSummaryDiagnosis_CreateDTM] DEFAULT (getdate()) NULL,
