CREATE TABLE [dbo].[tlbAggrDiagnosticActionMTX] (
    ...
    [SourceSystemNameID]         BIGINT           CONSTRAINT [DEF_tlbAggrDiagnosticActionMTX_SourceSystemNameID] DEFAULT ((10519001)) NULL,
    [SourceSystemKeyValue]       NVARCHAR (MAX)   NULL,
    [AuditCreateUser]            NVARCHAR (200)   NULL,
    [AuditCreateDTM]             DATETIME         CONSTRAINT [DF_tlbAggrDiagnosticActionMTX_CreateDTM] DEFAULT (getdate()) NULL,
