CREATE TABLE [dbo].[tlbAggrMatrixVersionHeader] (
    ...
    [SourceSystemNameID]   BIGINT           CONSTRAINT [DEF_tlbAggrMatrixVersionHeader_SourceSystemNameID] DEFAULT ((10519001)) NULL,
    [SourceSystemKeyValue] NVARCHAR (MAX)   NULL,
    [AuditCreateUser]      NVARCHAR (200)   NULL,
    [AuditCreateDTM]       DATETIME         CONSTRAINT [DF_tlbAggrMatrixVersionHeader_CreateDTM] DEFAULT (getdate()) NULL,
