CREATE TABLE [dbo].[tdeDataExportDetail] (
    ...
    [rowguid]                    UNIQUEIDENTIFIER CONSTRAINT [DF_tdeDataExportDetail_rowguid] DEFAULT (newsequentialid()) ROWGUIDCOL NOT NULL,
    [SourceSystemNameID]         BIGINT           NULL,
    [SourceSystemKeyValue]       NVARCHAR (MAX)   NULL,
    [AuditCreateUser]            NVARCHAR (200)   NULL,
    [AuditCreateDTM]             DATETIME         CONSTRAINT [DF_tdeDataExportDetail_CreateDTM] DEFAULT (getdate()) NULL,
