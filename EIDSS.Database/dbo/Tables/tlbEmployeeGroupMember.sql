CREATE TABLE [dbo].[tlbEmployeeGroupMember] (
    ...
    [SourceSystemNameID]   BIGINT           CONSTRAINT [DEF_tlbEmployeeGroupMember_SourceSystemNameID] DEFAULT ((10519001)) NULL,
    [SourceSystemKeyValue] NVARCHAR (MAX)   NULL,
    [AuditCreateUser]      NVARCHAR (200)   NULL,
    [AuditCreateDTM]       DATETIME         CONSTRAINT [DF_tlbEmployeeGroupMember_CreateDTM] DEFAULT (getdate()) NULL,
...
GO
CREATE NONCLUSTERED INDEX [IX_tlbEmployeeGroupMember]
    ON [dbo].[tlbEmployeeGroupMember]([idfEmployee] ASC, [intRowStatus] ASC);
