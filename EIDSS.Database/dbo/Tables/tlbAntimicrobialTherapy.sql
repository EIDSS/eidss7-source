CREATE TABLE [dbo].[tlbAntimicrobialTherapy] (
    ...
    [SourceSystemNameID]          BIGINT           CONSTRAINT [DEF_tlbAntimicrobialTherapy_SourceSystemNameID] DEFAULT ((10519001)) NULL,
    [SourceSystemKeyValue]        NVARCHAR (MAX)   NULL,
    [AuditCreateUser]             NVARCHAR (200)   NULL,
    [AuditCreateDTM]              DATETIME         CONSTRAINT [DF_tlbAntimicrobialTherapy_CreateDTM] DEFAULT (getdate()) NULL,
