CREATE TABLE [dbo].[tstEventActive] (
    ...
    [intRowNum]            BIGINT           IDENTITY (1, 1) NOT FOR REPLICATION NOT NULL,
    ...
    [rowguid]              UNIQUEIDENTIFIER CONSTRAINT [DF_tstEventActive_rowguid] DEFAULT (newsequentialid()) ROWGUIDCOL NOT NULL,
    [SourceSystemNameID]   BIGINT           NULL,
    [SourceSystemKeyValue] NVARCHAR (MAX)   NULL,
    [AuditCreateUser]      NVARCHAR (200)   NULL,
    [AuditCreateDTM]       DATETIME         CONSTRAINT [DF_tstEventActive_CreateDTM] DEFAULT (getdate()) NULL,
