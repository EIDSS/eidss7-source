CREATE TABLE [dbo].[tlbTransferOutMaterial] (
    ...
    [SourceSystemNameID]   BIGINT           CONSTRAINT [DEF_tlbTransferOutMaterial_SourceSystemNameID] DEFAULT ((10519001)) NULL,
    [SourceSystemKeyValue] NVARCHAR (MAX)   NULL,
    [AuditCreateUser]      NVARCHAR (200)   NULL,
    [AuditCreateDTM]       DATETIME         CONSTRAINT [DF_tlbTransferOutMaterial_CreateDTM] DEFAULT (getdate()) NULL,
...
GO
CREATE NONCLUSTERED INDEX [IX_tlbTransferOutMaterial_idfTransferOut_intRowStatus]
    ON [dbo].[tlbTransferOutMaterial]([idfTransferOut] ASC, [intRowStatus] ASC);
