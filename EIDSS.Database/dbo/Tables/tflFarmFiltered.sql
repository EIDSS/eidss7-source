CREATE TABLE [dbo].[tflFarmFiltered] (
    ...
    [SourceSystemNameID]   BIGINT           CONSTRAINT [DEF_tflFarmFiltered_SourceSystemNameID] DEFAULT ((10519001)) NULL,
    [SourceSystemKeyValue] NVARCHAR (MAX)   NULL,
    [AuditCreateUser]      NVARCHAR (200)   NULL,
    [AuditCreateDTM]       DATETIME         CONSTRAINT [DF_tflFarmFiltered_CreateDTM] DEFAULT (getdate()) NULL,
