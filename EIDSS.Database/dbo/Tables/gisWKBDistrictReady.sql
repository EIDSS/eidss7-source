CREATE TABLE [dbo].[gisWKBDistrictReady] (
    ...
    [rowguid]              UNIQUEIDENTIFIER CONSTRAINT [DF_gisWKBDistrictReady_rowguid] DEFAULT (newsequentialid()) ROWGUIDCOL NOT NULL,
    [SourceSystemNameID]   BIGINT           NULL,
    [SourceSystemKeyValue] NVARCHAR (MAX)   NULL,
    [AuditCreateUser]      NVARCHAR (200)   NULL,
    [AuditCreateDTM]       DATETIME         CONSTRAINT [DF_gisWKBDistrictReady_CreateDTM] DEFAULT (getdate()) NULL,
