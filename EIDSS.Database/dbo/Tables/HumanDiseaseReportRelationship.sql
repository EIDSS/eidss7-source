CREATE TABLE [dbo].[HumanDiseaseReportRelationship] (
    ...
    [rowguid]                           UNIQUEIDENTIFIER CONSTRAINT [DF_HumanDiseaseReportRelationship_rowguid] DEFAULT (newsequentialid()) ROWGUIDCOL NOT NULL,
    [SourceSystemNameID]                BIGINT           CONSTRAINT [DEF_HumanDiseaseReportRelationship_SourceSystemNameID] DEFAULT ((10519001)) NULL,
    [SourceSystemKeyValue]              NVARCHAR (MAX)   NULL,
    [RelatedToHumanDiseaseReportIdRoot] BIGINT           NULL,
    ...
    CONSTRAINT [FK_HumanDiseaseReportReln_tlbHumanCase_RelatedToHumanDiseaseReportIdRoot] FOREIGN KEY ([RelatedToHumanDiseaseReportIdRoot]) REFERENCES [dbo].[tlbHumanCase] ([idfHumanCase]),
