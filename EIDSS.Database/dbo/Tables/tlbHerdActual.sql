CREATE TABLE [dbo].[tlbHerdActual] (
    ...
    [SourceSystemNameID]   BIGINT           CONSTRAINT [DEF_tlbHerdActual_SourceSystemNameID] DEFAULT ((10519001)) NULL,
    [SourceSystemKeyValue] NVARCHAR (MAX)   NULL,
    [AuditCreateUser]      NVARCHAR (200)   NULL,
    [AuditCreateDTM]       DATETIME         CONSTRAINT [DF_tlbHerdActual_CreateDTM] DEFAULT (getdate()) NULL,
