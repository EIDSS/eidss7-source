CREATE TABLE [dbo].[tdeDataExportFFReference] (
    ...
    [rowguid]                 UNIQUEIDENTIFIER CONSTRAINT [DF_tdeDataExportFFReference_rowguid] DEFAULT (newsequentialid()) ROWGUIDCOL NOT NULL,
    [SourceSystemNameID]      BIGINT           NULL,
    [SourceSystemKeyValue]    NVARCHAR (MAX)   NULL,
    [AuditCreateUser]         NVARCHAR (200)   NULL,
    [AuditCreateDTM]          DATETIME         CONSTRAINT [DF_tdeDataExportFFReference_CreateDTM] DEFAULT (getdate()) NULL,
