CREATE TABLE [dbo].[tstNotificationShared] (
    ...
    [rowguid]                    UNIQUEIDENTIFIER CONSTRAINT [DF__tstNotifi__rowgu__09CA6A54] DEFAULT (newid()) ROWGUIDCOL NOT NULL,
    [strMaintenanceFlag]         NVARCHAR (20)    NULL,
    [SourceSystemNameID]         BIGINT           NULL,
    [SourceSystemKeyValue]       NVARCHAR (MAX)   NULL,
    [AuditCreateUser]            NVARCHAR (200)   NULL,
    [AuditCreateDTM]             DATETIME         CONSTRAINT [DF_tstNotificationShared_CreateDTM] DEFAULT (getdate()) NULL,
