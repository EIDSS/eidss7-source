CREATE TABLE [dbo].[tlbChangeDiagnosisHistory] (
    ...
    [SourceSystemNameID]        BIGINT           CONSTRAINT [DEF_tlbChangeDiagnosisHistory_SourceSystemNameID] DEFAULT ((10519001)) NULL,
    [SourceSystemKeyValue]      NVARCHAR (MAX)   NULL,
    [AuditCreateUser]           NVARCHAR (200)   NULL,
    [AuditCreateDTM]            DATETIME         CONSTRAINT [DF_tlbChangeDiagnosisHistory_CreateDTM] DEFAULT (getdate()) NULL,
