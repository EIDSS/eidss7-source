CREATE TABLE [dbo].[tstAggrSetting] (
    ...
    CONSTRAINT [XPKtstAggrSetting] PRIMARY KEY CLUSTERED ([idfsAggrCaseType] ASC, [idfCustomizationPackage] ASC, [idfsSite] ASC),
	...
	CONSTRAINT [FK_tstAggrSetting_tstSite_idfsSite] FOREIGN KEY([idfsSite]) REFERENCES [dbo].[tstSite] ([idfsSite]) NOT FOR REPLICATION 
);
