CREATE TABLE [dbo].[tstCustomizationPackageSettings] (
    ...
    [rowguid]                                  UNIQUEIDENTIFIER CONSTRAINT [DF_tstCustomizationPackageSettings_rowguid] DEFAULT (newsequentialid()) ROWGUIDCOL NOT NULL,
    [SourceSystemNameID]                       BIGINT           NULL,
    [SourceSystemKeyValue]                     NVARCHAR (MAX)   NULL,
    [AuditCreateUser]                          NVARCHAR (200)   NULL,
    [AuditCreateDTM]                           DATETIME         CONSTRAINT [DF_tstCustomizationPackageSettings_CreateDTM] DEFAULT (getdate()) NULL,
