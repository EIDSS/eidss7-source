CREATE TABLE [dbo].[tlbSpecies] (
    ...
    [SourceSystemNameID]     BIGINT           CONSTRAINT [DEF_tlbSpecies_SourceSystemNameID] DEFAULT ((10519001)) NULL,
    [SourceSystemKeyValue]   NVARCHAR (MAX)   NULL,
    [AuditCreateUser]        NVARCHAR (200)   NULL,
    [AuditCreateDTM]         DATETIME         CONSTRAINT [DF_tlbSpecies_CreateDTM] DEFAULT (getdate()) NULL,
    [AuditUpdateUser]        NVARCHAR (200)   NULL,
    [AuditUpdateDTM]         DATETIME         NULL,
    [idfsOutbreakCaseStatus] BIGINT           NULL,
    CONSTRAINT [XPKtlbSpecies] PRIMARY KEY CLUSTERED ([idfSpecies] ASC),
    CONSTRAINT [FK_tlbSpecies_OutbreakCaseStatus] FOREIGN KEY ([idfsOutbreakCaseStatus]) REFERENCES [dbo].[trtBaseReference] ([idfsBaseReference]),
...
GO
CREATE NONCLUSTERED INDEX [IX_tlbSpecies_idfHerd]
    ON [dbo].[tlbSpecies]([idfHerd] ASC);
