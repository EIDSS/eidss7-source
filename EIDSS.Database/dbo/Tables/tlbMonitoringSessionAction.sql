CREATE TABLE [dbo].[tlbMonitoringSessionAction] (
    ...
    [SourceSystemNameID]                BIGINT           CONSTRAINT [DEF_tlbMonitoringSessionAction_SourceSystemNameID] DEFAULT ((10519001)) NULL,
    [SourceSystemKeyValue]              NVARCHAR (MAX)   NULL,
    [AuditCreateUser]                   NVARCHAR (200)   NULL,
    [AuditCreateDTM]                    DATETIME         CONSTRAINT [DF_tlbMonitoringSessionAction_CreateDTM] DEFAULT (getdate()) NULL,
