CREATE TABLE [dbo].[tstNextNumbers] (
    ...
    [rowguid]                 UNIQUEIDENTIFIER CONSTRAINT [DF_tstNextNumbers_rowguid] DEFAULT (newsequentialid()) ROWGUIDCOL NOT NULL,
    [SourceSystemNameID]      BIGINT           NULL,
    [SourceSystemKeyValue]    NVARCHAR (MAX)   NULL,
    [AuditCreateUser]         NVARCHAR (200)   NULL,
    [AuditCreateDTM]          DATETIME         CONSTRAINT [DF_tstNextNumbers_CreateDTM] DEFAULT (getdate()) NULL,
    [AuditUpdateUser]         NVARCHAR (200)   NULL,
    [AuditUpdateDTM]          DATETIME         CONSTRAINT [Def_AuditUpdateDTM] DEFAULT (getdate()) NULL,
    [strSpecialChar]          NVARCHAR (2)     NULL,
    [intPreviousNumberValue]  BIGINT           NULL,
