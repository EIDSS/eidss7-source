CREATE TABLE [dbo].[gisStringNameTranslation] (
    ...
    [intRowStatus]         INT              CONSTRAINT [DF__gisString__intRo__3EFD4CA2] DEFAULT ((0)) NOT NULL,
    [strMaintenanceFlag]   NVARCHAR (20)    NULL,
    [strReservedAttribute] NVARCHAR (MAX)   NULL,
    [SourceSystemNameID]   BIGINT           NULL,
    [SourceSystemKeyValue] NVARCHAR (MAX)   NULL,
    [AuditCreateUser]      NVARCHAR (200)   NULL,
    [AuditCreateDTM]       DATETIME         CONSTRAINT [DF_gisStringNameTranslation_CreateDTM] DEFAULT (getdate()) NULL,
...
CREATE NONCLUSTERED INDEX [IX_gisStringNameTranslation_RS1]
    ON [dbo].[gisStringNameTranslation]([idfsLanguage] ASC, [intRowStatus] ASC)
