CREATE TABLE [dbo].[tstInvisibleFieldsToCP] (
    ...
    [rowguid]                 UNIQUEIDENTIFIER CONSTRAINT [DF_tstInvisibleFieldsToCP_rowguid] DEFAULT (newsequentialid()) ROWGUIDCOL NOT NULL,
    [SourceSystemNameID]      BIGINT           NULL,
    [SourceSystemKeyValue]    NVARCHAR (MAX)   NULL,
    [AuditCreateUser]         NVARCHAR (200)   NULL,
    [AuditCreateDTM]          DATETIME         CONSTRAINT [DF_tstInvisibleFieldsToCP_CreateDTM] DEFAULT (getdate()) NULL,
