CREATE TABLE [dbo].[trtEventType] (
    ...
    [intRowStatus]          INT              CONSTRAINT [DF__trtEventT__intRo__1961B39F] DEFAULT ((0)) NOT NULL,
    ...
    [AuditCreateDTM]        DATETIME         CONSTRAINT [DF_trtEventType_CreateDTM] DEFAULT (getdate()) NULL,
