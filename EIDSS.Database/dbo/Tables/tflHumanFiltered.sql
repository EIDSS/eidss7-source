CREATE TABLE [dbo].[tflHumanFiltered] (
    ...
    [SourceSystemNameID]   BIGINT           CONSTRAINT [DEF_tflHumanFiltered_SourceSystemNameID] DEFAULT ((10519001)) NULL,
    [SourceSystemKeyValue] NVARCHAR (MAX)   NULL,
    [AuditCreateUser]      NVARCHAR (200)   NULL,
    [AuditCreateDTM]       DATETIME         CONSTRAINT [DF_tflHumanFiltered_CreateDTM] DEFAULT (getdate()) NULL,
