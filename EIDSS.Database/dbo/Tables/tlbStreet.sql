CREATE TABLE [dbo].[tlbStreet] (
    ...
    [SourceSystemNameID]   BIGINT           CONSTRAINT [DEF_tlbStreet_SourceSystemNameID] DEFAULT ((10519001)) NULL,
    [SourceSystemKeyValue] NVARCHAR (MAX)   NULL,
    [AuditCreateUser]      NVARCHAR (200)   NULL,
    [AuditCreateDTM]       DATETIME         CONSTRAINT [DF_tlbStreet_CreateDTM] DEFAULT (getdate()) NULL,
    [AuditUpdateUser]      NVARCHAR (200)   NULL,
    [AuditUpdateDTM]       DATETIME         NULL,
    [idfsLocation]         BIGINT           NULL,
    CONSTRAINT [XPKtlbStreet] PRIMARY KEY CLUSTERED ([idfStreet] ASC),
    CONSTRAINT [FK_tlbStreet_gisLocation_idfsLocation] FOREIGN KEY ([idfsLocation]) REFERENCES [dbo].[gisLocation] ([idfsLocation]) NOT FOR REPLICATION,
