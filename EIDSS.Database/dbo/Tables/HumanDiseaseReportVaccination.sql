CREATE TABLE [dbo].[HumanDiseaseReportVaccination] (
    ...
    [rowguid]                          UNIQUEIDENTIFIER CONSTRAINT [DF_HumanDiseaseReportVaccination_rowguid] DEFAULT (newsequentialid()) ROWGUIDCOL NOT NULL,
    [SourceSystemNameID]               BIGINT           CONSTRAINT [DEF_HumanDiseaseReportVaccination_SourceSystemNameID] DEFAULT ((10519001)) NULL,
