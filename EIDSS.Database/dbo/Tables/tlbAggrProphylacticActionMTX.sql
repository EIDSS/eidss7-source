CREATE TABLE [dbo].[tlbAggrProphylacticActionMTX] (
    ...
    [SourceSystemNameID]           BIGINT           CONSTRAINT [DEF_tlbAggrProphylacticActionMTX_SourceSystemNameID] DEFAULT ((10519001)) NULL,
    [SourceSystemKeyValue]         NVARCHAR (MAX)   NULL,
    [AuditCreateUser]              NVARCHAR (200)   NULL,
    [AuditCreateDTM]               DATETIME         CONSTRAINT [DF_tlbAggrProphylacticActionMTX_CreateDTM] DEFAULT (getdate()) NULL,
