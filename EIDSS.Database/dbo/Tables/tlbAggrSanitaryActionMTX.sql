CREATE TABLE [dbo].[tlbAggrSanitaryActionMTX] (
    ...
    [SourceSystemNameID]       BIGINT           CONSTRAINT [DEF_tlbAggrSanitaryActionMTX_SourceSystemNameID] DEFAULT ((10519001)) NULL,
    [SourceSystemKeyValue]     NVARCHAR (MAX)   NULL,
    [AuditCreateUser]          NVARCHAR (200)   NULL,
    [AuditCreateDTM]           DATETIME         CONSTRAINT [DF_tlbAggrSanitaryActionMTX_CreateDTM] DEFAULT (getdate()) NULL,
