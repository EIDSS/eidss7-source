CREATE TABLE [dbo].[tstCustomizationPackage] (
    ...
    [AuditCreateDTM]              DATETIME         CONSTRAINT [DF_tstCustomizationPackage_CreateDTM] DEFAULT (getdate()) NULL,
    [AuditUpdateUser]             NVARCHAR (200)   NULL,
    [AuditUpdateDTM]              DATETIME         NULL,
    CONSTRAINT [XPKtstCustomizationPackage] PRIMARY KEY CLUSTERED ([idfCustomizationPackage] ASC),
    CONSTRAINT [FK_tstCustomizationPackage_gisLocation_idfsCountry] FOREIGN KEY ([idfsCountry]) REFERENCES [dbo].[gisCountry] ([idfsCountry]) NOT FOR REPLICATION,
