CREATE TABLE [dbo].[dotNetAppenderLog] (
    [dotNetAppenderLogUID] BIGINT           IDENTITY (1, 1) NOT FOR REPLICATION NOT NULL,
    ...
    [rowguid]              UNIQUEIDENTIFIER CONSTRAINT [DF_dotNetAppenderLog_rowguid] DEFAULT (newsequentialid()) ROWGUIDCOL NOT NULL,
