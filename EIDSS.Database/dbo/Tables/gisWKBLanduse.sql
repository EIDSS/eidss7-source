CREATE TABLE [dbo].[gisWKBLanduse] (
    ...
    [rowguid]              UNIQUEIDENTIFIER CONSTRAINT [DF_gisWKBLanduse_rowguid] DEFAULT (newsequentialid()) ROWGUIDCOL NOT NULL,
    [SourceSystemNameID]   BIGINT           NULL,
    [SourceSystemKeyValue] NVARCHAR (MAX)   NULL,
    [AuditCreateUser]      NVARCHAR (200)   NULL,
    [AuditCreateDTM]       DATETIME         CONSTRAINT [DF_gisWKBLanduse_CreateDTM] DEFAULT (getdate()) NULL,
