CREATE TABLE [dbo].[tlbContactedCasePerson] (
    ...
    [SourceSystemNameID]     BIGINT           CONSTRAINT [DEF_tlbContactedCasePerson_SourceSystemNameID] DEFAULT ((10519001)) NULL,
    [SourceSystemKeyValue]   NVARCHAR (MAX)   NULL,
    [AuditCreateUser]        NVARCHAR (200)   NULL,
    [AuditCreateDTM]         DATETIME         CONSTRAINT [DF_tlbContactedCasePerson_CreateDTM] DEFAULT (getdate()) NULL,
