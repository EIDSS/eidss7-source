CREATE TABLE [dbo].[tlbMonitoringSessionSummary] (
    ...
    [intRowStatus]                INT              CONSTRAINT [DF__tlbMonito__intRo__5CC2B9B3] DEFAULT ((0)) NOT NULL,
    [rowguid]                     UNIQUEIDENTIFIER CONSTRAINT [tlbMonitoringSessionSummary_newid] DEFAULT (newid()) ROWGUIDCOL NOT NULL,
    [strMaintenanceFlag]          NVARCHAR (20)    NULL,
    [strReservedAttribute]        NVARCHAR (MAX)   NULL,
    [SourceSystemNameID]          BIGINT           CONSTRAINT [DEF_tlbMonitoringSessionSummary_SourceSystemNameID] DEFAULT ((10519001)) NULL,
    [SourceSystemKeyValue]        NVARCHAR (MAX)   NULL,
    [AuditCreateUser]             NVARCHAR (200)   NULL,
    [AuditCreateDTM]              DATETIME         CONSTRAINT [DF_tlbMonitoringSessionSummary_CreateDTM] DEFAULT (getdate()) NULL,
