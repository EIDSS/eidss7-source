CREATE TABLE [dbo].[gisOtherBaseReference] (
    ...
    [intOrder]                  INT              NULL,
    [rowguid]                   UNIQUEIDENTIFIER CONSTRAINT [DF_gisOtherBaseReference_rowguid] DEFAULT (newsequentialid()) ROWGUIDCOL NOT NULL,
    [SourceSystemNameID]        BIGINT           NULL,
    [SourceSystemKeyValue]      NVARCHAR (MAX)   NULL,
    [AuditCreateUser]           NVARCHAR (200)   NULL,
    [AuditCreateDTM]            DATETIME         CONSTRAINT [DF_gisOtherBaseReference_CreateDTM] DEFAULT (getdate()) NULL,
