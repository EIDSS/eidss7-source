CREATE TABLE [dbo].[tlbHerd] (
    ...
    [SourceSystemNameID]   BIGINT           CONSTRAINT [DEF_tlbHerd_SourceSystemNameID] DEFAULT ((10519001)) NULL,
    [SourceSystemKeyValue] NVARCHAR (MAX)   NULL,
    [AuditCreateUser]      NVARCHAR (200)   NULL,
    [AuditCreateDTM]       DATETIME         CONSTRAINT [DF_tlbHerd_CreateDTM] DEFAULT (getdate()) NULL,
...
GO
CREATE NONCLUSTERED INDEX [IX_tlbHerd_idfFarm]
    ON [dbo].[tlbHerd]([idfFarm] ASC);
