CREATE TABLE [dbo].[tlbFreezerSubdivision] (
    ...
    [SourceSystemNameID]   BIGINT           CONSTRAINT [DEF_tlbFreezerSubdivision_SourceSystemNameID] DEFAULT ((10519001)) NULL,
    [SourceSystemKeyValue] NVARCHAR (MAX)   NULL,
    [AuditCreateUser]      NVARCHAR (200)   NULL,
    [AuditCreateDTM]       DATETIME         CONSTRAINT [DF_tlbFreezerSubdivision_CreateDTM] DEFAULT (getdate()) NULL,
