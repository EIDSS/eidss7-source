CREATE TABLE [dbo].[tstLocalSamplesTestsPreferences] (
    ...
    [rowguid]                    UNIQUEIDENTIFIER CONSTRAINT [DF_tstLocalSamplesTestsPreferences_rowguid] DEFAULT (newsequentialid()) ROWGUIDCOL NOT NULL,
    [SourceSystemNameID]         BIGINT           NULL,
    [SourceSystemKeyValue]       NVARCHAR (MAX)   NULL,
    [AuditCreateUser]            NVARCHAR (200)   NULL,
    [AuditCreateDTM]             DATETIME         CONSTRAINT [DF_tstLocalSamplesTestsPreferences_CreateDTM] DEFAULT (getdate()) NULL,
