CREATE TABLE [dbo].[tlbSpeciesActual] (
    ...
    [SourceSystemNameID]   BIGINT           CONSTRAINT [DEF_tlbSpeciesActual_SourceSystemNameID] DEFAULT ((10519001)) NULL,
    [SourceSystemKeyValue] NVARCHAR (MAX)   NULL,
    [AuditCreateUser]      NVARCHAR (200)   NULL,
    [AuditCreateDTM]       DATETIME         CONSTRAINT [DF_tlbSpeciesActual_CreateDTM] DEFAULT (getdate()) NULL,
