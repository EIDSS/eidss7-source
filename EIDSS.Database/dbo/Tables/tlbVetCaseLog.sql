CREATE TABLE [dbo].[tlbVetCaseLog] (
    ...
    [SourceSystemNameID]   BIGINT           CONSTRAINT [DEF_tlbVetCaseLog_SourceSystemNameID] DEFAULT ((10519001)) NULL,
    [SourceSystemKeyValue] NVARCHAR (MAX)   NULL,
    [AuditCreateUser]      NVARCHAR (200)   NULL,
    [AuditCreateDTM]       DATETIME         CONSTRAINT [DF_tlbVetCaseLog_CreateDTM] DEFAULT (getdate()) NULL,
