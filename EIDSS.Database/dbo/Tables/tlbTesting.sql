CREATE TABLE [dbo].[tlbTesting] (
    ...
    [blnReadOnly]              BIT              CONSTRAINT [DF__tlbTestin__blnRe__247E6090] DEFAULT ((0)) NOT NULL,
    [blnNonLaboratoryTest]     BIT              CONSTRAINT [DF__tlbTestin__blnNo__34B4C859] DEFAULT ((0)) NOT NULL,
    [blnExternalTest]          BIT              CONSTRAINT [DF__tlbTestin__blnEx__142B2A92] DEFAULT ((0)) NULL,
    ...
    [SourceSystemNameID]       BIGINT           CONSTRAINT [DEF_tlbTesting_SourceSystemNameID] DEFAULT ((10519001)) NULL,
    ...
    CONSTRAINT [FK_tlbTesting_tlbHumanCase] FOREIGN KEY ([idfHumanCase]) REFERENCES [dbo].[tlbHumanCase] ([idfHumanCase]) NOT FOR REPLICATION,
    CONSTRAINT [FK_tlbTesting_tlbMaterial] FOREIGN KEY ([idfMaterial]) REFERENCES [dbo].[tlbMaterial] ([idfMaterial]) NOT FOR REPLICATION,
    CONSTRAINT [FK_tlbTesting_tlbMonitoringSession] FOREIGN KEY ([idfMonitoringSession]) REFERENCES [dbo].[tlbMonitoringSession] ([idfMonitoringSession]),
    ...
    CONSTRAINT [FK_tlbTesting_tlbVector] FOREIGN KEY ([idfVector]) REFERENCES [dbo].[tlbVector] ([idfVector]) NOT FOR REPLICATION,
    CONSTRAINT [FK_tlbTesting_tlbVetCase] FOREIGN KEY ([idfVetCase]) REFERENCES [dbo].[tlbVetCase] ([idfVetCase]) NOT FOR REPLICATION,
...
GO
CREATE NONCLUSTERED INDEX [IX_tlbTesting_datStartedDate]
    ON [dbo].[tlbTesting]([datStartedDate] ASC);


GO
CREATE NONCLUSTERED INDEX [IX_tlbTesting_idfBatchTest]
    ON [dbo].[tlbTesting]([idfBatchTest] ASC);


GO
CREATE NONCLUSTERED INDEX [IX_tlbTesting_idfsDiagnosis]
    ON [dbo].[tlbTesting]([idfsDiagnosis] ASC);


GO
CREATE NONCLUSTERED INDEX [IX_tlbTesting_idfsTestName]
    ON [dbo].[tlbTesting]([idfsTestName] ASC);


GO
CREATE NONCLUSTERED INDEX [IX_tlbTesting_idfsTestResult]
    ON [dbo].[tlbTesting]([idfsTestResult] ASC);


GO
CREATE NONCLUSTERED INDEX [IX_tlbTesting_idfsTestStatus]
    ON [dbo].[tlbTesting]([idfsTestStatus] ASC);


GO
CREATE NONCLUSTERED INDEX [IX_tlbTesting_blnNonLaboratoryTest]
    ON [dbo].[tlbTesting]([blnNonLaboratoryTest] ASC);


GO
CREATE NONCLUSTERED INDEX [XI_tlbTesting_intRowStatus_blnNonLaboratoryTest]
    ON [dbo].[tlbTesting]([intRowStatus] ASC, [blnNonLaboratoryTest] ASC)
    INCLUDE([idfsTestName], [idfsTestResult], [idfsTestStatus], [idfMaterial], [datConcludedDate], [idfTestedByOffice]);
