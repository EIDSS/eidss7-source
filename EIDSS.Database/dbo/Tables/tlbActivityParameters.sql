CREATE TABLE [dbo].[tlbActivityParameters] (
    ...
    [SourceSystemNameID]    BIGINT           CONSTRAINT [DEF_tlbActivityParameters_SourceSystemNameID] DEFAULT ((10519001)) NULL,
    [SourceSystemKeyValue]  NVARCHAR (MAX)   NULL,
    [AuditCreateUser]       NVARCHAR (200)   NULL,
    [AuditCreateDTM]        DATETIME         CONSTRAINT [DF_tlbActivityParameters_CreateDTM] DEFAULT (getdate()) NULL,
...
GO
CREATE NONCLUSTERED INDEX [IX_tlbActivityParameters_idfObservation_intRowStatus]
    ON [dbo].[tlbActivityParameters]([idfObservation] ASC, [intRowStatus] ASC)
    INCLUDE([idfsParameter], [idfRow], [varValue]);
