CREATE TABLE [dbo].[trtDiagnosis] (
    ...
    [blnZoonotic]          BIT              CONSTRAINT [DF__trtDiagno__blnZo__3E21645E] DEFAULT ((0)) NOT NULL,
    ...
    [AuditCreateDTM]       DATETIME         CONSTRAINT [DF_trtDiagnosis_CreateDTM] DEFAULT (getdate()) NULL,
