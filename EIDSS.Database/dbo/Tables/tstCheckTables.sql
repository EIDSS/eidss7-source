CREATE TABLE [dbo].[tstCheckTables] (
    ...
    [rowguid]              UNIQUEIDENTIFIER CONSTRAINT [DF_tstCheckTables_rowguid] DEFAULT (newsequentialid()) ROWGUIDCOL NOT NULL,
    [SourceSystemNameID]   BIGINT           NULL,
    [SourceSystemKeyValue] NVARCHAR (MAX)   NULL,
    [AuditCreateUser]      NVARCHAR (200)   NULL,
    [AuditCreateDTM]       DATETIME         CONSTRAINT [DF_tstCheckTables_CreateDTM] DEFAULT (getdate()) NULL,
