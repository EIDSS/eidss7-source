CREATE TABLE [dbo].[tdeDataExportProblem] (
    ...
    [rowguid]              UNIQUEIDENTIFIER CONSTRAINT [DF_tdeDataExportProblem_rowguid] DEFAULT (newsequentialid()) ROWGUIDCOL NOT NULL,
    [SourceSystemNameID]   BIGINT           NULL,
    [SourceSystemKeyValue] NVARCHAR (MAX)   NULL,
    [AuditCreateUser]      NVARCHAR (200)   NULL,
    [AuditCreateDTM]       DATETIME         CONSTRAINT [DF_tdeDataExportProblem_CreateDTM] DEFAULT (getdate()) NULL,
