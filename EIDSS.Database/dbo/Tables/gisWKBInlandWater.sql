CREATE TABLE [dbo].[gisWKBInlandWater] (
    ...
    [rowguid]              UNIQUEIDENTIFIER CONSTRAINT [DF_gisWKBInlandWater_rowguid] DEFAULT (newsequentialid()) ROWGUIDCOL NOT NULL,
    [SourceSystemNameID]   BIGINT           NULL,
    [SourceSystemKeyValue] NVARCHAR (MAX)   NULL,
    [AuditCreateUser]      NVARCHAR (200)   NULL,
    [AuditCreateDTM]       DATETIME         CONSTRAINT [DF_gisWKBInlandWater_CreateDTM] DEFAULT (getdate()) NULL,
