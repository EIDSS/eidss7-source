CREATE TABLE [dbo].[tlbDepartment] (
    ...
    [SourceSystemNameID]   BIGINT           CONSTRAINT [DEF_tlbDepartment_SourceSystemNameID] DEFAULT ((10519001)) NULL,
    [SourceSystemKeyValue] NVARCHAR (MAX)   NULL,
    [AuditCreateUser]      NVARCHAR (200)   NULL,
    [AuditCreateDTM]       DATETIME         CONSTRAINT [DF_tlbDepartment_CreateDTM] DEFAULT (getdate()) NULL,
