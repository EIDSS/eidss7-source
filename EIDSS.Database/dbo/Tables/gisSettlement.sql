CREATE TABLE [dbo].[gisSettlement] (
    ...
    [intRowStatus]          INT              CONSTRAINT [DF__gisSettle__intRo__3B2CBBBE] DEFAULT ((0)) NOT NULL,
    ...
    [AuditCreateDTM]        DATETIME         CONSTRAINT [DF_gisSettlement_CreateDTM] DEFAULT (getdate()) NULL,
