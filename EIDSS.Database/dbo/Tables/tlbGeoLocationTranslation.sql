CREATE TABLE [dbo].[tlbGeoLocationTranslation] (
    ...
    [rowguid]               UNIQUEIDENTIFIER CONSTRAINT [DF_tlbGeoLocationTranslation_rowguid] DEFAULT (newsequentialid()) ROWGUIDCOL NOT NULL,
    [SourceSystemNameID]    BIGINT           CONSTRAINT [DEF_tlbGeoLocationTranslation_SourceSystemNameID] DEFAULT ((10519001)) NULL,
    [SourceSystemKeyValue]  NVARCHAR (MAX)   NULL,
    [AuditCreateUser]       NVARCHAR (200)   NULL,
    [AuditCreateDTM]        DATETIME         CONSTRAINT [DF_tlbGeoLocationTranslation_CreateDTM] DEFAULT (getdate()) NULL,
