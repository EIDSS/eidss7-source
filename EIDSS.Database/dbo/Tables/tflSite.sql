CREATE TABLE [dbo].[tflSite] (
    ...
    [SourceSystemNameID]   BIGINT           CONSTRAINT [DEF_tflSite_SourceSystemNameID] DEFAULT ((10519001)) NULL,
    [SourceSystemKeyValue] NVARCHAR (MAX)   NULL,
    [AuditCreateUser]      NVARCHAR (200)   NULL,
    [AuditCreateDTM]       DATETIME         CONSTRAINT [DF_tflSite_CreateDTM] DEFAULT (getdate()) NULL,
