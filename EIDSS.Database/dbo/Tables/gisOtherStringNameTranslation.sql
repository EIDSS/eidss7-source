CREATE TABLE [dbo].[gisOtherStringNameTranslation] (
    ...
    [rowguid]                   UNIQUEIDENTIFIER CONSTRAINT [DF_gisOtherStringNameTranslation_rowguid] DEFAULT (newsequentialid()) ROWGUIDCOL NOT NULL,
    [SourceSystemNameID]        BIGINT           NULL,
    [SourceSystemKeyValue]      NVARCHAR (MAX)   NULL,
    [AuditCreateUser]           NVARCHAR (200)   NULL,
    [AuditCreateDTM]            DATETIME         CONSTRAINT [DF_gisOtherStringNameTranslation_CreateDTM] DEFAULT (getdate()) NULL,
