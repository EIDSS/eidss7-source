CREATE TABLE [dbo].[tstLocalConnectionContext] (
    ...
    [rowguid]              UNIQUEIDENTIFIER CONSTRAINT [DF_tstLocalConnectionContext_rowguid] DEFAULT (newsequentialid()) ROWGUIDCOL NOT NULL,
    [SourceSystemNameID]   BIGINT           NULL,
    [SourceSystemKeyValue] NVARCHAR (MAX)   NULL,
    [AuditCreateUser]      NVARCHAR (200)   NULL,
    [AuditCreateDTM]       DATETIME         CONSTRAINT [DF_tstLocalConnectionContext_CreateDTM] DEFAULT (getdate()) NULL,
