CREATE TABLE [dbo].[tlbFreezer] (
    ...
    [SourceSystemNameID]   BIGINT           CONSTRAINT [DEF_tlbFreezer_SourceSystemNameID] DEFAULT ((10519001)) NULL,
    [SourceSystemKeyValue] NVARCHAR (MAX)   NULL,
    [AuditCreateUser]      NVARCHAR (200)   NULL,
    [AuditCreateDTM]       DATETIME         CONSTRAINT [DF_tlbFreezer_CreateDTM] DEFAULT (getdate()) NULL,
