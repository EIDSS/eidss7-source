CREATE TABLE [dbo].[tlbPerson] (
    ...
    [intRowStatus]         INT              CONSTRAINT [DF__tlbPerson__intRo__55ABA7D0] DEFAULT ((0)) NOT NULL,
    [strMaintenanceFlag]   NVARCHAR (20)    NULL,
    [strReservedAttribute] NVARCHAR (MAX)   NULL,
    [PersonalIDValue]      NVARCHAR (100)   NULL,
    [PersonalIDTypeID]     BIGINT           NULL,
    [SourceSystemNameID]   BIGINT           CONSTRAINT [DEF_tlbPerson_SourceSystemNameID] DEFAULT ((10519001)) NULL,
    [SourceSystemKeyValue] NVARCHAR (MAX)   NULL,
    [AuditCreateUser]      NVARCHAR (200)   NULL,
    [AuditCreateDTM]       DATETIME         CONSTRAINT [DF_tlbPerson_CreateDTM] DEFAULT (getdate()) NULL,
