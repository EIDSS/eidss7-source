CREATE TABLE [dbo].[tflNotificationFiltered] (
    ...
    [SourceSystemNameID]      BIGINT           CONSTRAINT [DEF_tflNotificationFiltered_SourceSystemNameID] DEFAULT ((10519001)) NULL,
    [SourceSystemKeyValue]    NVARCHAR (MAX)   NULL,
    [AuditCreateUser]         NVARCHAR (200)   NULL,
    [AuditCreateDTM]          DATETIME         CONSTRAINT [DF_tflNotificationFiltered_CreateDTM] DEFAULT (getdate()) NULL,
    [AuditUpdateUser]         NVARCHAR (200)   NULL,
    [AuditUpdateDTM]          DATETIME         NULL,
    CONSTRAINT [XPKtflNotificationFiltered] PRIMARY KEY CLUSTERED ([idfNotificationFiltered] ASC),
