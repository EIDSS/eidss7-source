CREATE TABLE [dbo].[tlbFarmActual] (
    ...
    [SourceSystemNameID]          BIGINT           CONSTRAINT [DEF_tlbFarmActual_SourceSystemNameID] DEFAULT ((10519001)) NULL,
    [SourceSystemKeyValue]        NVARCHAR (MAX)   NULL,
    [AuditCreateUser]             NVARCHAR (200)   NULL,
    [AuditCreateDTM]              DATETIME         CONSTRAINT [DF_tlbFarmActual_CreateDTM] DEFAULT (getdate()) NULL,
...
GO
CREATE NONCLUSTERED INDEX [IX_tlbFarmActual_idfsFarmCategory]
    ON [dbo].[tlbFarmActual]([idfsFarmCategory] ASC);


GO
CREATE NONCLUSTERED INDEX [IX_tlbFarmActual_strFarmCode]
    ON [dbo].[tlbFarmActual]([strFarmCode] ASC);


GO
CREATE NONCLUSTERED INDEX [IX_tlbFarmActual_strNationalName]
    ON [dbo].[tlbFarmActual]([strNationalName] ASC);
