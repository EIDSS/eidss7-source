CREATE TABLE [dbo].[tlbHumanActual] (
    ...
    [SourceSystemNameID]         BIGINT           CONSTRAINT [DEF_tlbHumanActual_SourceSystemNameID] DEFAULT ((10519001)) NULL,
    [SourceSystemKeyValue]       NVARCHAR (MAX)   NULL,
    [AuditCreateUser]            NVARCHAR (200)   NULL,
    [AuditCreateDTM]             DATETIME         CONSTRAINT [DF_tlbHumanActual_CreateDTM] DEFAULT (getdate()) NULL,
...
GO
CREATE NONCLUSTERED INDEX [IX_tlbHumanActual_datDateOfBirth]
    ON [dbo].[tlbHumanActual]([datDateofBirth] ASC)
    INCLUDE([intRowStatus]);


GO
CREATE NONCLUSTERED INDEX [IX_tlbHumanActual_strFirstName]
    ON [dbo].[tlbHumanActual]([strFirstName] ASC);


GO
CREATE NONCLUSTERED INDEX [IX_tlbHumanActual_strLastName]
    ON [dbo].[tlbHumanActual]([strLastName] ASC);


GO
CREATE NONCLUSTERED INDEX [IX_tlbHumanActual_idfsHumanGender]
    ON [dbo].[tlbHumanActual]([idfsHumanGender] ASC)
    INCLUDE([intRowStatus]);


GO
CREATE NONCLUSTERED INDEX [IX_tlbHumanActual_idfCurrentResidenceAddress]
    ON [dbo].[tlbHumanActual]([idfCurrentResidenceAddress] ASC);


GO
CREATE NONCLUSTERED INDEX [IX_tlbHumanActual_idfsNationality]
    ON [dbo].[tlbHumanActual]([idfsNationality] ASC)
    INCLUDE([intRowStatus]);


GO
CREATE NONCLUSTERED INDEX [IX_tlbHumanActual_idfsPersonIdType]
    ON [dbo].[tlbHumanActual]([idfsPersonIDType] ASC);


GO
CREATE NONCLUSTERED INDEX [IX_tlbHumanActual_IntRowStatus]
    ON [dbo].[tlbHumanActual]([intRowStatus] ASC);
