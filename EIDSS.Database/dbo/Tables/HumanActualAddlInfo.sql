CREATE TABLE [dbo].[HumanActualAddlInfo] (
    ...
    [EIDSSPersonID]                    NVARCHAR (200)   NOT NULL,
    ...
    CONSTRAINT [FK_HumanActualAddlInfo_BaseRef_IsAnotherPhone] FOREIGN KEY ([IsAnotherPhoneID]) REFERENCES [dbo].[trtBaseReference] ([idfsBaseReference]),
    CONSTRAINT [FK_HumanActualAddlInfo_BaseRef_IsAnotherAddress] FOREIGN KEY ([IsAnotherAddressID]) REFERENCES [dbo].[trtBaseReference] ([idfsBaseReference])
);
