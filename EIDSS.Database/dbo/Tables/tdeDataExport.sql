CREATE TABLE [dbo].[tdeDataExport] (
    ...
    [rowguid]              UNIQUEIDENTIFIER CONSTRAINT [DF_tdeDataExport_rowguid] DEFAULT (newsequentialid()) ROWGUIDCOL NOT NULL,
    [SourceSystemNameID]   BIGINT           NULL,
    [SourceSystemKeyValue] NVARCHAR (MAX)   NULL,
    [AuditCreateUser]      NVARCHAR (200)   NULL,
    [AuditCreateDTM]       DATETIME         CONSTRAINT [DF_tdeDataExport_CreateDTM] DEFAULT (getdate()) NULL,
