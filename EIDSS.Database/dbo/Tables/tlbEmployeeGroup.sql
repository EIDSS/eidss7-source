CREATE TABLE [dbo].[tlbEmployeeGroup] (
    ...
    [intRowStatus]          INT              CONSTRAINT [DF__tlbEmploy__intRo__0683E955] DEFAULT ((0)) NOT NULL,
    [strMaintenanceFlag]    NVARCHAR (20)    NULL,
    [strReservedAttribute]  NVARCHAR (MAX)   NULL,
    [SourceSystemNameID]    BIGINT           CONSTRAINT [DEF_tlbEmployeeGroup_SourceSystemNameID] DEFAULT ((10519001)) NULL,
    [SourceSystemKeyValue]  NVARCHAR (MAX)   NULL,
    [AuditCreateUser]       NVARCHAR (200)   NULL,
    [AuditCreateDTM]        DATETIME         CONSTRAINT [DF_tlbEmployeeGroup_CreateDTM] DEFAULT (getdate()) NULL,
