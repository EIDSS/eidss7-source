CREATE TABLE [dbo].[tlbOffice] (
    ...
    [SourceSystemNameID]      BIGINT           CONSTRAINT [DEF_tlbOffice_SourceSystemNameID] DEFAULT ((10519001)) NULL,
    [SourceSystemKeyValue]    NVARCHAR (MAX)   NULL,
    [AuditCreateUser]         NVARCHAR (200)   NULL,
    [AuditCreateDTM]          DATETIME         CONSTRAINT [DF_tlbOffice_CreateDTM] DEFAULT (getdate()) NULL,
