CREATE TABLE [dbo].[gisReferenceType] (
    ...
    [intRowStatus]            INT              CONSTRAINT [DF__gisRefere__intRo__338B99F6] DEFAULT ((0)) NOT NULL,
    [SourceSystemNameID]      BIGINT           NULL,
    [SourceSystemKeyValue]    NVARCHAR (MAX)   NULL,
    [AuditCreateUser]         NVARCHAR (200)   NULL,
    [AuditCreateDTM]          DATETIME         CONSTRAINT [DF_gisReferenceType_CreateDTM] DEFAULT (getdate()) NULL,
