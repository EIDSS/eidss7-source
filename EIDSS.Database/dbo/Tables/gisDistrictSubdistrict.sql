CREATE TABLE [dbo].[gisDistrictSubdistrict] (
    ...
    [rowguid]              UNIQUEIDENTIFIER CONSTRAINT [DF_gisDistrictSubdistrict_rowguid] DEFAULT (newsequentialid()) ROWGUIDCOL NOT NULL,
    [SourceSystemNameID]   BIGINT           NULL,
    [SourceSystemKeyValue] NVARCHAR (MAX)   NULL,
    [AuditCreateUser]      NVARCHAR (200)   NULL,
    [AuditCreateDTM]       DATETIME         CONSTRAINT [DF_gisDistrictSubdistrict_CreateDTM] DEFAULT (getdate()) NULL,
