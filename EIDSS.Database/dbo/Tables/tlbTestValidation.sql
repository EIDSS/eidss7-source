CREATE TABLE [dbo].[tlbTestValidation] (
    ...
    [blnReadOnly]            BIT              CONSTRAINT [DF__tlbTestVa__blnRe__098B3E89] DEFAULT ((0)) NOT NULL,
    [strMaintenanceFlag]     NVARCHAR (20)    NULL,
    [strReservedAttribute]   NVARCHAR (MAX)   NULL,
    [SourceSystemNameID]     BIGINT           CONSTRAINT [DEF_tlbTestValidation_SourceSystemNameID] DEFAULT ((10519001)) NULL,
...
CREATE NONCLUSTERED INDEX [IX_tlbTestValidation_RT]
    ...
    INCLUDE([blnValidateStatus], [datInterpretationDate], [datValidationDate], [idfInterpretedByPerson], [idfsDiagnosis], [idfsInterpretedStatus], [idfTestValidation], [idfValidatedByPerson], [strInterpretedComment], [strValidateComment]);
