CREATE TABLE [dbo].[trtReferenceType] (
    ...
    [intRowStatus]            INT              CONSTRAINT [DF__trtRefere__intRo__2FF0133C] DEFAULT ((0)) NOT NULL,
    ...
    [AuditCreateDTM]          DATETIME         CONSTRAINT [DF_trtReferenceType_CreateDTM] DEFAULT (getdate()) NULL,
    [AuditUpdateUser]         NVARCHAR (200)   NULL,
    [AuditUpdateDTM]          DATETIME         NULL,
    [strChildTableColumnName] NVARCHAR (100)   NULL,
