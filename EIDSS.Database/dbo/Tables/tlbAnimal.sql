CREATE TABLE [dbo].[tlbAnimal] (
    ...
    [SourceSystemNameID]   BIGINT           CONSTRAINT [DEF_tlbAnimal_SourceSystemNameID] DEFAULT ((10519001)) NULL,
    [SourceSystemKeyValue] NVARCHAR (MAX)   NULL,
    [AuditCreateUser]      NVARCHAR (200)   NULL,
    [AuditCreateDTM]       DATETIME         CONSTRAINT [DF_tlbAnimal_CreateDTM] DEFAULT (getdate()) NULL,
    [AuditUpdateUser]      NVARCHAR (200)   NULL,
    [AuditUpdateDTM]       DATETIME         NULL,
    [idfsYNClinicalSigns]  BIGINT           NULL,
    ...
    CONSTRAINT [FK_tlbAnimal_trtBaseReference__idfsYNClinicalSigns_R_1409] FOREIGN KEY ([idfsYNClinicalSigns]) REFERENCES [dbo].[trtBaseReference] ([idfsBaseReference]) NOT FOR REPLICATION,
...
GO
CREATE NONCLUSTERED INDEX [IX_tlbAnimal_strAnimalCode]
    ON [dbo].[tlbAnimal]([strAnimalCode] ASC);
