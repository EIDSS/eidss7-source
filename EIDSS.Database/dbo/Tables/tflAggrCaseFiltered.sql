CREATE TABLE [dbo].[tflAggrCaseFiltered] (
    ...
    [AuditCreateDTM]       DATETIME         CONSTRAINT [DF_tflAggrCaseFiltered_CreateDTM] DEFAULT (getdate()) NULL,
    [AuditUpdateUser]      NVARCHAR (200)   NULL,
    [AuditUpdateDTM]       DATETIME         NULL,
    CONSTRAINT [PK__tflAggrC__D191579A441A34D6] PRIMARY KEY CLUSTERED ([idfAggrCaseFiltered] ASC),
