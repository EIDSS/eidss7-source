CREATE TABLE [dbo].[tflBasicSyndromicSurveillanceAggregateHeaderFiltered] (
    ...
    [AuditCreateDTM]                                       DATETIME         CONSTRAINT [DF_tflBasicSyndromicSurveillanceAggregateHeaderFiltered_CreateDTM] DEFAULT (getdate()) NULL,
    [AuditUpdateUser]                                      NVARCHAR (200)   NULL,
    [AuditUpdateDTM]                                       DATETIME         NULL,
    CONSTRAINT [XPKtflBasicSyndromicSurveillanceAggregateHeaderFiltered] PRIMARY KEY CLUSTERED ([idfBasicSyndromicSurveillanceAggregateHeaderFiltered] ASC),
