CREATE TABLE [dbo].[updUpdateBlock] (
    ...
    [rowguid]               UNIQUEIDENTIFIER CONSTRAINT [DF_updUpdateBlock_rowguid] DEFAULT (newsequentialid()) ROWGUIDCOL NOT NULL,
    [SourceSystemNameID]    BIGINT           NULL,
    [SourceSystemKeyValue]  NVARCHAR (MAX)   NULL,
    [AuditCreateUser]       NVARCHAR (200)   NULL,
    [AuditCreateDTM]        DATETIME         CONSTRAINT [DF_updUpdateBlock_CreateDTM] DEFAULT (getdate()) NULL,
