CREATE TABLE [dbo].[tstNotificationStatus] (
    ...
    [rowguid]              UNIQUEIDENTIFIER CONSTRAINT [DF_tstNotificationStatus_rowguid] DEFAULT (newsequentialid()) ROWGUIDCOL NOT NULL,
    [SourceSystemNameID]   BIGINT           NULL,
    [SourceSystemKeyValue] NVARCHAR (MAX)   NULL,
    [AuditCreateUser]      NVARCHAR (200)   NULL,
    [AuditCreateDTM]       DATETIME         CONSTRAINT [DF_tstNotificationStatus_CreateDTM] DEFAULT (getdate()) NULL,
