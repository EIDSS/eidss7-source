CREATE TABLE [dbo].[tflDataAuditEventFiltered] (
    ...
    [AuditCreateDTM]            DATETIME         CONSTRAINT [DF_tflDataAuditEventFiltered_CreateDTM] DEFAULT (getdate()) NULL,
    [AuditUpdateUser]           NVARCHAR (200)   NULL,
    [AuditUpdateDTM]            DATETIME         NULL,
    CONSTRAINT [XPKtflDataAuditEventFiltered] PRIMARY KEY CLUSTERED ([idfDataAuditEventFiltered] ASC),
