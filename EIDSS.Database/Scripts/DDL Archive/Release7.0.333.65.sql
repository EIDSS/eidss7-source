...
PRINT N'Dropping Default Constraint [dbo].[DF_dotNetAppenderLog_rowguid]...';


GO
ALTER TABLE [dbo].[dotNetAppenderLog] DROP CONSTRAINT [DF_dotNetAppenderLog_rowguid];


GO
PRINT N'Dropping Default Constraint [dbo].[DF_gisWKBDistrictReady_rowguid]...';


GO
ALTER TABLE [dbo].[gisWKBDistrictReady] DROP CONSTRAINT [DF_gisWKBDistrictReady_rowguid];


GO
PRINT N'Dropping Default Constraint [dbo].[DF_gisWKBDistrictReady_CreateDTM]...';


GO
ALTER TABLE [dbo].[gisWKBDistrictReady] DROP CONSTRAINT [DF_gisWKBDistrictReady_CreateDTM];


GO
PRINT N'Dropping Default Constraint [dbo].[DF_gisWKBRayonReady_CreateDTM]...';


GO
ALTER TABLE [dbo].[gisWKBRayonReady] DROP CONSTRAINT [DF_gisWKBRayonReady_CreateDTM];


GO
PRINT N'Dropping Default Constraint [dbo].[DF_gisWKBRayonReady_rowguid]...';


GO
ALTER TABLE [dbo].[gisWKBRayonReady] DROP CONSTRAINT [DF_gisWKBRayonReady_rowguid];


GO
PRINT N'Dropping Default Constraint [dbo].[DF_gisWKBRegionReady_CreateDTM]...';


GO
ALTER TABLE [dbo].[gisWKBRegionReady] DROP CONSTRAINT [DF_gisWKBRegionReady_CreateDTM];


GO
PRINT N'Dropping Default Constraint [dbo].[DF_gisWKBRegionReady_rowguid]...';


GO
ALTER TABLE [dbo].[gisWKBRegionReady] DROP CONSTRAINT [DF_gisWKBRegionReady_rowguid];


GO
PRINT N'Dropping Default Constraint [dbo].[DF_gisWKBSettlementReady_CreateDTM]...';


GO
ALTER TABLE [dbo].[gisWKBSettlementReady] DROP CONSTRAINT [DF_gisWKBSettlementReady_CreateDTM];


GO
PRINT N'Dropping Default Constraint [dbo].[DF_gisWKBSettlementReady_rowguid]...';


GO
ALTER TABLE [dbo].[gisWKBSettlementReady] DROP CONSTRAINT [DF_gisWKBSettlementReady_rowguid];
...
CREATE TABLE [dbo].[tmp_ms_xx_AspNetUserClaims] (
    ...
    CONSTRAINT [tmp_ms_xx_constraint_PK_dbo.AspNetUserClaims1] PRIMARY KEY CLUSTERED ([Id] ASC)
);
...
EXECUTE sp_rename N'[dbo].[tmp_ms_xx_constraint_PK_dbo.AspNetUserClaims1]', N'PK_dbo.AspNetUserClaims', N'OBJECT';
...
GO
PRINT N'Starting rebuilding table [dbo].[dotNetAppenderLog]...';
...
CREATE TABLE [dbo].[tmp_ms_xx_dotNetAppenderLog] (
    ...
    CONSTRAINT [tmp_ms_xx_constraint_XPKdoNetAppenderLog1] PRIMARY KEY CLUSTERED ([dotNetAppenderLogUID] ASC)
);

IF EXISTS (SELECT TOP 1 1 
           FROM   [dbo].[dotNetAppenderLog])
    BEGIN
        SET IDENTITY_INSERT [dbo].[tmp_ms_xx_dotNetAppenderLog] ON;
        INSERT INTO [dbo].[tmp_ms_xx_dotNetAppenderLog] ([dotNetAppenderLogUID], [LogDTM], [ProcessThread], [LogType], [ClassName], [ExceptionMessage], [LogMessage], [LogURL], [StackTrace], [AppSessionID], [AppMethodObject], [MethodInParms], [MethodOutParms], [AuditCreateUser], [AuditCreateDTM], [rowguid], [SourceSystemNameID], [SourceSystemKeyValue])
        SELECT   [dotNetAppenderLogUID],
                 [LogDTM],
                 [ProcessThread],
                 [LogType],
                 [ClassName],
        ...
        FROM     [dbo].[dotNetAppenderLog]
        ORDER BY [dotNetAppenderLogUID] ASC;
        SET IDENTITY_INSERT [dbo].[tmp_ms_xx_dotNetAppenderLog] OFF;
    END

DROP TABLE [dbo].[dotNetAppenderLog];

EXECUTE sp_rename N'[dbo].[tmp_ms_xx_dotNetAppenderLog]', N'dotNetAppenderLog';

EXECUTE sp_rename N'[dbo].[tmp_ms_xx_constraint_XPKdoNetAppenderLog1]', N'XPKdoNetAppenderLog', N'OBJECT';
...
GO
PRINT N'Starting rebuilding table [dbo].[gisWKBDistrictReady]...';
...
CREATE TABLE [dbo].[tmp_ms_xx_gisWKBDistrictReady] (
    ...
    CONSTRAINT [tmp_ms_xx_constraint_PK__gisWKBDi__C2FFCF1354A99B0D1] PRIMARY KEY CLUSTERED ([oid] ASC)
);

IF EXISTS (SELECT TOP 1 1 
           FROM   [dbo].[gisWKBDistrictReady])
    BEGIN
        SET IDENTITY_INSERT [dbo].[tmp_ms_xx_gisWKBDistrictReady] ON;
        INSERT INTO [dbo].[tmp_ms_xx_gisWKBDistrictReady] ([oid], [idfsGeoObject], [Ratio], [geomShape_3857], [geomShape_4326], [rowguid], [SourceSystemNameID], [SourceSystemKeyValue], [AuditCreateUser], [AuditCreateDTM], [AuditUpdateUser], [AuditUpdateDTM])
        SELECT   [oid],
                 [idfsGeoObject],
                 [Ratio],
                 [geomShape_3857],
        ...
        FROM     [dbo].[gisWKBDistrictReady]
        ORDER BY [oid] ASC;
        SET IDENTITY_INSERT [dbo].[tmp_ms_xx_gisWKBDistrictReady] OFF;
    END

DROP TABLE [dbo].[gisWKBDistrictReady];

EXECUTE sp_rename N'[dbo].[tmp_ms_xx_gisWKBDistrictReady]', N'gisWKBDistrictReady';

EXECUTE sp_rename N'[dbo].[tmp_ms_xx_constraint_PK__gisWKBDi__C2FFCF1354A99B0D1]', N'PK__gisWKBDi__C2FFCF1354A99B0D', N'OBJECT';
...
GO
PRINT N'Starting rebuilding table [dbo].[gisWKBRayonReady]...';
...
CREATE TABLE [dbo].[tmp_ms_xx_gisWKBRayonReady] (
    [oid]                  INT              IDENTITY (1, 1) NOT FOR REPLICATION NOT NULL,
    [idfsGeoObject]        BIGINT           NOT NULL,
    [Ratio]                INT              NOT NULL,
    [geomShape_3857]       [sys].[geometry] NULL,
    ...
    [AuditUpdateUser]      NVARCHAR (200)   NULL,
    [AuditUpdateDTM]       DATETIME         NULL,
    CONSTRAINT [tmp_ms_xx_constraint_PK__gisWKBRa__C2FFCF130161CCF61] PRIMARY KEY CLUSTERED ([oid] ASC)
);

IF EXISTS (SELECT TOP 1 1 
           FROM   [dbo].[gisWKBRayonReady])
    BEGIN
        SET IDENTITY_INSERT [dbo].[tmp_ms_xx_gisWKBRayonReady] ON;
        INSERT INTO [dbo].[tmp_ms_xx_gisWKBRayonReady] ([oid], [idfsGeoObject], [Ratio], [geomShape_3857], [geomShape_4326], [rowguid], [SourceSystemNameID], [SourceSystemKeyValue], [AuditCreateUser], [AuditCreateDTM], [AuditUpdateUser], [AuditUpdateDTM])
        SELECT   [oid],
                 [idfsGeoObject],
                 [Ratio],
                 [geomShape_3857],
        ...
        FROM     [dbo].[gisWKBRayonReady]
        ORDER BY [oid] ASC;
        SET IDENTITY_INSERT [dbo].[tmp_ms_xx_gisWKBRayonReady] OFF;
    END

DROP TABLE [dbo].[gisWKBRayonReady];

EXECUTE sp_rename N'[dbo].[tmp_ms_xx_gisWKBRayonReady]', N'gisWKBRayonReady';

EXECUTE sp_rename N'[dbo].[tmp_ms_xx_constraint_PK__gisWKBRa__C2FFCF130161CCF61]', N'PK__gisWKBRa__C2FFCF130161CCF6', N'OBJECT';
...
GO
PRINT N'Starting rebuilding table [dbo].[gisWKBRegionReady]...';
...
CREATE TABLE [dbo].[tmp_ms_xx_gisWKBRegionReady] (
    [oid]                  INT              IDENTITY (1, 1) NOT FOR REPLICATION NOT NULL,
    [idfsGeoObject]        BIGINT           NOT NULL,
    [Ratio]                INT              NOT NULL,
    [geomShape_3857]       [sys].[geometry] NULL,
    ...
    [AuditUpdateUser]      NVARCHAR (200)   NULL,
    [AuditUpdateDTM]       DATETIME         NULL,
    CONSTRAINT [tmp_ms_xx_constraint_PK__gisWKBRe__C2FFCF1305325DDA1] PRIMARY KEY CLUSTERED ([oid] ASC)
);

IF EXISTS (SELECT TOP 1 1 
           FROM   [dbo].[gisWKBRegionReady])
    BEGIN
        SET IDENTITY_INSERT [dbo].[tmp_ms_xx_gisWKBRegionReady] ON;
        INSERT INTO [dbo].[tmp_ms_xx_gisWKBRegionReady] ([oid], [idfsGeoObject], [Ratio], [geomShape_3857], [geomShape_4326], [rowguid], [SourceSystemNameID], [SourceSystemKeyValue], [AuditCreateUser], [AuditCreateDTM], [AuditUpdateUser], [AuditUpdateDTM])
        SELECT   [oid],
                 [idfsGeoObject],
                 [Ratio],
                 [geomShape_3857],
        ...
        FROM     [dbo].[gisWKBRegionReady]
        ORDER BY [oid] ASC;
        SET IDENTITY_INSERT [dbo].[tmp_ms_xx_gisWKBRegionReady] OFF;
    END

DROP TABLE [dbo].[gisWKBRegionReady];

EXECUTE sp_rename N'[dbo].[tmp_ms_xx_gisWKBRegionReady]', N'gisWKBRegionReady';

EXECUTE sp_rename N'[dbo].[tmp_ms_xx_constraint_PK__gisWKBRe__C2FFCF1305325DDA1]', N'PK__gisWKBRe__C2FFCF1305325DDA', N'OBJECT';
...
GO
PRINT N'Starting rebuilding table [dbo].[gisWKBSettlementReady]...';
...
CREATE TABLE [dbo].[tmp_ms_xx_gisWKBSettlementReady] (
    [oid]                  INT              IDENTITY (1, 1) NOT FOR REPLICATION NOT NULL,
    [idfsGeoObject]        BIGINT           NOT NULL,
    [Ratio]                INT              NOT NULL,
    [geomShape_3857]       [sys].[geometry] NULL,
    ...
    [AuditUpdateUser]      NVARCHAR (200)   NULL,
    [AuditUpdateDTM]       DATETIME         NULL,
    CONSTRAINT [tmp_ms_xx_constraint_PK__gisWKBSe__C2FFCF130902EEBE1] PRIMARY KEY CLUSTERED ([oid] ASC)
);

IF EXISTS (SELECT TOP 1 1 
           FROM   [dbo].[gisWKBSettlementReady])
    BEGIN
        SET IDENTITY_INSERT [dbo].[tmp_ms_xx_gisWKBSettlementReady] ON;
        INSERT INTO [dbo].[tmp_ms_xx_gisWKBSettlementReady] ([oid], [idfsGeoObject], [Ratio], [geomShape_3857], [geomShape_4326], [rowguid], [SourceSystemNameID], [SourceSystemKeyValue], [AuditCreateUser], [AuditCreateDTM], [AuditUpdateUser], [AuditUpdateDTM])
        SELECT   [oid],
                 [idfsGeoObject],
                 [Ratio],
                 [geomShape_3857],
        ...
        FROM     [dbo].[gisWKBSettlementReady]
        ORDER BY [oid] ASC;
        SET IDENTITY_INSERT [dbo].[tmp_ms_xx_gisWKBSettlementReady] OFF;
    END

DROP TABLE [dbo].[gisWKBSettlementReady];

EXECUTE sp_rename N'[dbo].[tmp_ms_xx_gisWKBSettlementReady]', N'gisWKBSettlementReady';

EXECUTE sp_rename N'[dbo].[tmp_ms_xx_constraint_PK__gisWKBSe__C2FFCF130902EEBE1]', N'PK__gisWKBSe__C2FFCF130902EEBE', N'OBJECT';
...
GO
PRINT N'Altering Table [dbo].[tlbOutbreakNote]...';


GO
ALTER TABLE [dbo].[tlbOutbreakNote] ALTER COLUMN [NoteRecordUID] ADD NOT FOR REPLICATION;
...
GO
PRINT N'Creating Trigger [dbo].[TR_dotNetAppenderLog_A_Update]...';
...
END
GO
PRINT N'Creating Trigger [dbo].[TR_gisWKBDistrictReady_A_Update]...';
...
END
GO
PRINT N'Creating Trigger [dbo].[TR_gisWKBRayonReady_A_Update]...';
...
END
GO
PRINT N'Creating Trigger [dbo].[TR_gisWKBRegionReady_A_Update]...';
...
END
GO
PRINT N'Creating Trigger [dbo].[TR_gisWKBSettlementReady_A_Update]...';
...
GO
PRINT N'Refreshing Procedure [dbo].[USP_GBL_LOGGING_SET]...';


GO
EXECUTE sp_refreshsqlmodule N'[dbo].[USP_GBL_LOGGING_SET]';


GO
PRINT N'Refreshing Procedure [dbo].[USP_OMM_Note_File_Get]...';


GO
EXECUTE sp_refreshsqlmodule N'[dbo].[USP_OMM_Note_File_Get]';


GO
PRINT N'Refreshing Procedure [dbo].[USP_OMM_SESSION_Note_Delete]...';


GO
EXECUTE sp_refreshsqlmodule N'[dbo].[USP_OMM_SESSION_Note_Delete]';


GO
PRINT N'Refreshing Procedure [dbo].[USP_OMM_Session_Note_GetDetail]...';


GO
EXECUTE sp_refreshsqlmodule N'[dbo].[USP_OMM_Session_Note_GetDetail]';


GO
PRINT N'Refreshing Procedure [dbo].[USP_OMM_Session_Note_GetList]...';


GO
EXECUTE sp_refreshsqlmodule N'[dbo].[USP_OMM_Session_Note_GetList]';


GO
PRINT N'Refreshing Procedure [dbo].[USP_OMM_SESSION_Note_Set]...';


GO
EXECUTE sp_refreshsqlmodule N'[dbo].[USP_OMM_SESSION_Note_Set]';
