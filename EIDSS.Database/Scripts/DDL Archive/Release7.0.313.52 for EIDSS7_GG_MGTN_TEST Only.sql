/*
Deployment script for EIDSS7_GG_MGTN_TEST
...
GO
ALTER TABLE [Migr70].[DisabledForeignKeys] DROP CONSTRAINT [DF__DisabledF__FK_DI__66387A38];
...
GO
PRINT N'Dropping Schema [EIDSSDEV\EIDSSTestBusiness]...';


GO
DROP SCHEMA [EIDSSDEV\EIDSSTestBusiness];


GO
PRINT N'Dropping Schema [EIDSSDEV\EIDSSDevBusiness]...';


GO
DROP SCHEMA [EIDSSDEV\EIDSSDevBusiness];


GO
PRINT N'Dropping Schema [EIDSSDEV\EIDSSIntBusiness]...';


GO
DROP SCHEMA [EIDSSDEV\EIDSSIntBusiness];


GO
PRINT N'Dropping User [EIDSSDEV\EIDSSDevBusiness]...';


GO
DROP USER [EIDSSDEV\EIDSSDevBusiness];


GO
PRINT N'Dropping User [EIDSSDEV\EIDSSIntBusiness]...';


GO
DROP USER [EIDSSDEV\EIDSSIntBusiness];
...
GO
PRINT N'Creating Function [dbo].[FN_GBL_GetBaseReferenceTranslation]...';
...
END
GO
PRINT N'Creating Procedure [dbo].[USP_ADMIN_FF_ParameterTypeEditorMapping_GetList]...';
...
BEGIN
   BEGIN TRY
	  ...
	  UPDATE @Mapping
	  SET 
		 idfsEditor = '10067008,10067010,10067011,10067006',
	  ...
	  WHERE idfsEditor IN ('editText','editTotal','editSum','parString')
