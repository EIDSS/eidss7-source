...
--##REMARKS Date: 07.18.2022
--##REMARKS Added idfOffice and idfEmployee fields
--##REMARKS Date: 07.25.2022
--##REMARKS Added @idfOffice and @idfEmployee parameters to filter results by employee and organization
...
ALTER PROCEDURE [dbo].[spAsQuerySelectLookup]
	...
	@idfOffice	as bigint = null,
	@idfEmployee	as bigint = null
AS
BEGIN
	select	distinct	 q.idflQuery
				,q.idfsGlobalQuery
				...
				,q.idfOffice					as idfOffice
				,q.idfEmployee					as idfEmployee
	...
	left join	(
	 ...
	 left join tasLayout as l
		on q.idflQuery = l.idflQuery

	where		(@QueryID is null or @QueryID = q.idflQuery)
				and IsNull(q.blnSubQuery, 0) = 0
				and (@QueryID is not null or q.blnReadOnly = 1 or (l.blnShareLayout = 1 and q.idfEmployee <> @idfEmployee) or (q.idfOffice = @idfOffice and q.idfEmployee = @idfEmployee))
				--and (q.blnReadOnly = 1 or q.idfOffice = @idfOffice) 
