...
update		ghc
set			ghc.DataEntrySiteID = isnull(item.idfsSite, @idfsDefaultSite)
from		##GenerateCriteria ghc
...
left join	tstSite s_data_entry
	inner join	dbo.FN_GBL_Institution_Min('en-US') org_data_entry
	on		org_data_entry.idfOffice = s_data_entry.idfOffice
on			s_data_entry.idfsSite = ghc.DataEntrySiteID
