...
(4858, N'School Address', N'Heading', N'სკოლის მისამართი', N'Məktəb ünvanı', N''),
(4859, N'Employment Address', N'Heading', N'დასაქმების მისამართი', N'Məşğulluq ünvanı', N''),
(4860, N'Changed Disease (if known)', N'Field Label', N'შეცვლილი დაავადება (თუ ცნობილია)', N'', N''),
(4861, N'Date of Changed Diagnosis', N'Field Label', N'დიაგნოზის შეცვლის თარიღი', N'', N''),
(4862, N'The Changed Disease value should differ from the Disease value', N'Message', N'შეცვლილი დაავადება უნდა განსხვავდებოდეს საწყისი დაავადებისაგან', N'', N''),
(4863, N'Date of Changed Diagnosis should be later or the same as Diagnosis Date', N'Message', N'', N'', N''),
(4864, N'Reason for Disease Change', N'Heading', N'დაავადების შეცვლის მიზეზი', N'', N''),
(4865, N'Please enter a reason for changing the disease', N'Field Label', N'გთხოვთ შეიყვანოთ დაავადების შეცვლის მიზეზი', N'', N''),
(4866, N'Disease History', N'Heading', N'', N'', N''),
(4867, N'Date of Change', N'Column Heading', N'', N'', N''),
(4868, N'Changed By (Organization)', N'Column Heading', N'', N'', N''),
(4869, N'Changed By (Person)', N'Column Heading', N'', N'', N''),
(4870, N'Previous Disease', N'Column Heading', N'', N'', N''),
(4871, N'Changed Disease', N'Column Heading', N'', N'', N''),
(4872, N'Reason', N'Column Heading', N'', N'', N''),
(1803, N'Ground Type', N'Field Label', N'', N'', N''),
(1804, N'Distance (#.## km)', N'Field Label', N'', N'', N''),
(1805, N'Direction (#.##)', N'Field Label', N'', N'', N''),
(1806, N'Country', N'Field Label', N'', N'', N''),
(1807, N'Address', N'Field Label', N'', N'', N'')

insert into #ResourceToResourceSet(idfsResource, strResourceEN, strResourceSetPath) values
(4858, N'Disease', N'Global'),
(4859, N'Disease', N'Global'),
(4860, N'Changed Disease (if known)', N'Global'),
(4861, N'Date of Changed Diagnosis', N'Global'),
(4862, N'The Changed Disease value should differ from the Disease value', N'Global>Warning Messages'),
(4863, N'Date of Changed Diagnosis should be later or the same as Diagnosis Date', N'Global>Warning Messages'),
(4864, N'Reason for Disease Change', N'Global'),
(4865, N'Please enter a reason for changing the disease', N'Global'),
(4866, N'Disease History', N'Global'),
(4867, N'Date of Change', N'Global'),
(4868, N'Changed By (Organization)', N'Global'),
(4869, N'Changed By (Person)', N'Global'),
(4870, N'Previous Disease', N'Global'),
(4871, N'Changed Disease', N'Global'),
(4872, N'Reason', N'Global'),
(1803, N'Ground Type', N'Human>Human Disease Report>Case Investigation'),
(1804, N'Distance (#.## km)', N'Human>Human Disease Report>Case Investigation'),
(1805, N'Direction (#.##)', N'Human>Human Disease Report>Case Investigation'),
(1806, N'Country', N'Human>Human Disease Report>Case Investigation'),
(1807, N'Address', N'Human>Human Disease Report>Case Investigation')
