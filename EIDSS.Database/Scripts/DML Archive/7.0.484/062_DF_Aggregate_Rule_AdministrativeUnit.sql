-- Examples:
/*
	EXEC [dbo].[DF_Aggregate_Rule_AdministrativeUnit]
	EXEC [dbo].[DF_Aggregate_Rule_AdministrativeUnit] @UsePredefinedData=0,@StartDate='20240601'
	EXEC [dbo].[DF_Aggregate_Rule_AdministrativeUnit] @UsePredefinedData=1
*/
-- ************************************************************************************************
CREATE OR ALTER PROCEDURE [dbo].[DF_Aggregate_Rule_AdministrativeUnit] 
(
...
begin
	...
	on			s.idfsRayon = aggr.idfsAggrCaseRayon
