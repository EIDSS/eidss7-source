-- Examples:
/*
	EXEC [dbo].[DF_VSS_Rule_VectorDetailLocation]
	EXEC [dbo].[DF_VSS_Rule_VectorDetailLocation] @UsePredefinedData=0,@StartDate='20240601'
	EXEC [dbo].[DF_VSS_Rule_VectorDetailLocation] @UsePredefinedData=1
*/
-- ************************************************************************************************
CREATE OR ALTER PROCEDURE [dbo].[DF_VSS_Rule_VectorDetailLocation] 
(
