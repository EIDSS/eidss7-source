-- Examples:
/*
	EXEC [dbo].[DF_VSS_Rule_FieldTest_idfTestedByOffice]
	EXEC [dbo].[DF_VSS_Rule_FieldTest_idfTestedByOffice] @UsePredefinedData=0,@StartDate='20240601'
	EXEC [dbo].[DF_VSS_Rule_FieldTest_idfTestedByOffice] @UsePredefinedData=1
*/
-- ************************************************************************************************
CREATE OR ALTER PROCEDURE [dbo].[DF_VSS_Rule_FieldTest_idfTestedByOffice] 
(
...
begin
	...
	inner join	dbo.tlbPensideTest ft with (nolock)
	on			ft.idfMaterial = m.idfMaterial
	inner join	#SitesToCalculateFiltrationRecords s
	on			s.idfOffice = ft.idfTestedByOffice
