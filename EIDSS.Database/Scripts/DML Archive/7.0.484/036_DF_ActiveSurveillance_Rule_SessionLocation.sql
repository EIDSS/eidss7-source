-- Examples:
/*
	EXEC [dbo].[DF_ActiveSurveillance_Rule_SessionLocation]
	EXEC [dbo].[DF_ActiveSurveillance_Rule_SessionLocation] @UsePredefinedData=0,@StartDate='20240601'
	EXEC [dbo].[DF_ActiveSurveillance_Rule_SessionLocation] @UsePredefinedData=1
*/
-- ************************************************************************************************
CREATE OR ALTER PROCEDURE [dbo].[DF_ActiveSurveillance_Rule_SessionLocation] 
(
