-- Examples:
/*
	EXEC [dbo].[DF_VDR_Rule_FarmAddress]
	EXEC [dbo].[DF_VDR_Rule_FarmAddress] @UsePredefinedData=0,@StartDate='20240601'
	EXEC [dbo].[DF_VDR_Rule_FarmAddress] @UsePredefinedData=1
*/
-- ************************************************************************************************
CREATE OR ALTER PROCEDURE [dbo].[DF_VDR_Rule_FarmAddress] 
(
...
begin
	...
	on			s.idfsRayon = vc.idfsFarmAddressRayon
