-- Examples:
/*
	EXEC [dbo].[DF_HDR_Rule_idfReceivedByOffice]
	EXEC [dbo].[DF_HDR_Rule_idfReceivedByOffice] @UsePredefinedData=0,@StartDate='20240601'
	EXEC [dbo].[DF_HDR_Rule_idfReceivedByOffice] @UsePredefinedData=1
*/
-- ************************************************************************************************
CREATE OR ALTER PROCEDURE [dbo].[DF_HDR_Rule_idfReceivedByOffice] 
(
...
begin
	...
	on			s.idfOffice = hc.idfReceivedByOffice
