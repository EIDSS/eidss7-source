-- Examples:
/*
	EXEC [dbo].[DF_Aggregate_Rule_idfEnteredByOffice]
	EXEC [dbo].[DF_Aggregate_Rule_idfEnteredByOffice] @UsePredefinedData=0,@StartDate='20240601'
	EXEC [dbo].[DF_Aggregate_Rule_idfEnteredByOffice] @UsePredefinedData=1
*/
-- ************************************************************************************************
CREATE OR ALTER PROCEDURE [dbo].[DF_Aggregate_Rule_idfEnteredByOffice] 
(
...
begin
	...
	on			s.idfOffice = aggr.idfEnteredByOffice
