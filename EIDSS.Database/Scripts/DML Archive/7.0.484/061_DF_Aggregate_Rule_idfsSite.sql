-- Examples:
/*
	EXEC [dbo].[DF_Aggregate_Rule_idfsSite]
	EXEC [dbo].[DF_Aggregate_Rule_idfsSite] @UsePredefinedData=0,@StartDate='20240601'
	EXEC [dbo].[DF_Aggregate_Rule_idfsSite] @UsePredefinedData=1
*/
-- ************************************************************************************************
CREATE OR ALTER PROCEDURE [dbo].[DF_Aggregate_Rule_idfsSite] 
(
