-- Examples:
/*
	EXEC [dbo].[DF_HDR_Rule_ExposureLocation]
	EXEC [dbo].[DF_HDR_Rule_ExposureLocation] @UsePredefinedData=0,@StartDate='20240601'
	EXEC [dbo].[DF_HDR_Rule_ExposureLocation] @UsePredefinedData=1
*/
-- ************************************************************************************************
CREATE OR ALTER PROCEDURE [dbo].[DF_HDR_Rule_ExposureLocation] 
(
...
begin
	...
	on			s.idfsRayon = hc.idfsExposureLocRayon
