-- Examples:
/*
	EXEC [dbo].[DF_VDR_Rule_idfReportedByOffice]
	EXEC [dbo].[DF_VDR_Rule_idfReportedByOffice] @UsePredefinedData=0,@StartDate='20240601'
	EXEC [dbo].[DF_VDR_Rule_idfReportedByOffice] @UsePredefinedData=1
*/
-- ************************************************************************************************
CREATE OR ALTER PROCEDURE [dbo].[DF_VDR_Rule_idfReportedByOffice] 
(
...
begin
	...
	on			s.idfOffice = vc.idfReportedByOffice
