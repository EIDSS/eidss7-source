-- Examples:
/*
	EXEC [dbo].[DF_VDR_Rule_SiteAddress]
	EXEC [dbo].[DF_VDR_Rule_SiteAddress] @UsePredefinedData=0,@StartDate='20240601'
	EXEC [dbo].[DF_VDR_Rule_SiteAddress] @UsePredefinedData=1
*/
-- ************************************************************************************************
CREATE OR ALTER PROCEDURE [dbo].[DF_VDR_Rule_SiteAddress] 
(
...
begin
	...
	on			s_to_sg_rayon.idfsSite = vc.idfsSite
