-- Examples:
/*
	EXEC [dbo].[DF_HDR_Rule_Sample_TransferOut]
	EXEC [dbo].[DF_HDR_Rule_Sample_TransferOut] @UsePredefinedData=0,@StartDate='20240601'
	EXEC [dbo].[DF_HDR_Rule_Sample_TransferOut] @UsePredefinedData=1
*/
-- ************************************************************************************************
CREATE OR ALTER PROCEDURE [dbo].[DF_HDR_Rule_Sample_TransferOut] 
(
...
begin
	...
	inner join	tlbTransferOutMaterial tOutM with (nolock)
	on			tOutM.idfMaterial = m.idfMaterial
	inner join	tlbTransferOUT tOut with (nolock)
