-- Examples:
/*
	EXEC [dbo].[DF_VDR_Rule_idfInvestigatedByOffice]
	EXEC [dbo].[DF_VDR_Rule_idfInvestigatedByOffice] @UsePredefinedData=0,@StartDate='20240601'
	EXEC [dbo].[DF_VDR_Rule_idfInvestigatedByOffice] @UsePredefinedData=1
*/
-- ************************************************************************************************
CREATE OR ALTER PROCEDURE [dbo].[DF_VDR_Rule_idfInvestigatedByOffice] 
(
...
begin
	...
	on			s.idfOffice = vc.idfInvestigatedByOffice
