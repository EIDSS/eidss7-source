-- Examples:
/*
	EXEC [dbo].[DF_VDR_Rule_Sample_idfFieldCollectedByOffice]
	EXEC [dbo].[DF_VDR_Rule_Sample_idfFieldCollectedByOffice] @UsePredefinedData=0,@StartDate='20240601'
	EXEC [dbo].[DF_VDR_Rule_Sample_idfFieldCollectedByOffice] @UsePredefinedData=1
*/
-- ************************************************************************************************
CREATE OR ALTER PROCEDURE [dbo].[DF_VDR_Rule_Sample_idfFieldCollectedByOffice] 
(
