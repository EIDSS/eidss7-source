-- Examples:
/*
	EXEC [dbo].[DF_VSS_Rule_Vector_idfCollectedByOffice]
	EXEC [dbo].[DF_VSS_Rule_Vector_idfCollectedByOffice] @UsePredefinedData=0,@StartDate='20240601'
	EXEC [dbo].[DF_VSS_Rule_Vector_idfCollectedByOffice] @UsePredefinedData=1
*/
-- ************************************************************************************************
CREATE OR ALTER PROCEDURE [dbo].[DF_VSS_Rule_Vector_idfCollectedByOffice] 
(
...
begin
	...
	on			s.idfOffice = v.idfCollectedByOffice
