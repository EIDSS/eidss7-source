-- Examples:
/*
	EXEC [dbo].[DF_HDR_Rule_idfSentByOffice]
	EXEC [dbo].[DF_HDR_Rule_idfSentByOffice] @UsePredefinedData=0,@StartDate='20240601'
	EXEC [dbo].[DF_HDR_Rule_idfSentByOffice] @UsePredefinedData=1
*/
-- ************************************************************************************************
CREATE OR ALTER PROCEDURE [dbo].[DF_HDR_Rule_idfSentByOffice] 
(
...
begin
	...
	on			s.idfOffice = hc.idfSentByOffice
