-- Examples:
/*
	EXEC [dbo].[DF_VDR_Rule_Sample_TransferOut]
	EXEC [dbo].[DF_VDR_Rule_Sample_TransferOut] @UsePredefinedData=0,@StartDate='20240601'
	EXEC [dbo].[DF_VDR_Rule_Sample_TransferOut] @UsePredefinedData=1
*/
-- ************************************************************************************************
CREATE OR ALTER PROCEDURE [dbo].[DF_VDR_Rule_Sample_TransferOut] 
(
...
begin
	...
	on			m.idfHumanCase = vc.idfVetCase
