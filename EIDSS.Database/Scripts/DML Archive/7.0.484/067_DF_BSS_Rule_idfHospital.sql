-- Examples:
/*
	EXEC [dbo].[DF_BSS_Rule_idfHospital]
	EXEC [dbo].[DF_BSS_Rule_idfHospital] @UsePredefinedData=0,@StartDate='20240601'
	EXEC [dbo].[DF_BSS_Rule_idfHospital] @UsePredefinedData=1
*/
-- ************************************************************************************************
CREATE OR ALTER PROCEDURE [dbo].[DF_BSS_Rule_idfHospital] 
(
...
begin
	...
	on			s.idfOffice = bss.idfHospital
