-- Examples:
/*
	EXEC [dbo].[DF_TransferOut_Rule_idfSendFromOffice]
	EXEC [dbo].[DF_TransferOut_Rule_idfSendFromOffice] @UsePredefinedData=0,@StartDate='20240601'
	EXEC [dbo].[DF_TransferOut_Rule_idfSendFromOffice] @UsePredefinedData=1
*/
-- ************************************************************************************************
CREATE OR ALTER PROCEDURE [dbo].[DF_TransferOut_Rule_idfSendFromOffice] 
(
