-- Examples:
/*
	EXEC [dbo].[DF_BSSAggregate_Rule_idfsSite]
	EXEC [dbo].[DF_BSSAggregate_Rule_idfsSite] @UsePredefinedData=0,@StartDate='20240601'
	EXEC [dbo].[DF_BSSAggregate_Rule_idfsSite] @UsePredefinedData=1
*/
-- ************************************************************************************************
CREATE OR ALTER PROCEDURE [dbo].[DF_BSSAggregate_Rule_idfsSite] 
(
...
begin
	...
	on			s.idfsSite = bssaggr.idfsSite
