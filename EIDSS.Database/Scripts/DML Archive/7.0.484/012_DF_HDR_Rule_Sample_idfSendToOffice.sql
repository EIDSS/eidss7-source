-- Examples:
/*
	EXEC [dbo].[DF_HDR_Rule_Sample_idfSendToOffice]
	EXEC [dbo].[DF_HDR_Rule_Sample_idfSendToOffice] @UsePredefinedData=0,@StartDate='20240601'
	EXEC [dbo].[DF_HDR_Rule_Sample_idfSendToOffice] @UsePredefinedData=1
*/
-- ************************************************************************************************
CREATE OR ALTER PROCEDURE [dbo].[DF_HDR_Rule_Sample_idfSendToOffice] 
(
