-- Examples:
/*
	EXEC [dbo].[DF_VSS_Rule_SessionLocation]
	EXEC [dbo].[DF_VSS_Rule_SessionLocation] @UsePredefinedData=0,@StartDate='20240601'
	EXEC [dbo].[DF_VSS_Rule_SessionLocation] @UsePredefinedData=1
*/
-- ************************************************************************************************
CREATE OR ALTER PROCEDURE [dbo].[DF_VSS_Rule_SessionLocation] 
(
...
begin
	...
	on			s.idfsRayon = vss.idfsVSSRayon
