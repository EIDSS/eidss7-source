...
where
   ...
   (
	  b.strDefault LIKE 'Type of animal products contacted/prepared%' or
	  b.strDefault LIKE 'Type of animal whose meat was consumed raw or undercooked (Within two weeks of symptoms onset)%'
   ) AND
