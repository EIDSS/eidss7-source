...
(4856, N'Personal ID already exists', N'Message', N'Personal ID already exists', N'Fərdi İN arıq mövcuddur', N'Персональный ИН уже существует'),
...
(4856, N'Personal ID already exists', N'Global>Warning Messages'),
(4857, N'Age Type', N'Human>Person>Person Information')
