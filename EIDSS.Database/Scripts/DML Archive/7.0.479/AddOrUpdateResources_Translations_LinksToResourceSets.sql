...
(2566, N'Country Code and Phone Number', N'Field Label', N'ქვეყნის კოდი და ტელეფონის ნომერი', N'Ölkə kodu və telefon nömrəsi', N'Код страны и номер'),
(4856, N'The record with the Personal ID = "{0}" already exists.', N'Message', N'ჩანაწერი სადაც უნიკალური ID = "{0}" უკვე არსებობს.', N'Fərdi İN "{0}" ilə yazı arıq mövcuddur', N'Запись с персональным ИН "{0}" уже существует.'),
(4857, N'Age Type', N'Field Label', N'ასაკის ტოპი', N'', N''),
...
(4860, N'Changed Disease (if known)', N'Field Label', N'', N'', N''),
(4861, N'Date of Changed Diagnosis', N'Field Label', N'', N'', N''),
(4862, N'The Changed Disease value should differ from the Disease value', N'Message', N'', N'', N''),
(4863, N'Date of Changed Diagnosis should be later or the same as Diagnosis Date', N'Message', N'', N'', N''),
(4864, N'Reason for Disease Change', N'Heading', N'', N'', N''),
(4865, N'Please enter a reason for changing the disease', N'Field Label', N'', N'', N'')

insert into #ResourceToResourceSet(idfsResource, strResourceEN, strResourceSetPath) values
(2566, N'Contact Information Modal', N'Outbreak>Outbreak Session>Outbreak Contacts>Human Disease Report and Outbreak Contact Details Modal'),
(4856, N'The record with the Personal ID = "{0}" already exists.', N'Global>Warning Messages'),
(4857, N'Age Type', N'Human>Human Person>Person Information'),
