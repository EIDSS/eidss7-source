...
IF NOT EXISTS (SELECT 1 FROM [Giraffe_Archive].[dbo].tstLocalSiteOptions WHERE strName = 'Context' collate Cyrillic_General_CI_AS)
...
from	[Giraffe_Archive].[dbo].[trtResource] trtResource_v7
left join	[Giraffe_Archive].[dbo].[trtResourceTranslation] trtResourceTranslation_v7
...
select	@sqlIdResetCmd = @sqlIdResetCmd + N'
	...
	if	exists	(
			select	1 
			from	[Falcon_Archive].[sys].[tables] t
			inner join	[Falcon_Archive].sys.objects o_t
			on			o_t.[object_id] = t.[object_id]
						and o_t.[type] = N''U'' collate Cyrillic_General_CI_AS
			inner join	[Falcon_Archive].sys.schemas s
	...
	begin
		if	exists	(
				select	1
				from	[Falcon_Archive].[dbo].[' + t.[name] + N']
...
-- PK
inner join	[Falcon_Archive].sys.indexes i
on			i.[object_id] = t.[object_id]
			and i.is_primary_key = 1

-- PK column
inner join	[Falcon_Archive].sys.index_columns ic
on			ic.[object_id] = i.[object_id]
			and ic.[index_id] = i.[index_id]
inner join	[Falcon_Archive].sys.columns c_ic
...
where		not exists	(
					select	1
					from		[Falcon_Archive].sys.index_columns ic_second
					inner join	[Falcon_Archive].sys.columns c_ic_second
...
from		[Giraffe_Archive].sys.identity_columns NewIDcol
inner join	[Giraffe_Archive].sys.columns col
on			col.[object_id] = NewIDcol.[object_id]
			and col.[column_id] = NewIDcol.[column_id]
			and col.[name] = NewIDcol.[name]
			and col.is_identity = 1
inner join	[Giraffe_Archive].dbo.sysobjects NewIDtable
...
if	exists	(
select	1 
from	[Giraffe_Archive].[dbo].sysobjects 
...
'
exec [Giraffe_Archive].[sys].sp_executesql @sqlIdResetCmd
/************************************************************
...
join	[Falcon_Archive].[dbo].[tlbHumanActual] tlbHumanActual_v6_Archive
...
************************************************************/
insert into	[Giraffe_Archive].[dbo].[tstNewID]
(	[idfTable],
	[idfKey1],
	[idfKey2],
	[strRowGuid]
...
select		4572590000000	/*tlbGeoLocationShared*/
			...
			, address_Type.idfKey
			, @TempIdentifierKey
from		[Falcon_Archive].[dbo].[tlbHumanActual] tlbHumanActual_v6
left join	[Giraffe_Archive].[dbo].[tlbHumanActual] tlbHumanActual_v7
...
exec [Giraffe_Archive].sys.sp_executesql N'ALTER INDEX ALL ON dbo.tstNewID REBUILD'
...
select		  tstNewID_v7.[NewID]
			...
			, @idfsCountry
from		[Falcon_Archive].[dbo].[tlbHumanActual] tlbHumanActual_v6
inner join	[Giraffe_Archive].[dbo].[tstNewID] tstNewID_v7
...
where tlbGeoLocationShared_v7.[idfGeoLocationShared] is null 
	and (	exists (select 1 from [Falcon_Archive].[dbo].[tlbHumanActual] tlbHumanActual_v6 where tlbHumanActual_v6.[idfCurrentResidenceAddress] = tlbGeoLocationShared_v6.[idfGeoLocationShared])
			or exists (select 1 from [Falcon_Archive].[dbo].[tlbHumanActual] tlbHumanActual_v6 where tlbHumanActual_v6.[idfEmployerAddress] = tlbGeoLocationShared_v6.[idfGeoLocationShared])
			or exists (select 1 from [Falcon_Archive].[dbo].[tlbHumanActual] tlbHumanActual_v6 where tlbHumanActual_v6.[idfRegistrationAddress] = tlbGeoLocationShared_v6.[idfGeoLocationShared])
			or exists (select 1 from [Falcon_Archive].[dbo].[tlbFarmActual] tlbFarmActual_v6 where tlbFarmActual_v6.[idfFarmAddress] = tlbGeoLocationShared_v6.[idfGeoLocationShared])
		)
...
************************************************************/
insert into [Giraffe_Archive].[dbo].[tlbStreet] 
...
from [Falcon_Archive].[dbo].[tlbStreet] tlbStreet_v6 
...
left join	[Giraffe_Archive].[dbo].[tlbStreet] tlbStreet_v7 
on	

					tlbStreet_v7.[idfStreet] = tlbStreet_v6.[idfStreet] 
where tlbStreet_v7.[idfStreet] is null 
	and not exists (select 1 from [Giraffe_Archive].[dbo].[tlbStreet] tlbStreet_v7_UK where tlbStreet_v7_UK.[idfsLocation] =  j_gisSettlement_idfsSettlement_v7.[idfsSettlement] and tlbStreet_v7_UK.[strStreetName] = tlbStreet_v6.[strStreetName] collate Cyrillic_General_CI_AS)
...
************************************************************/
insert into [Giraffe_Archive].[dbo].[tlbPostalCode] 
...
select 
					...
					, j_gisSettlement_idfsSettlement_v7.[idfsSettlement] /*Rule for the new field in EIDSSv7: idfsLocation*/
from [Falcon_Archive].[dbo].[tlbPostalCode] tlbPostalCode_v6 
...
left join	[Giraffe_Archive].[dbo].[tlbPostalCode] tlbPostalCode_v7 
on	

					tlbPostalCode_v7.[idfPostalCode] = tlbPostalCode_v6.[idfPostalCode] 
where tlbPostalCode_v7.[idfPostalCode] is null 
	and not exists (select 1 from [Giraffe_Archive].[dbo].[tlbPostalCode] tlbPostalCode_v7_UK where tlbPostalCode_v7_UK.[idfsLocation] =  j_gisSettlement_idfsSettlement_v7.[idfsSettlement] and tlbPostalCode_v7_UK.[strPostCode] = tlbPostalCode_v6.[strPostCode] collate Cyrillic_General_CI_AS)
...
************************************************************/
insert into [Giraffe_Archive].[dbo].[tlbHumanActual] 
...
from [Falcon_Archive].[dbo].[tlbHumanActual] tlbHumanActual_v6 
					...
					left join	[Giraffe_Archive].[dbo].[tlbGeoLocationShared] j_tlbGeoLocationShared_idfCurrentResidenceAddress_v7
		...
		on	
					...
					left join	[Giraffe_Archive].[dbo].[tlbGeoLocationShared] j_tlbGeoLocationShared_idfEmployerAddress_v7
		...
		on	
					...
					left join	[Giraffe_Archive].[dbo].[tlbGeoLocationShared] j_tlbGeoLocationShared_idfRegistrationAddress_v7
		...
		on	
					...
					left join	[Giraffe_Archive].[dbo].[trtBaseReference] j_trtBaseReference_idfsOccupationType_v7
		...
		on	
					...
					left join	[Giraffe_Archive].[dbo].[trtBaseReference] j_trtBaseReference_idfsNationality_v7
		...
		on	
					...
					left join	[Giraffe_Archive].[dbo].[trtBaseReference] j_trtBaseReference_idfsHumanGender_v7
		...
		on	
					...
					left join	[Giraffe_Archive].[dbo].[trtBaseReference] j_trtBaseReference_idfsPersonIDType_v7
...
************************************************************/
insert into [Giraffe_Archive].[dbo].[tlbFarmActual] 
...
select 
					...
					, GETUTCDATE()
from [Falcon_Archive].[dbo].[tlbFarmActual] tlbFarmActual_v6 


					left join	[Giraffe_Archive].[dbo].[trtBaseReference] j_trtBaseReference_idfsGrazingPattern_v7
		...
		on	
					...
					left join	[Giraffe_Archive].[dbo].[trtBaseReference] j_trtBaseReference_idfsLivestockProductionType_v7
		...
		on	
					...
					left join	[Giraffe_Archive].[dbo].[tlbHumanActual] j_tlbHumanActual_idfHumanActual_v7
		...
		on	
					...
					left join	[Giraffe_Archive].[dbo].[tlbGeoLocationShared] j_tlbGeoLocationShared_idfFarmAddress_v7
		...
		on	
					...
					left join	[Giraffe_Archive].[dbo].[trtBaseReference] j_trtBaseReference_idfsAvianFarmType_v7
		...
		on	
					...
					left join	[Giraffe_Archive].[dbo].[trtBaseReference] j_trtBaseReference_idfsAvianProductionType_v7
		...
		on	
					...
					left join	[Giraffe_Archive].[dbo].[trtBaseReference] j_trtBaseReference_idfsFarmCategory_v7
		...
		on	
					...
					left join	[Giraffe_Archive].[dbo].[trtBaseReference] j_trtBaseReference_idfsOwnershipStructure_v7
		...
		on	
					...
					left join	[Giraffe_Archive].[dbo].[trtBaseReference] j_trtBaseReference_idfsMovementPattern_v7
		...
		on	
					...
					left join	[Giraffe_Archive].[dbo].[trtBaseReference] j_trtBaseReference_idfsIntendedUse_v7

		on	


					j_trtBaseReference_idfsIntendedUse_v7.[idfsBaseReference] = tlbFarmActual_v6.[idfsIntendedUse] 
left join	[Giraffe_Archive].[dbo].[tlbFarmActual] tlbFarmActual_v7 
on	
...
************************************************************/
insert into [Giraffe_Archive].[dbo].[tlbHerdActual] 
...
select 
					...
					, GETUTCDATE()
from [Falcon_Archive].[dbo].[tlbHerdActual] tlbHerdActual_v6 


					left join	[Giraffe_Archive].[dbo].[tlbFarmActual] j_tlbFarmActual_idfFarmActual_v7

		on	


					j_tlbFarmActual_idfFarmActual_v7.[idfFarmActual] = tlbHerdActual_v6.[idfFarmActual] 
left join	[Giraffe_Archive].[dbo].[tlbHerdActual] tlbHerdActual_v7 
on	
...
************************************************************/
insert into [Giraffe_Archive].[dbo].[tlbSpeciesActual] 
...
select 
					...
					, GETUTCDATE()
from [Falcon_Archive].[dbo].[tlbSpeciesActual] tlbSpeciesActual_v6 
		...
		on	
					...
					left join	[Giraffe_Archive].[dbo].[tlbHerdActual] j_tlbHerdActual_idfHerdActual_v7

		on	


					j_tlbHerdActual_idfHerdActual_v7.[idfHerdActual] = tlbSpeciesActual_v6.[idfHerdActual] 
left join	[Giraffe_Archive].[dbo].[tlbSpeciesActual] tlbSpeciesActual_v7 
on	
...
from	[Falcon_Archive].[dbo].[tlbHumanActual] tlbHumanActual_v6
inner join	[Giraffe_Archive].[dbo].[tlbHumanActual] tlbHumanActual_v7
on	tlbHumanActual_v7.[idfHumanActual] = tlbHumanActual_v6.[idfHumanActual]
inner join	[Giraffe_Archive].[dbo].[HumanActualAddlInfo] HumanActualAddlInfo_v7
...
inner join	[Giraffe_Archive].[dbo].[tlbHumanActual] tlbHumanActual_v7
on	tlbHumanActual_v7.[idfHumanActual] = tlbHumanActual_v6.[idfHumanActual]
left join	[Giraffe_Archive].[dbo].[tlbGeoLocationShared] tlbGeoLocationShared_EmployerAddress_v7
on	tlbGeoLocationShared_EmployerAddress_v7.[idfGeoLocationShared] = tlbHumanActual_v7.[idfEmployerAddress]
left join	[Giraffe_Archive].[dbo].[HumanActualAddlInfo] HumanActualAddlInfo_v7
on	HumanActualAddlInfo_v7.[HumanActualAddlInfoUID] = tlbHumanActual_v6.[idfHumanActual]
...
left join	[Giraffe_Archive].[dbo].[tlbGeoLocationShared] altAddress_v7
	inner join	[Giraffe_Archive].[dbo].[tstNewID] tstNewID_altAddress_v7
...
from	#HumanActualAddlInfo temp
left join	[Giraffe_Archive].[dbo].[tlbGeoLocationShared] schAddress_v7
	inner join	[Giraffe_Archive].[dbo].[tstNewID] tstNewID_schAddress_v7
...
insert into	[Giraffe_Archive].[dbo].[HumanActualAddlInfo]
(	[HumanActualAddlInfoUID],
	[EIDSSPersonID],
	[SchoolAddressID],
	[AltAddressID],
...
print N''
insert into [Giraffe_Archive].[dbo]._dmccHumanCase
(	--Upd--idfRootId,
	idfPreviousId,
	idfHumanCase_v6,
...
from		[Falcon_Archive].[dbo].tlbHumanCase tlbHumanCase_v6
inner join	[Falcon_Archive].[dbo].tlbHuman tlbHuman_v6
on			tlbHuman_v6.[idfHuman] = tlbHumanCase_v6.[idfHuman]
left join	[Falcon_Archive].[dbo].[tlbObservation] tlbObservation_CS_v6
on			tlbObservation_CS_v6.[idfObservation] = tlbHumanCase_v6.[idfCSObservation]
left join	[Falcon_Archive].[dbo].[tlbObservation] tlbObservation_Epi_v6
on			tlbObservation_Epi_v6.[idfObservation] = tlbHumanCase_v6.[idfEpiObservation]
left join	[Giraffe_Archive].[dbo]._dmccHumanCase cchc
...
(	select	top 1 tlbChangeDiagnosisHistory_v6.[idfsCurrentDiagnosis]
	from	[Falcon_Archive].[dbo].[tlbChangeDiagnosisHistory] tlbChangeDiagnosisHistory_v6
...
--from		[Giraffe_Archive].[dbo]._dmccHumanCase cchc
...
from		[Falcon_Archive].[dbo].tlbHumanCase tlbHumanCase_v6
inner join	[Giraffe_Archive].[dbo]._dmccHumanCase cchc_initial
...
(	select		tlbChangeDiagnosisHistory_v6.[idfChangeDiagnosisHistory], 
	...
	from		[Falcon_Archive].[dbo].[tlbChangeDiagnosisHistory] tlbChangeDiagnosisHistory_v6
	left join	[Falcon_Archive].[dbo].[trtBaseReference] trtBaseReference_DiagReason_v6
	on			trtBaseReference_DiagReason_v6.[idfsBaseReference] = tlbChangeDiagnosisHistory_v6.[idfsChangeDiagnosisReason]
	left join	[Falcon_Archive].[dbo].[trtStringNameTranslation] trtStringNameTranslation_DiagReason_v6
...
--from		[Giraffe_Archive].[dbo]._dmccHumanCase cchc
--join		[Giraffe_Archive].[dbo]._dmccHumanCase cchc_initial
...
from		[Giraffe_Archive].[dbo]._dmccHumanCase cchc
join		[Giraffe_Archive].[dbo]._dmccHumanCase cchc_initial
	join		[Falcon_Archive].[dbo].[tlbHumanCase] tlbHumanCase_v6
...
from		[Giraffe_Archive].[dbo]._dmccHumanCase cchc
join		[Giraffe_Archive].[dbo]._dmccHumanCase cchc_final
	--join		[Falcon_Archive].[dbo].[tlbHumanCase] tlbHumanCase_v6
...
(	select top 1
	...
	from	[Giraffe_Archive].[dbo].[ffDeterminantValue] ffDeterminantValue_v6
	join	[Giraffe_Archive].[dbo].[ffFormTemplate] ffFormTemplate_v6
...
(	select top 1
			ffFormTemplate_v6.[idfsFormTemplate]
	from	[Giraffe_Archive].[dbo].[ffFormTemplate] ffFormTemplate_v6
...
(	select	top 1
	...
	from	[Giraffe_Archive].[dbo]._dmccHumanCase cchc_prev_change_diag
...
from		[Giraffe_Archive].[dbo]._dmccHumanCase cchc
join		[Giraffe_Archive].[dbo]._dmccHumanCase cchc_next
	--join		[Falcon_Archive].[dbo].[tlbHumanCase] tlbHumanCase_v6
...
from	[Giraffe_Archive].[dbo]._dmccHumanCase cchc
inner join	[Giraffe_Archive].[dbo].[tlbHumanCase] tlbHumanCase_v7
...
where	not exists
		(	select		1
			from		[Giraffe_Archive].[dbo]._dmccHumanCase cchc_fully_migrated
			left join	[Giraffe_Archive].[dbo].[tlbHumanCase] tlbHumanCase_v7
...
(	select		count(cchc_prev.idfId) as intNumber
	from		[Giraffe_Archive].[dbo]._dmccHumanCase cchc_prev
...
begin
	...
	from		[Giraffe_Archive].[dbo]._dmccHumanCase cchc
	inner join	[Giraffe_Archive].[dbo]._dmccHumanCase cchc_prev
...
where		cchc.[idfPointGeoLocation_v7] is not null
			and exists
			(	select	1
				from	[Giraffe_Archive].[dbo].[_dmccHumanCase] cchc_less
...
from		[Giraffe_Archive].[dbo].[_dmccHumanCase] cchc
join		[Giraffe_Archive].[dbo].[tstNewID] nId
...
from		[Giraffe_Archive].[dbo].[_dmccHumanCase] cchc
join		[Giraffe_Archive].[dbo].[_dmccHumanCase] cchc_prev
on			cchc_prev.[idfId] = cchc.[idfPreviousId]
where		cchc.[idfPreviousId] is not null
...
insert into [Giraffe_Archive].[dbo].[_dmccContactedCasePerson]
(	idfHumanCaseId,
	idfHumanCase_v6,
...
from		[Giraffe_Archive].[dbo].[_dmccHumanCase] cchc
inner join	[Falcon_Archive].[dbo].[tlbContactedCasePerson] tlbContactedCasePerson_v6
on			tlbContactedCasePerson_v6.[idfHumanCase] = cchc.[idfHumanCase_v6]
left join	[Falcon_Archive].[dbo].[tlbHuman] tlbHuman_v6
on			tlbHuman_v6.[idfHuman] = tlbContactedCasePerson_v6.[idfHuman]
left join	[Giraffe_Archive].[dbo].[_dmccContactedCasePerson] ccccp
...
select		75500000000	/*tlbContactedCasePerson*/
			...
			, @TempIdentifierKey
from		[Giraffe_Archive].[dbo].[_dmccContactedCasePerson] ccccp
...
insert into [Giraffe_Archive].[dbo].[_dmccAntimicrobialTherapy]
(	idfHumanCaseId,
	idfHumanCase_v6,
...
from		[Giraffe_Archive].[dbo].[_dmccHumanCase] cchc
inner join	[Falcon_Archive].[dbo].[tlbAntimicrobialTherapy] tlbAntimicrobialTherapy_v6
on			tlbAntimicrobialTherapy_v6.[idfHumanCase] = cchc.[idfHumanCase_v6]
left join	[Giraffe_Archive].[dbo].[_dmccAntimicrobialTherapy] ccat
...
select		75470000000	/*tlbAntimicrobialTherapy*/
			...
			, @TempIdentifierKey
from		[Giraffe_Archive].[dbo].[_dmccAntimicrobialTherapy] ccat
...
insert into [Giraffe_Archive].[dbo].[_dmccHuman]
(	idfHumanCaseId,
	idfCCPId,
...
left join	[Falcon_Archive].[dbo].[tlbGeoLocation] tlbGeoLocation_EmployerAddress_v6
on			tlbGeoLocation_EmployerAddress_v6.[idfGeoLocation] = tlbHuman_v6.[idfEmployerAddress]

left join	[Giraffe_Archive].[dbo].[_dmccHuman] cch_idfHuman_v7
...
select		--No need--  null
			...
			, null
			, null
from		[Falcon_Archive].[dbo].[tlbFarm] tlbFarm_v6
inner join	[Falcon_Archive].[dbo].[tlbHuman] tlbHuman_v6
...
select		--No need--  null
			...
			, null
			, null
from		[Falcon_Archive].[dbo].[tlbBasicSyndromicSurveillance] tlbBasicSyndromicSurveillance_v6
inner join	[Falcon_Archive].[dbo].[tlbHuman] tlbHuman_v6
...
from		[Giraffe_Archive].[dbo].[_dmccHuman] cch
where		cch.[idfHuman_v7] is not null
			and exists
			(	select	1
				from	[Giraffe_Archive].[dbo].[_dmccHuman] cch_less
...
from		[Giraffe_Archive].[dbo].[_dmccHumanCase] cchc
join		[Giraffe_Archive].[dbo].[_dmccHuman] cch
...
insert into [Giraffe_Archive].[dbo].[_dmccMaterial]
...
from		[Giraffe_Archive].[dbo].[_dmccHumanCase] cchc
inner join	[Falcon_Archive].[dbo].[tlbMaterial] tlbMaterial_v6
on			tlbMaterial_v6.[idfHumanCase] = cchc.[idfHumanCase_v6]
inner join	[Falcon_Archive].[dbo].[tlbHuman] tlbHuman_v6
on			tlbHuman_v6.[idfHuman] = cchc.[idfHuman_v6]
left join	[Giraffe_Archive].[dbo].[_dmccMaterial] ccm
...
inner join	[Falcon_Archive].[dbo].[tlbHuman] tlbHuman_v6
on			tlbHuman_v6.[idfHuman] = cchc.[idfHuman_v6]
inner join	[Giraffe_Archive].[dbo].[_dmccMaterial] ccm
on			ccm.[idfHumanCase_v6] = cchc.[idfHumanCase_v6]
			and ccm.[idfMaterial_v6] = tlbMaterial_v6.[idfMaterial]
			and ccm.[idfHumanCase_v7] = cchc.[idfHumanCase_v7]

inner join	[Giraffe_Archive].[dbo].[_dmccMaterial] ccm_parent
...
select		75620000000	/*tlbMaterial*/
			...
			, ccm.idfMaterial_v6
			, @TempIdentifierKey
from		[Giraffe_Archive].[dbo].[_dmccMaterial] ccm
...
insert into [Giraffe_Archive].[dbo].[_dmccLabTest]
(	idfMaterialId,
	idfMaterial_v6,
	idfTesting_v6,
	idfMaterial_v7,
...
from		[Giraffe_Archive].[dbo].[_dmccMaterial] ccm
inner join	[Falcon_Archive].[dbo].[tlbTesting] tlbTesting_v6
on			tlbTesting_v6.[idfMaterial] = ccm.[idfMaterial_v6]
left join	[Falcon_Archive].[dbo].[tlbObservation] tlbObservation_v6
on			tlbObservation_v6.[idfObservation] = tlbTesting_v6.[idfObservation]
left join	[Giraffe_Archive].[dbo].[_dmccLabTest] cct
...
select		75740000000	/*tlbTesting*/
			...
			, cct.idfTesting_v6
			, @TempIdentifierKey
from		[Giraffe_Archive].[dbo].[_dmccLabTest] cct
...
insert into [Giraffe_Archive].[dbo].[_dmccTestValidation]
(	idfLabTestId,
	idfTesting_v6,
...
from		[Giraffe_Archive].[dbo].[_dmccLabTest] cct
inner join	[Falcon_Archive].[dbo].[tlbTestValidation] tlbTestValidation_v6
on			tlbTestValidation_v6.[idfTesting] = cct.[idfTesting_v6]
left join	[Giraffe_Archive].[dbo].[_dmccTestValidation] cctv
...
select		75750000000	/*tlbTestValidation*/
			...
			, @TempIdentifierKey
from		[Giraffe_Archive].[dbo].[_dmccTestValidation] cctv
...
insert into [Giraffe_Archive].[dbo].[_dmccHumanCaseFiltered]
(	idfHumanCaseId,
	idfHumanCase_v6,
...
from		[Giraffe_Archive].[dbo].[_dmccHumanCase] cchc
inner join	[Falcon_Archive].[dbo].[tflHumanCaseFiltered] tflHumanCaseFiltered_v6
on			tflHumanCaseFiltered_v6.[idfHumanCase] = cchc.[idfHumanCase_v6]
left join	[Giraffe_Archive].[dbo].[_dmccHumanCaseFiltered] cchcf
...
insert into	[Giraffe_Archive].[dbo].[tflNewID]
(	[strTableName],
	[idfKey1],
	[idfKey2]
)
...
from		[Giraffe_Archive].[dbo].[_dmccHumanCaseFiltered] cchcf
where		cchcf.[idfHumanCaseFiltered_v7] is null

exec [Giraffe_Archive].sys.sp_executesql N'ALTER INDEX ALL ON dbo.tflNewID REBUILD'

update		cchcf
set			cchcf.[idfHumanCaseFiltered_v7] = nId.[NewID]
from		[Giraffe_Archive].[dbo].[_dmccHumanCaseFiltered] cchcf
join		[Giraffe_Archive].[dbo].[tflNewID] nId
...
insert into [Giraffe_Archive].[dbo].[_dmccGeoLocation]
(	idfGeoLocation_v6,
	idfGeoLocation_v7
)
...
left join	[Giraffe_Archive].[dbo].[_dmccGeoLocation] ccgl_idfGeoLocation_v7
...
insert into [Giraffe_Archive].[dbo].[_dmccNewGeoLocation] 
(	  [idfGeoLocation_v7]
	, [idfsSite]
	, [idfsGeoLocationType]
	, [idfsCountry]
...
select		  cchc.[idfPointGeoLocation_v7]
			...
			, @idfsCountry
from		[Giraffe_Archive].[dbo].[_dmccHumanCase] cchc
left join	[Falcon_Archive].[dbo].[tlbGeoLocation] tlbGeoLocation_v6
on			tlbGeoLocation_v6.[idfGeoLocation] = cchc.[idfPointGeoLocation_v6]
left join	[Giraffe_Archive].[dbo].[_dmccNewGeoLocation] ccngl
...
delete		ccgl
from		[Giraffe_Archive].[dbo].[_dmccGeoLocation] ccgl
left join	[Falcon_Archive].[dbo].[tlbGeoLocation] tlbGeoLocation_v6
...
insert into [Giraffe_Archive].[dbo].[_dmccObservation]
(	idfObservation_v6,
	idfsTemplate_v6,
	idfObservation_v7,
	idfsTemplate_v7
...
left join	[Giraffe_Archive].[dbo].[_dmccObservation] ccobs_idfObservation_v7
...
insert into [Giraffe_Archive].[dbo].[_dmccNewObservation] 
(	  [idfObservation_v7]
	, [idfsSite]
	, [idfsFormTemplate]
	, [intRowStatus]
...
left join	[Giraffe_Archive].[dbo].[_dmccNewObservation] ccnobs
...
delete		ccobs
from		[Giraffe_Archive].[dbo].[_dmccObservation] ccobs
left join	[Falcon_Archive].[dbo].[tlbObservation] tlbObservation_v6
...
insert into [Giraffe_Archive].[dbo].[_dmccActivityParameters]
(	idfObservation_v6,
...
from		[Giraffe_Archive].[dbo].[_dmccObservation] ccobs
inner join	[Falcon_Archive].[dbo].[tlbActivityParameters] tlbActivityParameters_v6
on			tlbActivityParameters_v6.[idfObservation] = ccobs.[idfObservation_v6]
left join	[Giraffe_Archive].[dbo].[_dmccActivityParameters] ccap
...
select		75410000000	/*tlbActivityParameters*/
			...
			, @TempIdentifierKey
from		[Giraffe_Archive].[dbo].[_dmccActivityParameters] ccap
...
select *
from [Giraffe_Archive].[dbo]._dmccAntimicrobialTherapy


-- TODO: add all remaning records related to farm owners to generate additional addresses
select *
from [Giraffe_Archive].[dbo]._dmccHuman


select *
from [Giraffe_Archive].[dbo]._dmccMaterial


select *
from [Giraffe_Archive].[dbo]._dmccLabTest



select *
from [Giraffe_Archive].[dbo]._dmccTestValidation


select *
from [Giraffe_Archive].[dbo]._dmccHumanCaseFiltered



select *
from [Giraffe_Archive].[dbo]._dmccGeoLocation

select *
from [Giraffe_Archive].[dbo]._dmccObservation

select *
from [Giraffe_Archive].[dbo]._dmccActivityParameters
...
insert into	[Giraffe_Archive].[dbo].[tlbObservation]
(	[idfObservation],
	[idfsFormTemplate],
	[intRowStatus],
	[idfsSite],
...
from		[Giraffe_Archive].[dbo].[_dmccNewObservation] ccnobs
left join	[Giraffe_Archive].[dbo].[tlbObservation] tlbObservation_v7
...
insert into	[Giraffe_Archive].[dbo].[tlbGeoLocation]
(	  [idfGeoLocation]
	, [idfsSite]
	, [idfsGeoLocationType]
	, [idfsCountry]
...
select		  ccngl.[idfGeoLocation_v7]
			...
			, ccngl.[idfsLocation]
from		[Giraffe_Archive].[dbo].[_dmccNewGeoLocation] ccngl
left join	[Giraffe_Archive].[dbo].[tlbGeoLocation] tlbGeoLocation_v7
...
select 
					...
					, GETUTCDATE()
from [Falcon_Archive].[dbo].[tlbObservation] tlbObservation_v6
left join	[Giraffe_Archive].[dbo].[_dmccObservation] ccobs
...
************************************************************/
insert into [Giraffe_Archive].[dbo].[tlbActivityParameters] 
...
select 
					...
					, GETUTCDATE()
from [Falcon_Archive].[dbo].[tlbActivityParameters] tlbActivityParameters_v6
left join	[Giraffe_Archive].[dbo].[_dmccActivityParameters] ccap
on			ccap.idfActivityParameters_v6 = tlbActivityParameters_v6.[idfActivityParameters] 
		...
		on	
					...
					inner join	[Giraffe_Archive].[dbo].[tlbObservation] j_tlbObservation_idfObservation_v7

		on	


					j_tlbObservation_idfObservation_v7.[idfObservation] = isnull(ccap.idfObservation_v7, tlbActivityParameters_v6.[idfObservation]) 
left join	[Giraffe_Archive].[dbo].[tlbActivityParameters] tlbActivityParameters_v7 
on	
...
select 
					...
					, coalesce(j_gisSettlement_idfsSettlement_v7.[idfsSettlement], j_gisRayon_idfsRayon_v7.[idfsRayon], j_gisRegion_idfsRegion_v7.[idfsRegion], j_gisCountry_idfsCountry_v7.[idfsCountry]) /*Rule for the new field in EIDSSv7: idfsLocation*/
from [Falcon_Archive].[dbo].[tlbGeoLocation] tlbGeoLocation_v6
left join	[Giraffe_Archive].[dbo].[_dmccGeoLocation] ccgl
...
************************************************************/
insert into [Giraffe_Archive].[dbo].[tlbHuman] 
...
select 
					...
					, GETUTCDATE()
from [Falcon_Archive].[dbo].[tlbHuman] tlbHuman_v6
inner join	[Giraffe_Archive].[dbo].[_dmccHuman] cch
on			cch.idfHuman_v6 = tlbHuman_v6.[idfHuman] 
		...
		on	
					...
					left join	[Giraffe_Archive].[dbo].[tlbGeoLocation] j_tlbGeoLocation_idfCurrentResidenceAddress_v7
		...
		on	
					...
					left join	[Giraffe_Archive].[dbo].[tlbGeoLocation] j_tlbGeoLocation_idfEmployerAddress_v7
		...
		on	
					...
					left join	[Giraffe_Archive].[dbo].[tlbGeoLocation] j_tlbGeoLocation_idfRegistrationAddress_v7
...
left join	[Giraffe_Archive].[dbo].[tlbHuman] tlbHuman_v7 
on	
...
************************************************************/
insert into [Giraffe_Archive].[dbo].[tlbFarm] 
...
from [Falcon_Archive].[dbo].[tlbFarm] tlbFarm_v6 
		...
		on	
					...
					left join	[Giraffe_Archive].[dbo].[tlbMonitoringSession] j_tlbMonitoringSession_idfMonitoringSession_v7
		...
		on	
					...
					left join	[Giraffe_Archive].[dbo].[_dmccHuman] cch
						inner join	[Giraffe_Archive].[dbo].[tlbHuman] j_tlbHuman_idfHuman_v7
		...
		on	
					...
					left join	[Giraffe_Archive].[dbo].[tlbGeoLocation] j_tlbGeoLocation_idfFarmAddress_v7
		...
		on	
					...
					left join	[Giraffe_Archive].[dbo].[tlbObservation] j_tlbObservation_idfObservation_v7

		on	


					j_tlbObservation_idfObservation_v7.[idfObservation] = tlbFarm_v6.[idfObservation] 
left join	[Giraffe_Archive].[dbo].[tlbFarm] tlbFarm_v7 
on	
...
************************************************************/
insert into [Giraffe_Archive].[dbo].[tlbHerd] 
...
select 
					...
					, GETUTCDATE()
from [Falcon_Archive].[dbo].[tlbHerd] tlbHerd_v6 


					left join	[Giraffe_Archive].[dbo].[tlbFarm] j_tlbFarm_idfFarm_v7
...
left join	[Giraffe_Archive].[dbo].[tlbHerd] tlbHerd_v7 
on	
...
************************************************************/
insert into [Giraffe_Archive].[dbo].[tlbSpecies] 
...
from [Falcon_Archive].[dbo].[tlbSpecies] tlbSpecies_v6 
		...
		on	
					...
					left join	[Giraffe_Archive].[dbo].[tlbHerd] j_tlbHerd_idfHerd_v7
		...
		on	
					...
					left join	[Giraffe_Archive].[dbo].[tlbSpeciesActual] j_tlbSpeciesActual_idfSpeciesActual_v7

		on	


					j_tlbSpeciesActual_idfSpeciesActual_v7.[idfSpeciesActual] = tlbSpecies_v6.[idfSpeciesActual] 
left join	[Giraffe_Archive].[dbo].[tlbSpecies] tlbSpecies_v7 
on	
...
************************************************************/
insert into [Giraffe_Archive].[dbo].[tlbAnimal] 
...
from [Falcon_Archive].[dbo].[tlbAnimal] tlbAnimal_v6 


					left join	[Giraffe_Archive].[dbo].[trtBaseReference] j_trtBaseReference_idfsAnimalGender_v7
		...
		on	
					...
					left join	[Giraffe_Archive].[dbo].[trtBaseReference] j_trtBaseReference_idfsAnimalCondition_v7
		...
		on	
					...
					left join	[Giraffe_Archive].[dbo].[trtBaseReference] j_trtBaseReference_idfsAnimalAge_v7
		...
		on	
					...
					left join	[Giraffe_Archive].[dbo].[tlbSpecies] j_tlbSpecies_idfSpecies_v7
...
left join	[Giraffe_Archive].[dbo].[tlbAnimal] tlbAnimal_v7 
on	
...
************************************************************/
insert into [Giraffe_Archive].[dbo].[tlbCampaign] 
...
select 
					...
					, GETUTCDATE()
from [Falcon_Archive].[dbo].[tlbCampaign] tlbCampaign_v6 
		...
		on	
					...
					left join	[Giraffe_Archive].[dbo].[trtBaseReference] j_trtBaseReference_idfsCampaignStatus_v7
		...
		on	
					...
					left join	[Giraffe_Archive].[dbo].[trtBaseReference] j_trtBaseReference_idfsCampaignType_v7

		on	


					j_trtBaseReference_idfsCampaignType_v7.[idfsBaseReference] = tlbCampaign_v6.[idfsCampaignType] 
left join	[Giraffe_Archive].[dbo].[tlbCampaign] tlbCampaign_v7 
on	
...
************************************************************/
insert into [Giraffe_Archive].[dbo].[tlbCampaignToDiagnosis] 
...
from [Falcon_Archive].[dbo].[tlbCampaignToDiagnosis] tlbCampaignToDiagnosis_v6 


					inner join	[Giraffe_Archive].[dbo].[tlbCampaign] j_tlbCampaign_idfCampaign_v7
		...
		on	
					...
					left join	[Giraffe_Archive].[dbo].[trtSpeciesType] j_trtSpeciesType_idfsSpeciesType_v7
...
left join	[Giraffe_Archive].[dbo].[tlbCampaignToDiagnosis] tlbCampaignToDiagnosis_v7 
on	
...
************************************************************/
insert into [Giraffe_Archive].[dbo].[tlbFreezer] 
...
select 
					...
					, GETUTCDATE()
from [Falcon_Archive].[dbo].[tlbFreezer] tlbFreezer_v6 
		...
		on	
					...
					left join	[Giraffe_Archive].[dbo].[trtBaseReference] j_trtBaseReference_idfsStorageType_v7

		on	


					j_trtBaseReference_idfsStorageType_v7.[idfsBaseReference] = tlbFreezer_v6.[idfsStorageType] 
left join	[Giraffe_Archive].[dbo].[tlbFreezer] tlbFreezer_v7 
on	
...
************************************************************/
insert into [Giraffe_Archive].[dbo].[tlbFreezerSubdivision] 
...
select 
					...
					, GETUTCDATE()
from [Falcon_Archive].[dbo].[tlbFreezerSubdivision] tlbFreezerSubdivision_v6 


					inner join	[Giraffe_Archive].[dbo].[tlbFreezer] j_tlbFreezer_idfFreezer_v7
		...
		on	
					...
					left join	[Giraffe_Archive].[dbo].[tlbFreezerSubdivision] j_tlbFreezerSubdivision_idfParentSubdivision_v7
		...
		on	
					...
					left join	[Giraffe_Archive].[dbo].[trtBaseReference] j_trtBaseReference_idfsSubdivisionType_v7

		on	


					j_trtBaseReference_idfsSubdivisionType_v7.[idfsBaseReference] = tlbFreezerSubdivision_v6.[idfsSubdivisionType] 
left join	[Giraffe_Archive].[dbo].[tlbFreezerSubdivision] tlbFreezerSubdivision_v7 
on	
...
************************************************************/
insert into [Giraffe_Archive].[dbo].[tlbOutbreak] 
...
from [Falcon_Archive].[dbo].[tlbOutbreak] tlbOutbreak_v6
outer apply
(	select	count(tlbHumanCase_childForOutbreak_v6.[idfHumanCase]) as intCount
	from	[Falcon_Archive].[dbo].[tlbHumanCase] tlbHumanCase_childForOutbreak_v6
...
(	select	count(tlbVetCase_childForOutbreak_v6.[idfVetCase]) as intCount
	from	[Falcon_Archive].[dbo].[tlbVetCase] tlbVetCase_childForOutbreak_v6
...
(	select	count(tlbVSS_childForOutbreak_v6.[idfVectorSurveillanceSession]) as intCount
	from	[Falcon_Archive].[dbo].[tlbVectorSurveillanceSession] tlbVSS_childForOutbreak_v6
	where	tlbVSS_childForOutbreak_v6.[idfOutbreak] = tlbOutbreak_v6.[idfOutbreak]
		...
		on	
					...
					left join	[Giraffe_Archive].[dbo].[tlbGeoLocation] j_tlbGeoLocation_idfGeoLocation_v7
		...
		on	
					...
					left join	[Giraffe_Archive].[dbo].[trtBaseReference] j_trtBaseReference_idfsDiagnosisOrDiagnosisGroup_v7
		...
		on	
					...
					left join	[Giraffe_Archive].[dbo].[trtBaseReference] j_trtBaseReference_idfsOutbreakStatus_v7
...
left join	[Giraffe_Archive].[dbo].[tlbOutbreak] tlbOutbreak_v7 
on	
...
************************************************************/
insert into [Giraffe_Archive].[dbo].[tlbOutbreakNote] 
...
from [Falcon_Archive].[dbo].[tlbOutbreakNote] tlbOutbreakNote_v6 


					inner join	[Giraffe_Archive].[dbo].[tlbOutbreak] j_tlbOutbreak_idfOutbreak_v7
		...
		on	
					...
					inner join	[Giraffe_Archive].[dbo].[tlbPerson] j_tlbPerson_idfPerson_v7

		on	


					j_tlbPerson_idfPerson_v7.[idfPerson] = tlbOutbreakNote_v6.[idfPerson] 
left join	[Giraffe_Archive].[dbo].[tlbOutbreakNote] tlbOutbreakNote_v7 
on	
...
************************************************************/
insert into [Giraffe_Archive].[dbo].[tflOutbreakFiltered] 
...
select 
					...
					, GETUTCDATE()
from [Falcon_Archive].[dbo].[tflOutbreakFiltered] tflOutbreakFiltered_v6 
...
left join	[Giraffe_Archive].[dbo].[tflOutbreakFiltered] tflOutbreakFiltered_v7 
on	
...
************************************************************/
insert into [Giraffe_Archive].[dbo].[tlbAggrCase] 
...
from [Falcon_Archive].[dbo].[tlbAggrCase] tlbAggrCase_v6 
		...
		on	
					...
					inner join	[Giraffe_Archive].[dbo].[gisBaseReference] j_gisBaseReference_idfsAdministrativeUnit_v7
		...
		on	
					...
					inner join	[Giraffe_Archive].[dbo].[tlbOffice] j_tlbOffice_idfSentByOffice_v7
		...
		on	
					...
					inner join	[Giraffe_Archive].[dbo].[tlbPerson] j_tlbPerson_idfSentByPerson_v7
		...
		on	
					...
					inner join	[Giraffe_Archive].[dbo].[tlbOffice] j_tlbOffice_idfEnteredByOffice_v7
		...
		on	
					...
					inner join	[Giraffe_Archive].[dbo].[tlbPerson] j_tlbPerson_idfEnteredByPerson_v7
		...
		on	
					...
					left join	[Giraffe_Archive].[dbo].[tlbOffice] j_tlbOffice_idfReceivedByOffice_v7
		...
		on	
					...
					left join	[Giraffe_Archive].[dbo].[tlbPerson] j_tlbPerson_idfReceivedByPerson_v7
		...
		on	
					...
					left join	[Giraffe_Archive].[dbo].[tlbObservation] j_tlbObservation_idfCaseObservation_v7
		...
		on	
					...
					left join	[Giraffe_Archive].[dbo].[tlbObservation] j_tlbObservation_idfDiagnosticObservation_v7
		...
		on	
					...
					left join	[Giraffe_Archive].[dbo].[tlbObservation] j_tlbObservation_idfProphylacticObservation_v7
		...
		on	
					...
					left join	[Giraffe_Archive].[dbo].[tlbObservation] j_tlbObservation_idfSanitaryObservation_v7
		...
		on	
					...
					left join	[Giraffe_Archive].[dbo].[tlbAggrMatrixVersionHeader] j_tlbAggrMatrixVersionHeader_idfVersion_v7
		...
		on	
					...
					left join	[Giraffe_Archive].[dbo].[tlbAggrMatrixVersionHeader] j_tlbAggrMatrixVersionHeader_idfDiagnosticVersion_v7
		...
		on	
					...
					left join	[Giraffe_Archive].[dbo].[tlbAggrMatrixVersionHeader] j_tlbAggrMatrixVersionHeader_idfProphylacticVersion_v7
		...
		on	
					...
					left join	[Giraffe_Archive].[dbo].[tlbAggrMatrixVersionHeader] j_tlbAggrMatrixVersionHeader_idfSanitaryVersion_v7

		on	


					j_tlbAggrMatrixVersionHeader_idfSanitaryVersion_v7.[idfVersion] = tlbAggrCase_v6.[idfSanitaryVersion] 
left join	[Giraffe_Archive].[dbo].[tlbAggrCase] tlbAggrCase_v7 
on	
...
************************************************************/
insert into [Giraffe_Archive].[dbo].[tlbVectorSurveillanceSession] 
...
select 
					...
					, GETUTCDATE()
from [Falcon_Archive].[dbo].[tlbVectorSurveillanceSession] tlbVectorSurveillanceSession_v6 
		...
		on	
					...
					inner join	[Giraffe_Archive].[dbo].[trtBaseReference] j_trtBaseReference_idfsVectorSurveillanceStatus_v7
		...
		on	
					...
					left join	[Giraffe_Archive].[dbo].[tlbGeoLocation] j_tlbGeoLocation_idfLocation_v7
		...
		on	
					...
					left join	[Giraffe_Archive].[dbo].[tlbOutbreak] j_tlbOutbreak_idfOutbreak_v7

		on	


					j_tlbOutbreak_idfOutbreak_v7.[idfOutbreak] = tlbVectorSurveillanceSession_v6.[idfOutbreak] 
left join	[Giraffe_Archive].[dbo].[tlbVectorSurveillanceSession] tlbVectorSurveillanceSession_v7 
on	
...
************************************************************/
insert into [Giraffe_Archive].[dbo].[tlbVector] 
...
select 
					...
					, GETUTCDATE()
from [Falcon_Archive].[dbo].[tlbVector] tlbVector_v6 


					inner join	[Giraffe_Archive].[dbo].[tlbOffice] j_tlbOffice_idfCollectedByOffice_v7
		...
		on	
					...
					inner join	[Giraffe_Archive].[dbo].[trtVectorSubType] j_trtVectorSubType_idfsVectorSubType_v7
		...
		on	
					...
					left join	[Giraffe_Archive].[dbo].[tlbVectorSurveillanceSession] j_tlbVectorSurveillanceSession_idfVectorSurveillanceSession_v7
		...
		on	
					...
					left join	[Giraffe_Archive].[dbo].[tlbOffice] j_tlbOffice_idfIdentifiedByOffice_v7
		...
		on	
					...
					left join	[Giraffe_Archive].[dbo].[tlbPerson] j_tlbPerson_idfCollectedByPerson_v7
		...
		on	
					...
					left join	[Giraffe_Archive].[dbo].[tlbPerson] j_tlbPerson_idfIdentifiedByPerson_v7
		...
		on	
					...
					left join	[Giraffe_Archive].[dbo].[tlbVector] j_tlbVector_idfHostVector_v7
		...
		on	
					...
					left join	[Giraffe_Archive].[dbo].[trtBaseReference] j_trtBaseReference_idfsSurrounding_v7
		...
		on	
					...
					left join	[Giraffe_Archive].[dbo].[trtBaseReference] j_trtBaseReference_idfsCollectionMethod_v7
		...
		on	
					...
					left join	[Giraffe_Archive].[dbo].[trtBaseReference] j_trtBaseReference_idfsBasisOfRecord_v7
		...
		on	
					...
					left join	[Giraffe_Archive].[dbo].[trtBaseReference] j_trtBaseReference_idfsSex_v7
		...
		on	
					...
					left join	[Giraffe_Archive].[dbo].[trtBaseReference] j_trtBaseReference_idfsIdentificationMethod_v7
		...
		on	
					...
					left join	[Giraffe_Archive].[dbo].[trtBaseReference] j_trtBaseReference_idfsDayPeriod_v7
		...
		on	
					...
					left join	[Giraffe_Archive].[dbo].[trtBaseReference] j_trtBaseReference_idfsEctoparasitesCollected_v7

		on	


					j_trtBaseReference_idfsEctoparasitesCollected_v7.[idfsBaseReference] = tlbVector_v6.[idfsEctoparasitesCollected] 
left join	[Giraffe_Archive].[dbo].[tlbVector] tlbVector_v7 
on	
...
************************************************************/
insert into [Giraffe_Archive].[dbo].[tlbVectorSurveillanceSessionSummary] 
...
select 
					...
					, GETUTCDATE()
from [Falcon_Archive].[dbo].[tlbVectorSurveillanceSessionSummary] tlbVectorSurveillanceSessionSummary_v6 


					inner join	[Giraffe_Archive].[dbo].[tlbGeoLocation] j_tlbGeoLocation_idfGeoLocation_v7
		...
		on	
					...
					inner join	[Giraffe_Archive].[dbo].[tlbVectorSurveillanceSession] j_tlbVectorSurveillanceSession_idfVectorSurveillanceSession_v7
...
left join	[Giraffe_Archive].[dbo].[tlbVectorSurveillanceSessionSummary] tlbVectorSurveillanceSessionSummary_v7 
on	
...
************************************************************/
insert into [Giraffe_Archive].[dbo].[tlbVectorSurveillanceSessionSummaryDiagnosis] 
...
select 
					...
					, GETUTCDATE()
from [Falcon_Archive].[dbo].[tlbVectorSurveillanceSessionSummaryDiagnosis] tlbVectorSurveillanceSessionSummaryDiagnosis_v6 


					inner join	[Giraffe_Archive].[dbo].[tlbVectorSurveillanceSessionSummary] j_tlbVectorSurveillanceSessionSummary_idfsVSSessionSummary_v7
...
left join	[Giraffe_Archive].[dbo].[tlbVectorSurveillanceSessionSummaryDiagnosis] tlbVectorSurveillanceSessionSummaryDiagnosis_v7 
on	
...
************************************************************/
insert into [Giraffe_Archive].[dbo].[tflVectorSurveillanceSessionFiltered] 
...
select 
					...
					, GETUTCDATE()
from [Falcon_Archive].[dbo].[tflVectorSurveillanceSessionFiltered] tflVectorSurveillanceSessionFiltered_v6 
...
left join	[Giraffe_Archive].[dbo].[tflVectorSurveillanceSessionFiltered] tflVectorSurveillanceSessionFiltered_v7 
on	
...
************************************************************/
insert into [Giraffe_Archive].[dbo].[tlbMonitoringSession] 
...
from [Falcon_Archive].[dbo].[tlbMonitoringSession] tlbMonitoringSession_v6 
		...
		on	
					...
					left join	[Giraffe_Archive].[dbo].[tlbCampaign] j_tlbCampaign_idfCampaign_v7
		...
		on	
					...
					left join	[Giraffe_Archive].[dbo].[trtBaseReference] j_trtBaseReference_idfsMonitoringSessionStatus_v7
		...
		on	
					...
					left join	[Giraffe_Archive].[dbo].[tlbPerson] j_tlbPerson_idfPersonEnteredBy_v7

		on	


					j_tlbPerson_idfPersonEnteredBy_v7.[idfPerson] = tlbMonitoringSession_v6.[idfPersonEnteredBy] 
left join	[Giraffe_Archive].[dbo].[tlbMonitoringSession] tlbMonitoringSession_v7 
on	
...
************************************************************/
insert into [Giraffe_Archive].[dbo].[tlbMonitoringSessionToDiagnosis] 
...
select 
					...
					, null /*TODO: Check the rule for the new field in EIDSSv7: Comments*/
from [Falcon_Archive].[dbo].[tlbMonitoringSessionToDiagnosis] tlbMonitoringSessionToDiagnosis_v6 
		...
		on	
					...
					inner join	[Giraffe_Archive].[dbo].[tlbMonitoringSession] j_tlbMonitoringSession_idfMonitoringSession_v7
...
left join	[Giraffe_Archive].[dbo].[tlbMonitoringSessionToDiagnosis] tlbMonitoringSessionToDiagnosis_v7 
on	
...
************************************************************/
insert into [Giraffe_Archive].[dbo].[tlbMonitoringSessionAction] 
...
select 
					...
					, GETUTCDATE()
from [Falcon_Archive].[dbo].[tlbMonitoringSessionAction] tlbMonitoringSessionAction_v6 
		...
		on	
					...
					inner join	[Giraffe_Archive].[dbo].[tlbPerson] j_tlbPerson_idfPersonEnteredBy_v7
		...
		on	
					...
					inner join	[Giraffe_Archive].[dbo].[trtBaseReference] j_trtBaseReference_idfsMonitoringSessionActionType_v7
		...
		on	
					...
					inner join	[Giraffe_Archive].[dbo].[trtBaseReference] j_trtBaseReference_idfsMonitoringSessionActionStatus_v7
...
left join	[Giraffe_Archive].[dbo].[tlbMonitoringSessionAction] tlbMonitoringSessionAction_v7 
on	
...
************************************************************/
insert into [Giraffe_Archive].[dbo].[tlbMonitoringSessionSummary] 
...
select 
					...
					, GETUTCDATE()
from [Falcon_Archive].[dbo].[tlbMonitoringSessionSummary] tlbMonitoringSessionSummary_v6 


					inner join	[Giraffe_Archive].[dbo].[tlbFarm] j_tlbFarm_idfFarm_v7
		...
		on	
					...
					left join	[Giraffe_Archive].[dbo].[trtBaseReference] j_trtBaseReference_idfsAnimalSex_v7

		on	


					j_trtBaseReference_idfsAnimalSex_v7.[idfsBaseReference] = tlbMonitoringSessionSummary_v6.[idfsAnimalSex] 
left join	[Giraffe_Archive].[dbo].[tlbMonitoringSessionSummary] tlbMonitoringSessionSummary_v7 
on	
...
************************************************************/
insert into [Giraffe_Archive].[dbo].[tlbMonitoringSessionSummaryDiagnosis] 
...
select 
					...
					, GETUTCDATE()
from [Falcon_Archive].[dbo].[tlbMonitoringSessionSummaryDiagnosis] tlbMonitoringSessionSummaryDiagnosis_v6 


					inner join	[Giraffe_Archive].[dbo].[tlbMonitoringSessionSummary] j_tlbMonitoringSessionSummary_idfMonitoringSessionSummary_v7
...
left join	[Giraffe_Archive].[dbo].[tlbMonitoringSessionSummaryDiagnosis] tlbMonitoringSessionSummaryDiagnosis_v7 
on	
...
************************************************************/
insert into [Giraffe_Archive].[dbo].[tlbMonitoringSessionSummarySample] 
...
select 
					...
					, GETUTCDATE()
from [Falcon_Archive].[dbo].[tlbMonitoringSessionSummarySample] tlbMonitoringSessionSummarySample_v6 
...
left join	[Giraffe_Archive].[dbo].[tlbMonitoringSessionSummarySample] tlbMonitoringSessionSummarySample_v7 
on	
...
************************************************************/
insert into [Giraffe_Archive].[dbo].[tflMonitoringSessionFiltered] 
...
select 
					...
					, GETUTCDATE()
from [Falcon_Archive].[dbo].[tflMonitoringSessionFiltered] tflMonitoringSessionFiltered_v6 
...
left join	[Giraffe_Archive].[dbo].[tflMonitoringSessionFiltered] tflMonitoringSessionFiltered_v7 
on	
...
************************************************************/
insert into [Giraffe_Archive].[dbo].[tlbHumanCase] 
...
select 
					...
					, isnull(cchc.[datDiagnosisDate], tlbHumanCase_v6.[datFinalDiagnosisDate])
					...
					, null /*TODO: Check the rule for the new field in EIDSSv7: idfsYNPreviouslySoughtCare*/

					, null /*TODO: Check the rule for the new field in EIDSSv7: idfsYNExposureLocationKnown*/
					...
					, GETUTCDATE()
from [Falcon_Archive].[dbo].[tlbHumanCase] tlbHumanCase_v6
inner join	[Giraffe_Archive].[dbo].[_dmccHumanCase] cchc
on			cchc.idfHumanCase_v6 = tlbHumanCase_v6.[idfHumanCase] 
		...
		on	
					...
					left join	[Giraffe_Archive].[dbo].[tlbGeoLocation] j_tlbGeoLocation_idfPointGeoLocation_v7
		...
		on	
					...
					left join	[Giraffe_Archive].[dbo].[tlbHumanCase] j_tlbHumanCase_idfDeduplicationResultCase_v7
		...
		on	
					...
					left join	[Giraffe_Archive].[dbo].[trtBaseReference] j_trtBaseReference_idfsFinalState_v7
		...
		on	
					...
					left join	[Giraffe_Archive].[dbo].[trtBaseReference] j_trtBaseReference_idfsHospitalizationStatus_v7
		...
		on	
					...
					left join	[Giraffe_Archive].[dbo].[trtBaseReference] j_trtBaseReference_idfsHumanAgeType_v7
		...
		on	
					...
					left join	[Giraffe_Archive].[dbo].[trtBaseReference] j_trtBaseReference_idfsYNAntimicrobialTherapy_v7
		...
		on	
					...
					left join	[Giraffe_Archive].[dbo].[trtBaseReference] j_trtBaseReference_idfsYNHospitalization_v7
		...
		on	
					...
					left join	[Giraffe_Archive].[dbo].[trtBaseReference] j_trtBaseReference_idfsYNSpecimenCollected_v7
		...
		on	
					...
					left join	[Giraffe_Archive].[dbo].[trtBaseReference] j_trtBaseReference_idfsYNRelatedToOutbreak_v7
		...
		on	
					...
					left join	[Giraffe_Archive].[dbo].[trtBaseReference] j_trtBaseReference_idfsOutcome_v7
		...
		on	
					...
					left join	[Giraffe_Archive].[dbo].[trtDiagnosis] j_trtDiagnosis_idfsTentativeDiagnosis_v7

		on	


					j_trtDiagnosis_idfsTentativeDiagnosis_v7.[idfsDiagnosis] = tlbHumanCase_v6.[idfsTentativeDiagnosis] 

					left join	[Giraffe_Archive].[dbo].[trtDiagnosis] j_trtDiagnosis_idfsFinalDiagnosis_v7

		on	


					j_trtDiagnosis_idfsFinalDiagnosis_v7.[idfsDiagnosis] = cchc.[idfsDiagnosis] 

					left join	[Giraffe_Archive].[dbo].[trtBaseReference] j_trtBaseReference_idfsInitialCaseStatus_v7
		...
		on	
					...
					left join	[Giraffe_Archive].[dbo].[trtBaseReference] j_trtBaseReference_idfsFinalCaseStatus_v7
		...
		on	
					...
					left join	[Giraffe_Archive].[dbo].[tlbOffice] j_tlbOffice_idfSentByOffice_v7
		...
		on	
					...
					left join	[Giraffe_Archive].[dbo].[tlbOffice] j_tlbOffice_idfInvestigatedByOffice_v7
		...
		on	
					...
					left join	[Giraffe_Archive].[dbo].[tlbObservation] j_tlbObservation_idfEpiObservation_v7
		...
		on	
					...
					left join	[Giraffe_Archive].[dbo].[tlbObservation] j_tlbObservation_idfCSObservation_v7
		...
		on	
					...
					left join	[Giraffe_Archive].[dbo].[tlbPerson] j_tlbPerson_idfSentByPerson_v7
		...
		on	
					...
					left join	[Giraffe_Archive].[dbo].[tlbPerson] j_tlbPerson_idfInvestigatedByPerson_v7
		...
		on	
					...
					left join	[Giraffe_Archive].[dbo].[trtBaseReference] j_trtBaseReference_idfsYNTestsConducted_v7
		...
		on	
					...
					left join	[Giraffe_Archive].[dbo].[tlbOffice] j_tlbOffice_idfSoughtCareFacility_v7
		...
		on	
					...
					left join	[Giraffe_Archive].[dbo].[trtBaseReference] j_trtBaseReference_idfsNonNotifiableDiagnosis_v7
		...
		on	
					...
					left join	[Giraffe_Archive].[dbo].[trtBaseReference] j_trtBaseReference_idfsNotCollectedReason_v7
		...
		on	
					...
					left join	[Giraffe_Archive].[dbo].[trtBaseReference] j_trtBaseReference_idfsCaseProgressStatus_v7
		...
		on	
					...
					left join	[Giraffe_Archive].[dbo].[tlbOffice] j_tlbOffice_idfHospital_v7
...
************************************************************/
insert into [Giraffe_Archive].[dbo].[tlbAntimicrobialTherapy] 
...
select 
					...
					, GETUTCDATE()
from [Falcon_Archive].[dbo].[tlbAntimicrobialTherapy] tlbAntimicrobialTherapy_v6
inner join	[Giraffe_Archive].[dbo].[_dmccAntimicrobialTherapy] ccat
on			ccat.idfAntimicrobialTherapy_v6 = tlbAntimicrobialTherapy_v6.[idfAntimicrobialTherapy] 


					inner join	[Giraffe_Archive].[dbo].[tlbHumanCase] j_tlbHumanCase_idfHumanCase_v7

		on	


					j_tlbHumanCase_idfHumanCase_v7.[idfHumanCase] = ccat.idfHumanCase_v7 
left join	[Giraffe_Archive].[dbo].[tlbAntimicrobialTherapy] tlbAntimicrobialTherapy_v7 
on	
...
************************************************************/
insert into [Giraffe_Archive].[dbo].[tlbChangeDiagnosisHistory] 
...
from [Falcon_Archive].[dbo].[tlbChangeDiagnosisHistory] tlbChangeDiagnosisHistory_v6 
		...
		on	
					...
					left join	[Giraffe_Archive].[dbo].[trtDiagnosis] j_trtDiagnosis_idfsPreviousDiagnosis_v7
		...
		on	
					...
					left join	[Giraffe_Archive].[dbo].[trtDiagnosis] j_trtDiagnosis_idfsCurrentDiagnosis_v7
		...
		on	
					...
					left join	[Giraffe_Archive].[dbo].[trtBaseReference] j_trtBaseReference_idfsChangeDiagnosisReason_v7

		on	


					j_trtBaseReference_idfsChangeDiagnosisReason_v7.[idfsBaseReference] = tlbChangeDiagnosisHistory_v6.[idfsChangeDiagnosisReason] 
left join	[Giraffe_Archive].[dbo].[tlbChangeDiagnosisHistory] tlbChangeDiagnosisHistory_v7 
on	
...
************************************************************/
insert into [Giraffe_Archive].[dbo].[tlbContactedCasePerson] 
...
select 
					...
					, GETUTCDATE()
from [Falcon_Archive].[dbo].[tlbContactedCasePerson] tlbContactedCasePerson_v6
inner join	[Giraffe_Archive].[dbo].[_dmccContactedCasePerson] ccccp
on			ccccp.idfContactedCasePerson_v6 = tlbContactedCasePerson_v6.[idfContactedCasePerson] 


					inner join	[Giraffe_Archive].[dbo].[trtBaseReference] j_trtBaseReference_idfsPersonContactType_v7
...
left join	[Giraffe_Archive].[dbo].[tlbContactedCasePerson] tlbContactedCasePerson_v7 
on	
...
************************************************************/
insert into [Giraffe_Archive].[dbo].[tlbVetCase] 
...
from [Falcon_Archive].[dbo].[tlbVetCase] tlbVetCase_v6 
		...
		on	
					...
					inner join	[Giraffe_Archive].[dbo].[trtBaseReference] j_trtBaseReference_idfsCaseType_v7
		...
		on	
					...
					left join	[Giraffe_Archive].[dbo].[tlbMonitoringSession] j_tlbMonitoringSession_idfParentMonitoringSession_v7
		...
		on	
					...
					left join	[Giraffe_Archive].[dbo].[tlbOffice] j_tlbOffice_idfReportedByOffice_v7
		...
		on	
					...
					left join	[Giraffe_Archive].[dbo].[tlbPerson] j_tlbPerson_idfPersonInvestigatedBy_v7
		...
		on	
					...
					left join	[Giraffe_Archive].[dbo].[tlbPerson] j_tlbPerson_idfPersonReportedBy_v7
		...
		on	
					...
					left join	[Giraffe_Archive].[dbo].[trtDiagnosis] j_trtDiagnosis_idfsTentativeDiagnosis_v7
		left join	[Giraffe_Archive].[dbo].[trtBaseReference] j_trtBaseReference_idfsTentativeDiagnosis_v7
		on	j_trtBaseReference_idfsTentativeDiagnosis_v7.[idfsBaseReference] = j_trtDiagnosis_idfsTentativeDiagnosis_v7.[idfsDiagnosis]
		left join	[Giraffe_Archive].[dbo].[trtStringNameTranslation] j_trtStringNameTranslation_idfsTentativeDiagnosis_v7
		...
		on	
					...
					left join	[Giraffe_Archive].[dbo].[trtDiagnosis] j_trtDiagnosis_idfsTentativeDiagnosis1_v7
		left join	[Giraffe_Archive].[dbo].[trtBaseReference] j_trtBaseReference_idfsTentativeDiagnosis1_v7
		...
		left join	[Giraffe_Archive].[dbo].[trtStringNameTranslation] j_trtStringNameTranslation_idfsTentativeDiagnosis1_v7
		...
		on	
					...
					left join	[Giraffe_Archive].[dbo].[trtDiagnosis] j_trtDiagnosis_idfsTentativeDiagnosis2_v7
		left join	[Giraffe_Archive].[dbo].[trtBaseReference] j_trtBaseReference_idfsTentativeDiagnosis2_v7
		...
		left join	[Giraffe_Archive].[dbo].[trtStringNameTranslation] j_trtStringNameTranslation_idfsTentativeDiagnosis2_v7
		...
		on	
					...
					left join	[Giraffe_Archive].[dbo].[trtBaseReference] j_trtBaseReference_idfsCaseReportType_v7
		...
		on	
					...
					left join	[Giraffe_Archive].[dbo].[trtBaseReference] j_trtBaseReference_idfsCaseClassification_v7
		...
		on	
					...
					left join	[Giraffe_Archive].[dbo].[trtDiagnosis] j_trtDiagnosis_idfsShowDiagnosis_v7
...
left join	[Giraffe_Archive].[dbo].[tlbVetCase] tlbVetCase_v7 
on	
...
************************************************************/
insert into [Giraffe_Archive].[dbo].[tlbVaccination] 
...
select 
					...
					, GETUTCDATE()
from [Falcon_Archive].[dbo].[tlbVaccination] tlbVaccination_v6 
		...
		on	
					...
					left join	[Giraffe_Archive].[dbo].[tlbVetCase] j_tlbVetCase_idfVetCase_v7
		...
		on	
					...
					left join	[Giraffe_Archive].[dbo].[trtBaseReference] j_trtBaseReference_idfsVaccinationType_v7
		...
		on	
					...
					left join	[Giraffe_Archive].[dbo].[trtBaseReference] j_trtBaseReference_idfsVaccinationRoute_v7
		...
		on	
					...
					left join	[Giraffe_Archive].[dbo].[trtDiagnosis] j_trtDiagnosis_idfsDiagnosis_v7

		on	


					j_trtDiagnosis_idfsDiagnosis_v7.[idfsDiagnosis] = tlbVaccination_v6.[idfsDiagnosis] 
left join	[Giraffe_Archive].[dbo].[tlbVaccination] tlbVaccination_v7 
on	
...
************************************************************/
insert into [Giraffe_Archive].[dbo].[tlbVetCaseLog] 
...
select 
					...
					, GETUTCDATE()
from [Falcon_Archive].[dbo].[tlbVetCaseLog] tlbVetCaseLog_v6 
		...
		on	
					...
					left join	[Giraffe_Archive].[dbo].[trtBaseReference] j_trtBaseReference_idfsCaseLogStatus_v7
...
left join	[Giraffe_Archive].[dbo].[tlbVetCaseLog] tlbVetCaseLog_v7 
on	
...
************************************************************/
insert into [Giraffe_Archive].[dbo].[tflVetCaseFiltered] 
...
select 
					...
					, GETUTCDATE()
from [Falcon_Archive].[dbo].[tflVetCaseFiltered] tflVetCaseFiltered_v6 
		...
		on	
					...
					inner join	[Giraffe_Archive].[dbo].[tlbVetCase] j_tlbVetCase_idfVetCase_v7

		on	


					j_tlbVetCase_idfVetCase_v7.[idfVetCase] = tflVetCaseFiltered_v6.[idfVetCase] 
left join	[Giraffe_Archive].[dbo].[tflVetCaseFiltered] tflVetCaseFiltered_v7 
on	
...
************************************************************/
insert into [Giraffe_Archive].[dbo].[tlbMaterial] 
...
from [Falcon_Archive].[dbo].[tlbMaterial] tlbMaterial_v6
left join	[Giraffe_Archive].[dbo].[_dmccMaterial] ccm
on			ccm.idfMaterial_v6 = tlbMaterial_v6.[idfMaterial] 
		...
		on	
					...
					left join	[Giraffe_Archive].[dbo].[tlbAnimal] j_tlbAnimal_idfAnimal_v7
		...
		on	
					...
					left join	[Giraffe_Archive].[dbo].[tlbDepartment] j_tlbDepartment_idfInDepartment_v7
		...
		on	
					...
					left join	[Giraffe_Archive].[dbo].[tlbFreezerSubdivision] j_tlbFreezerSubdivision_idfSubdivision_v7
		...
		on	
					...
					left join	[Giraffe_Archive].[dbo].[tlbHumanCase] j_tlbHumanCase_idfHumanCase_v7
		...
		on	
					...
					left join	[Giraffe_Archive].[dbo].[tlbHuman] j_tlbHuman_idfHuman_v7
		...
		on	
					...
					left join	[Giraffe_Archive].[dbo].[tlbMaterial] j_tlbMaterial_idfParentMaterial_v7
		...
		on	
					...
					left join	[Giraffe_Archive].[dbo].[tlbMaterial] j_tlbMaterial_idfRootMaterial_v7
		...
		on	
					...
					left join	[Giraffe_Archive].[dbo].[tlbPerson] j_tlbPerson_idfFieldCollectedByPerson_v7
		...
		on	
					...
					left join	[Giraffe_Archive].[dbo].[tlbOffice] j_tlbOffice_idfFieldCollectedByOffice_v7
		...
		on	
					...
					left join	[Giraffe_Archive].[dbo].[tlbTesting] j_tlbTesting_idfMainTest_v7
		...
		on	
					...
					left join	[Giraffe_Archive].[dbo].[tlbVector] j_tlbVector_idfVector_v7
		...
		on	
					...
					left join	[Giraffe_Archive].[dbo].[trtBaseReference] j_trtBaseReference_idfsSampleStatus_v7
		...
		on	
					...
					left join	[Giraffe_Archive].[dbo].[tlbPerson] j_tlbPerson_idfDestroyedByPerson_v7
		...
		on	
					...
					left join	[Giraffe_Archive].[dbo].[tlbOffice] j_tlbOffice_idfSendToOffice_v7
		...
		on	
					...
					left join	[Giraffe_Archive].[dbo].[trtBaseReference] j_trtBaseReference_idfsBirdStatus_v7
		...
		on	
					...
					left join	[Giraffe_Archive].[dbo].[trtBaseReference] j_trtBaseReference_idfsAccessionCondition_v7
		...
		on	
					...
					left join	[Giraffe_Archive].[dbo].[tlbPerson] j_tlbPerson_idfAccesionByPerson_v7
		...
		on	
					...
					left join	[Giraffe_Archive].[dbo].[trtBaseReference] j_trtBaseReference_idfsDestructionMethod_v7
		...
		on	
					...
					left join	[Giraffe_Archive].[dbo].[trtBaseReference] j_trtBaseReference_idfsSampleKind_v7
		...
		on	
					...
					left join	[Giraffe_Archive].[dbo].[tlbPerson] j_tlbPerson_idfMarkedForDispositionByPerson_v7
		...
		on	
					...
					left join	[Giraffe_Archive].[dbo].[tstSite] j_tstSite_idfsCurrentSite_v7

		on	


					j_tstSite_idfsCurrentSite_v7.[idfsSite] = tlbMaterial_v6.[idfsCurrentSite] 
left join	[Giraffe_Archive].[dbo].[tlbMaterial] tlbMaterial_v7 
on	
...
************************************************************/
insert into [Giraffe_Archive].[dbo].[tlbTransferOUT] 
...
select 
					...
					, GETUTCDATE()
from [Falcon_Archive].[dbo].[tlbTransferOUT] tlbTransferOUT_v6 


					inner join	[Giraffe_Archive].[dbo].[trtBaseReference] j_trtBaseReference_idfsTransferStatus_v7
		...
		on	
					...
					left join	[Giraffe_Archive].[dbo].[tlbOffice] j_tlbOffice_idfSendFromOffice_v7
		...
		on	
					...
					left join	[Giraffe_Archive].[dbo].[tlbPerson] j_tlbPerson_idfSendByPerson_v7

		on	


					j_tlbPerson_idfSendByPerson_v7.[idfPerson] = tlbTransferOUT_v6.[idfSendByPerson] 
left join	[Giraffe_Archive].[dbo].[tlbTransferOUT] tlbTransferOUT_v7 
on	
...
************************************************************/
insert into [Giraffe_Archive].[dbo].[tflTransferOutFiltered] 
...
select 
					...
					, GETUTCDATE()
from [Falcon_Archive].[dbo].[tflTransferOutFiltered] tflTransferOutFiltered_v6 
		...
		on	
					...
					inner join	[Giraffe_Archive].[dbo].[tlbTransferOUT] j_tlbTransferOUT_idfTransferOut_v7

		on	


					j_tlbTransferOUT_idfTransferOut_v7.[idfTransferOut] = tflTransferOutFiltered_v6.[idfTransferOut] 
left join	[Giraffe_Archive].[dbo].[tflTransferOutFiltered] tflTransferOutFiltered_v7 
on	
...
************************************************************/
insert into [Giraffe_Archive].[dbo].[tlbTransferOutMaterial] 
...
select 
					...
					, GETUTCDATE()
from [Falcon_Archive].[dbo].[tlbTransferOutMaterial] tlbTransferOutMaterial_v6 


					inner join	[Giraffe_Archive].[dbo].[tlbMaterial] j_tlbMaterial_idfMaterial_v7
...
left join	[Giraffe_Archive].[dbo].[tlbTransferOutMaterial] tlbTransferOutMaterial_v7 
on	
...
************************************************************/
insert into [Giraffe_Archive].[dbo].[tlbPensideTest] 
...
select 
					...
					, GETUTCDATE()
from [Falcon_Archive].[dbo].[tlbPensideTest] tlbPensideTest_v6 
		...
		on	
					...
					left join	[Giraffe_Archive].[dbo].[tlbOffice] j_tlbOffice_idfTestedByOffice_v7
		...
		on	
					...
					left join	[Giraffe_Archive].[dbo].[trtBaseReference] j_trtBaseReference_idfsPensideTestResult_v7
		...
		on	
					...
					left join	[Giraffe_Archive].[dbo].[trtBaseReference] j_trtBaseReference_idfsPensideTestName_v7
		...
		on	
					...
					left join	[Giraffe_Archive].[dbo].[tlbPerson] j_tlbPerson_idfTestedByPerson_v7
		...
		on	
					...
					left join	[Giraffe_Archive].[dbo].[trtBaseReference] j_trtBaseReference_idfsPensideTestCategory_v7

		on	


					j_trtBaseReference_idfsPensideTestCategory_v7.[idfsBaseReference] = tlbPensideTest_v6.[idfsPensideTestCategory] 
left join	[Giraffe_Archive].[dbo].[tlbPensideTest] tlbPensideTest_v7 
on	
...
************************************************************/
insert into [Giraffe_Archive].[dbo].[tlbBatchTest] 
...
select 
					...
					, GETUTCDATE()
from [Falcon_Archive].[dbo].[tlbBatchTest] tlbBatchTest_v6 
		...
		on	
					...
					left join	[Giraffe_Archive].[dbo].[trtBaseReference] j_trtBaseReference_idfsBatchStatus_v7
		...
		on	
					...
					left join	[Giraffe_Archive].[dbo].[tlbOffice] j_tlbOffice_idfPerformedByOffice_v7
		...
		on	
					...
					left join	[Giraffe_Archive].[dbo].[tlbPerson] j_tlbPerson_idfPerformedByPerson_v7
		...
		on	
					...
					left join	[Giraffe_Archive].[dbo].[tlbOffice] j_tlbOffice_idfValidatedByOffice_v7
		...
		on	
					...
					left join	[Giraffe_Archive].[dbo].[tlbPerson] j_tlbPerson_idfValidatedByPerson_v7
		...
		on	
					...
					left join	[Giraffe_Archive].[dbo].[tlbPerson] j_tlbPerson_idfResultEnteredByPerson_v7
		...
		on	
					...
					left join	[Giraffe_Archive].[dbo].[tlbOffice] j_tlbOffice_idfResultEnteredByOffice_v7

		on	


					j_tlbOffice_idfResultEnteredByOffice_v7.[idfOffice] = tlbBatchTest_v6.[idfResultEnteredByOffice] 
left join	[Giraffe_Archive].[dbo].[tlbBatchTest] tlbBatchTest_v7 
on	
...
************************************************************/
insert into [Giraffe_Archive].[dbo].[tflBatchTestFiltered] 
...
select 
					...
					, GETUTCDATE()
from [Falcon_Archive].[dbo].[tflBatchTestFiltered] tflBatchTestFiltered_v6 


					inner join	[Giraffe_Archive].[dbo].[tlbBatchTest] j_tlbBatchTest_idfBatchTest_v7
...
left join	[Giraffe_Archive].[dbo].[tflBatchTestFiltered] tflBatchTestFiltered_v7 
on	
...
************************************************************/
insert into [Giraffe_Archive].[dbo].[tlbTesting] 
...
from [Falcon_Archive].[dbo].[tlbTesting] tlbTesting_v6
left join	[Giraffe_Archive].[dbo].[_dmccLabTest] cct
on			cct.idfTesting_v6 = tlbTesting_v6.[idfTesting] 


					inner join	[Giraffe_Archive].[dbo].[trtBaseReference] j_trtBaseReference_idfsTestStatus_v7
		...
		on	
					...
					left join	[Giraffe_Archive].[dbo].[tlbBatchTest] j_tlbBatchTest_idfBatchTest_v7
		...
		on	
					...
					left join	[Giraffe_Archive].[dbo].[tlbMaterial] j_tlbMaterial_idfMaterial_v7
		...
		on	
					...
					left join	[Giraffe_Archive].[dbo].[trtBaseReference] j_trtBaseReference_idfsTestResult_v7

		on	


					j_trtBaseReference_idfsTestResult_v7.[idfsBaseReference] = tlbTesting_v6.[idfsTestResult] 
left join	[Giraffe_Archive].[dbo].[tlbTesting] tlbTesting_v7 
on	
...
************************************************************/
insert into [Giraffe_Archive].[dbo].[tlbTestAmendmentHistory] 
...
select 
					...
					, GETUTCDATE()
from [Falcon_Archive].[dbo].[tlbTestAmendmentHistory] tlbTestAmendmentHistory_v6 


					inner join	[Giraffe_Archive].[dbo].[tlbTesting] j_tlbTesting_idfTesting_v7
		...
		on	
					...
					left join	[Giraffe_Archive].[dbo].[tlbOffice] j_tlbOffice_idfAmendByOffice_v7
		...
		on	
					...
					left join	[Giraffe_Archive].[dbo].[tlbPerson] j_tlbPerson_idfAmendByPerson_v7
		...
		on	
					...
					left join	[Giraffe_Archive].[dbo].[trtBaseReference] j_trtBaseReference_idfsOldTestResult_v7
		...
		on	
					...
					left join	[Giraffe_Archive].[dbo].[trtBaseReference] j_trtBaseReference_idfsNewTestResult_v7

		on	


					j_trtBaseReference_idfsNewTestResult_v7.[idfsBaseReference] = tlbTestAmendmentHistory_v6.[idfsNewTestResult] 
left join	[Giraffe_Archive].[dbo].[tlbTestAmendmentHistory] tlbTestAmendmentHistory_v7 
on	
...
************************************************************/
insert into [Giraffe_Archive].[dbo].[tlbTestValidation] 
...
select 
					...
					, GETUTCDATE()
from [Falcon_Archive].[dbo].[tlbTestValidation] tlbTestValidation_v6
left join	[Giraffe_Archive].[dbo].[_dmccTestValidation] cctv
on			cctv.idfTestValidation_v6 = tlbTestValidation_v6.[idfTestValidation] 
		...
		on	
					...
					left join	[Giraffe_Archive].[dbo].[tlbOffice] j_tlbOffice_idfInterpretedByOffice_v7
		...
		on	
					...
					left join	[Giraffe_Archive].[dbo].[tlbPerson] j_tlbPerson_idfInterpretedByPerson_v7
		...
		on	
					...
					left join	[Giraffe_Archive].[dbo].[trtBaseReference] j_trtBaseReference_idfsInterpretedStatus_v7

		on	


					j_trtBaseReference_idfsInterpretedStatus_v7.[idfsBaseReference] = tlbTestValidation_v6.[idfsInterpretedStatus] 
left join	[Giraffe_Archive].[dbo].[tlbTestValidation] tlbTestValidation_v7 
on	
...
************************************************************/
insert into [Giraffe_Archive].[dbo].[tlbBasicSyndromicSurveillanceAggregateHeader] 
...
select 
					...
					, null /*TODO: Check the rule for the new field in EIDSSv7: LegacyFormID*/
from [Falcon_Archive].[dbo].[tlbBasicSyndromicSurveillanceAggregateHeader] tlbBasicSyndromicSurveillanceAggregateHeader_v6 


					left join	[Giraffe_Archive].[dbo].[tlbPerson] j_tlbPerson_idfEnteredBy_v7
...
left join	[Giraffe_Archive].[dbo].[tlbBasicSyndromicSurveillanceAggregateHeader] tlbBasicSyndromicSurveillanceAggregateHeader_v7 
on	
...
************************************************************/
insert into [Giraffe_Archive].[dbo].[tlbBasicSyndromicSurveillanceAggregateDetail] 
...
select 
					...
					, GETUTCDATE()
from [Falcon_Archive].[dbo].[tlbBasicSyndromicSurveillanceAggregateDetail] tlbBasicSyndromicSurveillanceAggregateDetail_v6 


					inner join	[Giraffe_Archive].[dbo].[tlbBasicSyndromicSurveillanceAggregateHeader] j_tlbBasicSyndromicSurveillanceAggregateHeader_idfAggregateHeader_v7
		...
		on	
					...
					inner join	[Giraffe_Archive].[dbo].[tlbOffice] j_tlbOffice_idfHospital_v7

		on	


					j_tlbOffice_idfHospital_v7.[idfOffice] = tlbBasicSyndromicSurveillanceAggregateDetail_v6.[idfHospital] 
left join	[Giraffe_Archive].[dbo].[tlbBasicSyndromicSurveillanceAggregateDetail] tlbBasicSyndromicSurveillanceAggregateDetail_v7 
on	
...
************************************************************/
insert into [Giraffe_Archive].[dbo].[tflBasicSyndromicSurveillanceAggregateHeaderFiltered] 
...
select 
					...
					, GETUTCDATE()
from [Falcon_Archive].[dbo].[tflBasicSyndromicSurveillanceAggregateHeaderFiltered] tflBasicSyndromicSurveillanceAggregateHeaderFiltered_v6 
...
left join	[Giraffe_Archive].[dbo].[tflBasicSyndromicSurveillanceAggregateHeaderFiltered] tflBasicSyndromicSurveillanceAggregateHeaderFiltered_v7 
on	
...
************************************************************/
insert into [Giraffe_Archive].[dbo].[tlbBasicSyndromicSurveillance] 
...
from [Falcon_Archive].[dbo].[tlbBasicSyndromicSurveillance] tlbBasicSyndromicSurveillance_v6 
					...
					inner join	[Giraffe_Archive].[dbo].[tlbPerson] j_tlbPerson_idfEnteredBy_v7
		...
		on	
					...
					left join	[Giraffe_Archive].[dbo].[trtBaseReference] j_trtBaseReference_idfsBasicSyndromicSurveillanceType_v7
		...
		on	
					...
					left join	[Giraffe_Archive].[dbo].[trtBaseReference] j_trtBaseReference_idfsYNPregnant_v7
		...
		on	
					...
					left join	[Giraffe_Archive].[dbo].[trtBaseReference] j_trtBaseReference_idfsYNPostpartumPeriod_v7
		...
		on	
					...
					left join	[Giraffe_Archive].[dbo].[trtBaseReference] j_trtBaseReference_idfsYNFever_v7
		...
		on	
					...
					left join	[Giraffe_Archive].[dbo].[trtBaseReference] j_trtBaseReference_idfsMethodOfMeasurement_v7
		...
		on	
					...
					left join	[Giraffe_Archive].[dbo].[trtBaseReference] j_trtBaseReference_idfsYNCough_v7
		...
		on	
					...
					left join	[Giraffe_Archive].[dbo].[trtBaseReference] j_trtBaseReference_idfsYNShortnessOfBreath_v7
		...
		on	
					...
					left join	[Giraffe_Archive].[dbo].[trtBaseReference] j_trtBaseReference_idfsYNSeasonalFluVaccine_v7
		...
		on	
					...
					left join	[Giraffe_Archive].[dbo].[trtBaseReference] j_trtBaseReference_idfsYNPatientWasHospitalized_v7
		...
		on	
					...
					left join	[Giraffe_Archive].[dbo].[trtBaseReference] j_trtBaseReference_idfsYNPatientWasInER_v7
		...
		on	
					...
					left join	[Giraffe_Archive].[dbo].[trtBaseReference] j_trtBaseReference_idfsYNTreatment_v7
		...
		on	
					...
					left join	[Giraffe_Archive].[dbo].[trtBaseReference] j_trtBaseReference_idfsYNAdministratedAntiviralMedication_v7
...
left join	[Giraffe_Archive].[dbo].[tlbBasicSyndromicSurveillance] tlbBasicSyndromicSurveillance_v7 
on	
...
************************************************************/
insert into [Giraffe_Archive].[dbo].[tflBasicSyndromicSurveillanceFiltered] 
...
select 
					...
					, GETUTCDATE()
from [Falcon_Archive].[dbo].[tflBasicSyndromicSurveillanceFiltered] tflBasicSyndromicSurveillanceFiltered_v6 


					inner join	[Giraffe_Archive].[dbo].[tlbBasicSyndromicSurveillance] j_tlbBasicSyndromicSurveillance_idfBasicSyndromicSurveillance_v7
...
left join	[Giraffe_Archive].[dbo].[tflBasicSyndromicSurveillanceFiltered] tflBasicSyndromicSurveillanceFiltered_v7 
on	
...
insert into	[Giraffe_Archive].[dbo].[HumanAddlInfo]
(	[HumanAdditionalInfo],
	[ReportedAge],
	[ReportedAgeUOMID],
	[ReportedAgeDTM],
...
from	[Giraffe_Archive].[dbo].[_dmccHuman] cch
inner join	[Giraffe_Archive].[dbo].[tlbHuman] tlbHuman_v7
on	tlbHuman_v7.[idfHuman] = cch.[idfHuman_v7]
left join	[Falcon_Archive].[dbo].[tlbHumanCase] tlbHumanCase_v6
on			tlbHumanCase_v6.[idfHumanCase] = cch.[idfHumanCase_v6]
left join	[Giraffe_Archive].[dbo].[tlbGeoLocation] j_tlbGeoLocation_SchoolAddressID_v7
on	j_tlbGeoLocation_SchoolAddressID_v7.[idfGeoLocation] = cch.[idfHumanSchAddress_v7]
left join	[Giraffe_Archive].[dbo].[tlbGeoLocation] j_tlbGeoLocation_AltAddressID_v7
on	j_tlbGeoLocation_AltAddressID_v7.[idfGeoLocation] = cch.[idfHumanAltAddress_v7]
left join	[Giraffe_Archive].[dbo].[HumanAddlInfo] HumanAddlInfo_v7
...
from		[Giraffe_Archive].[dbo].[tlbFreezerSubdivision] tlbFreezerSubdivision_v7
inner join	[Falcon_Archive].[dbo].[tlbFreezerSubdivision] tlbFreezerSubdivision_v6
on			tlbFreezerSubdivision_v6.idfSubdivision = tlbFreezerSubdivision_v7.idfSubdivision
inner join	[Giraffe_Archive].[dbo].[tlbFreezerSubdivision] tlbFreezerSubdivision_parent_v7
...
from		[Giraffe_Archive].[dbo].[tlbOutbreak] tlbOutbreak_v7
inner join	[Falcon_Archive].[dbo].[tlbOutbreak] tlbOutbreak_v6
...
from		[Giraffe_Archive].[dbo].[tlbVector] tlbVector_v7
inner join	[Falcon_Archive].[dbo].[tlbVector] tlbVector_v6
on			tlbVector_v6.idfVector = tlbVector_v7.idfVector
inner join	[Giraffe_Archive].[dbo].[tlbVector] tlbVector_host_v7
...
from		[Giraffe_Archive].[dbo].[tlbFarm] tlbFarm_v7
inner join	[Falcon_Archive].[dbo].[tlbFarm] tlbFarm_v6
on			tlbFarm_v6.[idfFarm] = tlbFarm_v7.[idfFarm]
inner join	[Giraffe_Archive].[dbo].[tlbMonitoringSession] tlbMonitoringSession_v7
...
from		[Giraffe_Archive].[dbo].[tlbHumanCase] tlbHumanCase_v7
inner join	[Giraffe_Archive].[dbo].[_dmccHumanCase] cchc
on			cchc.[idfHumanCase_v7] = tlbHumanCase_v7.[idfHumanCase]
inner join	[Giraffe_Archive].[dbo].[tlbHumanCase] tlbHumanCase_dedupl_v7
...
insert into	[Giraffe_Archive].[dbo].[HumanDiseaseReportRelationship]
...
inner join	[Giraffe_Archive].[dbo].[tlbHumanCase] tlbHumanCaseRelateTo_v7
on	tlbHumanCaseRelateTo_v7.[idfHumanCase] = cchc.[idfHumanCase_v7]
inner join	[Giraffe_Archive].[dbo].[tlbHumanCase] tlbHumanCaseRoot_v7
on	tlbHumanCaseRoot_v7.[idfHumanCase] = cchc.[idfRootHumanCase_v7]
left join	[Giraffe_Archive].[dbo].[HumanDiseaseReportRelationship] HumanDiseaseReportRelationship_v7
...
from		[Giraffe_Archive].[dbo].[tlbMaterial] tlbMaterial_v7
left join	[Giraffe_Archive].[dbo].[_dmccMaterial] ccm
...
inner join	[Giraffe_Archive].[dbo].[tlbMaterial] tlbMaterial_Parent_v7
...
inner join	[Falcon_Archive].[dbo].[tlbMaterial] tlbMaterial_v6
on			tlbMaterial_v6.[idfMaterial] = isnull(ccm.[idfMaterial_v6], tlbMaterial_v7.[idfMaterial])
inner join	[Giraffe_Archive].[dbo].[tlbMaterial] tlbMaterial_Root_v7
...
inner join	[Giraffe_Archive].[dbo].[_dmccLabTest] cct
on			cct.[idfMaterial_v7] = tlbMaterial_v7.[idfMaterial]
			and cct.[idfTesting_v6] = tlbMaterial_v6.[idfMainTest]
inner join	[Giraffe_Archive].[dbo].[tlbTesting] tlbTesting_MainTest_v7
...
where		tlbMaterial_V7.[TestUnassignedIndicator] = 0
			...
			and not exists	(
						select	1 
						from	[Giraffe_Archive].[dbo].[tlbTesting] tlbTesting_v7 
...
where		tlbMaterial_V7.[TransferIndicator] = 0
			...
			and exists	(
						select	1 
						from	[Giraffe_Archive].[dbo].[tlbTransferOutMaterial] tlbTransferOutMaterial_v7 
						join	[Giraffe_Archive].[dbo].[tlbTransferOUT] tlbTransferOUT_v7
...
''
	...
	print ''Update of consequent ID value in the table tflNewID is not needed: '' + cast(@seed_value as varchar(30))
'
execute [Giraffe_Archive].[dbo].sp_executesql @sqlIdResetCmd
/************************************************************
* Reset identifier seed value - end
************************************************************/
