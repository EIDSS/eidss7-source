...
print N''
insert into	 [Giraffe_Archive].[dbo]._dmccFarmActual
(	idfFarmActual_v6,
	idfFarmActual_v7,
	idfSeqNumber,
	strFarmCode_v6,
...
left join	[Giraffe_Archive].[dbo]._dmccFarmActual ccfa
...
begin
	...
	from		[Giraffe_Archive].[dbo]._dmccFarmActual ccfa
	outer apply
	(	select	count(ccfa_count.[idfFarmActual_v6]) intCount
		from	[Giraffe_Archive].[dbo]._dmccFarmActual ccfa_count
	...
	(	select		count(tlbFarmActual_v7.[idfFarmActual]) intCount
		from		[Giraffe_Archive].[dbo].tlbFarmActual tlbFarmActual_v7
		left join	[Giraffe_Archive].[dbo]._dmccFarmActual ccfa_not_exists
...
join	[Falcon_Archive].[dbo].[tlbFarmActual] tlbFarmActual_v6_Archive
...
from		[Giraffe_Archive].[dbo].[_dmccFarmActual] ccfa
inner join	[Giraffe_Archive].[dbo].[tlbFarmActual] tlbFarmActual_v7
...
begin
	...
	on			cchc_prev.[idfHumanCase_v6] = cchc.[idfHumanCase_v6]
				...
				and not exists
					(	select	1
						from	[Giraffe_Archive].[dbo]._dmccHumanCase cchc_prev_greater
...
from		[Giraffe_Archive].[dbo]._dmccHumanCase cchc
inner join	[Giraffe_Archive].[dbo]._dmccHumanCase cchc_dedup_res
