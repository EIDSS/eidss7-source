...
/**************************************************************************************************************************************
* Check script of data migration results: FF Values of type HEI in Human Cases v6.1 and HDRs v7 with templates, determinants, 
...
set	@FormTypeEN = N'Human Epi Investigations'
...
(
	...
	on			tlbObservation_v7.[idfObservation] = tlbHumanCase_v7.[idfEpiObservation]
	...
	on			tlbObservation_v6.[idfObservation] = tlbHumanCase_v6.[idfEpiObservation]
...
on			tlbActivityParameters_v6.[idfObservation] = tlbHumanCase_v6.[idfEpiObservation]
...
(	select		count(distinct tlbActivityParameters_prev_rows_v6.idfRow) as intRowNum
	...
	where		tlbActivityParameters_prev_rows_v6.[idfObservation] = tlbHumanCase_v6.[idfEpiObservation]
...
on			tlbActivityParameters_v7.[idfObservation] = tlbHumanCase_v7.[idfEpiObservation]
...
(	select		count(distinct tlbActivityParameters_prev_rows_v7.idfRow) as intRowNum
	...
	where		tlbActivityParameters_prev_rows_v7.[idfObservation] = tlbHumanCase_v7.[idfEpiObservation]
