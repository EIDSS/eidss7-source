...
namespace EIDSS.ReportViewer
{
	public abstract class ReportController : Controller
	{
		...
		protected abstract bool ShowReportParameters { get;  }
		...
		/// </summary>
		protected virtual bool UseCustomReportImagePath { get { return true; } }
		protected virtual bool AjaxLoadInitialReport { get { return false; } }
		protected virtual System.Text.Encoding Encoding { get { return System.Text.Encoding.UTF8; } }
		...
		public JsonResult ViewReportPage(string reportPath, int? page = 0)
		{
			...
			model.ShowReportParameters = ShowReportParameters;
		...
		public JsonResult ReloadParameters(string reportPath)
		{
			...
			return Json(EIDSS.ReportViewer.CoreHtmlHelpers.ParametersToHtmlString(null, model));
		}
		...
		protected ReportViewerModel GetReportViewerModel(HttpRequest request)
		{
			...
			model.ShowReportParameters = this.ShowReportParameters;
			...
			model.UseCustomReportImagePath = true;
