using EIDSS.ReportViewer.ReportService;
using System;
...
namespace EIDSS.ReportViewer
{
	public static class ReportServiceHelpers
	{
		...
		public static ReportService.ReportParameter[] GetReportParameters(ReportViewerModel model, bool forRendering = false)
		{
			...
			ReportService.ExpirationDefinition item = new ReportService.ExpirationDefinition();
            service.SetCacheOptionsAsync(model.ReportPath, true, new TimeExpiration{Minutes = 1});
